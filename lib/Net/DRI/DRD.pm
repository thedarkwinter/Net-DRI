...
sub _build_price_query
{
 ...
 if ((grep $_ eq 'Net::DRI::Protocol::EPP::Extensions::CentralNic::Fee', @{$ndr->protocol()->{loaded_modules}}) || (grep $_ eq 'Net::DRI::Protocol::EPP::Extensions::Fee', @{$ndr->protocol()->{loaded_modules}}))
 {
   my ($fee,@fees);
