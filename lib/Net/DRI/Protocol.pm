...
##
## Copyright (c) 2005-2011,2013-2014,2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2005-2011,2013-2014,2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
# Handles extracting a given argument, that may be in data refhash for all operations
# or inside a Changes object in case of update
sub extract_argument
{
 my ($self, $key, $data) = @_;
 my $arg;

 if ($self->message()->operation()->[1] eq 'update')
 {
  $arg = $data->set($key);
 } elsif (Net::DRI::Util::has_key($data, $key))
 {
  $arg = $data->{$key};
 }
