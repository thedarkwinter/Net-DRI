## NOTE: This module is depricated in favour of the Net::DRI::Data::Contact::IIS 
##       which supports both .SE and .NU domains
...
use base qw/Net::DRI::Data::Contact::IIS/;
...
{
 my $class=shift;
 warn "Data::Contact::SE.pm is depricated, please use Data::Contact::IIS.pm for .SE and .NU domains!";
