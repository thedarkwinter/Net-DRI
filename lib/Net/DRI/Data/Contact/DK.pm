...
__PACKAGE__->register_attributes(qw(vat type ean));
...
VAT number - this is only supported for user types: company, public_organisation and association. The number
is required for handling VAT correctly, mandatory for user types company and public_organisation and optional for the
...
EAN - this number is only supported for user types: company, public_organisation and association. It is only mandatory for association and optional for company and public_organisationnot used by 'individual' contacts
