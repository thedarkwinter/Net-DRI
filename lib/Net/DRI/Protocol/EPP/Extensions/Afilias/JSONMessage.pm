## Domain Registry Interface, EPP JSONMessage extension for Afilias
##
...
package Net::DRI::Protocol::EPP::Extensions::Afilias::JSONMessage;
...
sub parse
{
  ...
  my $decoded_json;
  eval {
    $decoded_json=decode_json($rd->{content});
  };
  return if $@;
...
Net::DRI::Protocol::EPP::Extensions::Afilias::JSONMessage - EPP Afilias JSONMessage for Net::DRI

=head1 DESCRIPTION

EPP JSONMessage extension: poll queue enhancements.
