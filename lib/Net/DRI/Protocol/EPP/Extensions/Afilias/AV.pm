...
##
## Copyright (c) 2008,2009,2013 Tonnerre Lombard <tonnerre.lombard@sygroup.ch>. All rights reserved.
...
sub build_command
{
	...
	$msg->command([$command, 'av:' . $tcommand,sprintf('xmlns:av="%s"',$msg->ns('av'))]);
