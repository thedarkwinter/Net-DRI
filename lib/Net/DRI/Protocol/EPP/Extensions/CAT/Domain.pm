...
##
## Copyright (c) 2006-2008,2012-2014,2016 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2006-2008,2012-2014,2016 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
sub create
{
 ...
 my $eid=$mes->command_extension_register('dx', 'create');
...
sub update
{
 ...
 return unless @n;
 my $eid=$mes->command_extension_register('dx', 'update');
 $mes->command_extension($eid,\@n);
 return;
}
