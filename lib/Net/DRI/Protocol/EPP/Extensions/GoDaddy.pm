## Domain Registry Interface, GoDaddy New gTLD EPP extensions
##
...
package Net::DRI::Protocol::EPP::Extensions::GoDaddy;
...
sub default_extensions {
 ...
 my @ext = qw/GracePeriod SecDNS LaunchPhase IDN AllocationToken NeuLevel::CO NeuLevel::Message NeuLevel::EXTContact NeuLevel::WhoisType ARI::KeyValue CentralNic::Fee GoDaddy::MZB/;
 if (exists $pp->{custom} )
 {
