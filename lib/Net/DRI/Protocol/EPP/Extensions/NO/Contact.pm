...
##           (c) 2016,2019 Patrick Mevzek E<lt>netdri@dotandco.comE<gt>
##                    All rights reserved.
##
...
Copyright (c) 2008,2010 UNINETT Norid AS, E<lt>http://www.norid.noE<gt>,
Trond Haugen E<lt>info@norid.noE<gt>
Copyright (c) 2016,2019 Patrick Mevzek E<lt>netdri@dotandco.comE<gt>
All rights reserved.
...
sub add_no_extensions {
    ...
    my $r = $epp->message()->command_extension( 'no-ext-contact', [ $op, @e ] );
...
sub update {
    ...
    if ( defined($mp)
       ...
       $r = $epp->message()->command_extension( 'no-ext-contact', [ 'update', @n ] );
    }
