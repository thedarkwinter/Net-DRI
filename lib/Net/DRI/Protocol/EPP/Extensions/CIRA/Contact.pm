...
sub create
{
 ...
 my $mes=$epp->message();
 my $eid=$mes->command_extension_register('cira', 'ciraCreate');
...
sub update
{
 ...
 my $mes=$epp->message();
 my $eid=$mes->command_extension_register('cira', 'ciraUpdate');
...
Copyright (c) 2010,2013,2016 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
