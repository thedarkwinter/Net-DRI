...
##
## Copyright (c) 2006,2008,2009,2011,2018 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2006,2008,2009,2011,2018 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
{
 my ($self,$rp)=@_;
 $self->ns({aero => 'urn:afilias:params:xml:ns:ext:aero-1.0'});
 return;
}
