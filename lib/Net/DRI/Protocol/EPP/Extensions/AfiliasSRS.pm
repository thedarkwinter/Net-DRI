...
sub default_extensions { 
 ...
 my @extensions = qw/GracePeriod SecDNS LaunchPhase Afilias::IPR Afilias::IDNLanguage Afilias::Message Afilias::Registrar Afilias::JSONMessage/;
 push @extensions, (defined $self->{brown_fee_version}) ? 'CentralNic::Fee' : 'Afilias::Price';
 return @extensions;
}
