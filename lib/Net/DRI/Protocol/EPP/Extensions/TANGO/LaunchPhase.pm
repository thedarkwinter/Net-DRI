...
=item trademark_id [mandatory for the custom phase and accepted only with the followinf sub_phases(local-trademark)]

=item  trademark_issuer [mandatory for the custom phase and accepted only with the followinf sub_phases(local-trademark)]
...
sub create
{
 ...
 push @n, ['ext:augmentedMark' , {'xmlns:ext'=>'http://xmlns.corenic.net/epp/mark-ext-1.0'},@n2] if @n2;
