...
##
## Copyright (c) 2008,2009,2013,2016,2018 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2008,2009,2013,2016,2018 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
{
 my ($self,$rp)=@_;
 $self->ns({ dnssi => 'http://www.arnes.si/xml/epp/dnssi-1.2' });
