...
##
## Copyright (c) 2006-2008,2012,2013,2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2006-2008,2012,2013,2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
sub setup
{
 ...
 state $rns = { 'whoisInf' => 'http://www.verisign.com/epp/whoisInf-1.0'};
 $po->ns($rns);
 return;
}
...
sub info
{
 ...
 $epp->message()->command_extension('whoisInf', ['whoisInf', ['flag', $wi]]);
 return;
}
