...
##
## Copyright (c) 2005-2009,2013,2016 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2005-2009,2013,2016 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
sub setup
{
 ...
 $po->ns({ 'e164' => [ 'urn:ietf:params:xml:ns:e164epp-1.0','e164epp-1.0.xsd' ] });
 return;
}
...
sub create
{
 ...
 my $mes=$epp->message();
 my $eid=$mes->command_extension_register('e164', 'create');
...
sub update
{
 ...
 my $mes=$epp->message();
 my $eid=$mes->command_extension_register('e164', 'update');
