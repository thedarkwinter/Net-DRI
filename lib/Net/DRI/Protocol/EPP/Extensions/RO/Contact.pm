...
sub create {
	...
	if (defined $c->vat()) { push @f, [ 'rotld:cnp_fiscal_code', $c->vat() ]; } 
	if (defined $c->orgno()) { push @f, [ 'rotld:registration_number', $c->orgno() ]; }
	if (defined $c->type()) { push @f, [ 'rotld:person_type', $c->type() ]; } 
