...
##
## Copyright (c) 2011,2013,2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2011,2013,2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
sub setup
{
 ...
 $po->ns({ 'cocca' => 'https://production.coccaregistry.net/cocca-ip-verification-1.1' });
 return;
}
...
sub create
{
 ...
 $epp->message()->command_extension('cocca', ['extension', @ipv]);
 return;
}
