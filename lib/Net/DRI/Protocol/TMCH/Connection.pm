## Domain Registry Interface, TMCH Connection handling
##
...
package Net::DRI::Protocol::TMCH::Connection;
...
sub read_data
{
 ...
 die(Net::DRI::Protocol::ResultStatus->new_error('COMMAND_SYNTAX_ERROR',$frame? 'Got unexpected EPP message: '.$frame : '<empty message from server>','en')) unless ($frame=~m!</tmch>\s*$!s);
