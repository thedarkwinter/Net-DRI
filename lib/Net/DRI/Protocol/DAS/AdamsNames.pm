...
package Net::DRI::Protocol::DAS::AdamsNames;
...
use Net::DRI::Util;
use Net::DRI::Protocol::DAS::AdamsNames::Message;

=pod

=head1 NAME

Net::DRI::Protocol::DAS::AdamsNames - AdamsNames DAS Protocol (Domain Availability Service) for Net::DRI
...
sub new
{
 ...
 $self->factories('message',sub { return Net::DRI::Protocol::DAS::AdamsNames::Message->new(@_)->version($version); });
 $self->_load($rp);
 return $self;
}
...
{
 my ($self)=@_;
 return (protocol_connection => 'Net::DRI::Protocol::DAS::AdamsNames::Connection', protocol_version => 1);
}
