...
##
## Copyright (c) 2005-2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>. All rights reserved.
##
...
Copyright (c) 2005-2016,2018-2019 Patrick Mevzek <netdri@dotandco.com>.
All rights reserved.
...
## See https://www.iso.org/obp/ui/#search , select 'Country codes', then 'Officially assigned', order by Alpha-2 code (last checked on 2019-08-08)
