...
our %CCA2_EU=map { $_ => 1 } qw/AT AX BE BG CZ CY DE DK ES EE FI FR GB GF GI GP GR HR HU IE IS IT LI LT LU LV MF MQ MT NL NO PL PT RE RO SE SI SK YT/;
...
sub tlds     { return ('eu', 'xn--e1a4c', 'xn--qxa6a'); }
