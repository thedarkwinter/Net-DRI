...
package Net::DRI::DRD::Nominet::GTLD;
...
Net::DRI::DRD::Nominet::GTLD - Mominet gTLD policies for Net::DRI

=head1 DESCRIPTION

Additional domain extension for Nominet gTLDS

Nominet utilises the following standard extensions. Please see the test files for more examples.
...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::Socket',{ssl_version => 'TLSv12'},'Net::DRI::Protocol::EPP::Extensions::NEWGTLD',{'disable_idn'=>1, custom => ['CentralNic::Fee','AllocationToken']}) if $type eq 'epp';
 return;
}
