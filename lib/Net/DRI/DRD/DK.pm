...
__PACKAGE__->make_exception_for_unavailable_operations(qw/contact_update contact_delete contact_transfer contact_transfer_stop contact_transfer_query contact_transfer_accept contact_transfer_refuse contact_renew domain_update domain_delete domain_transfer domain_transfer_accept domains_transfer_reject domains_transfer_cancel domain_renew host_create host_update host_delete/);
