...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::HTTP',{protocol_connection=>'Net::DRI::Protocol::EPP::Extensions::HTTP'},'Net::DRI::Protocol::EPP::Extensions::MSKIX',{}) if $type eq 'epp'; ## EPP is over HTTPS here
 return;
}
