...
sub tlds     { return ('auction','audio','auto','blackfriday','cars','christmas','click','country','deal','design','diet','family','ﬂowers','free','furniture','game','gift','gratis','guitars','help','hiphop','home','hosting','inc','juegos','link','lol','love','marketing','media','mom','news','photo','pics','pizza','property','racing','realestate','restaurant','sale','save','school','sexy','store','style','tattoo','team','tech','video'); } # This might be all of them?
