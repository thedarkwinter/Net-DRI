...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::Socket',{},'Net::DRI::Protocol::EPP::Extensions::NEWGTLD',{custom=>['CentralNic::Fee','AllocationToken'],'disable_idn'=>1,'brown_fee_version'=>'0.6'}) if $type eq 'epp';
