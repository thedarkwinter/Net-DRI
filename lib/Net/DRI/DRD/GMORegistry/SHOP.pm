## Domain Registry Interface, GMO Registry (.SHOP) Driver
##
...
package Net::DRI::DRD::GMORegistry::SHOP;
...
Net::DRI::DRD::GMORegistry::GMORegistry - GMO Registry (.SHOP) Driver for Net::DRI

=head1 DESCRIPTION

Additional domain extensions for GMO Registry (.SHOP) New Generic TLDs
...
sub name     { return 'GMORegistry::SHOP'; }
sub tlds { return qw/shop/; }
