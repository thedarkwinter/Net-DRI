...
Net::DRI::DRD::UPU - "Universal Postal Union" .POST Registry driver for Net::DRI
...
## return ('Net::DRI::Transport::Socket',{remote_host=>'whois.dotpostregistry.net '},'Net::DRI::Protocol::Whois',{}) if $type eq 'whois';
 return;
}
