## Domain Registry Interface, UniRegistry::CREDITUNION Driver
##
...
package Net::DRI::DRD::UniRegistry::CREDITUNION;
...
Net::DRI::DRD::UniRegistry::CREDITUNION - UniRegistry::CREDITUNION Driver for Net::DRI

=head1 DESCRIPTION

Additional domain extension UniRegistry::CREDITUNION New Generic TLDs

UniRegistry::CREDITUNION utilises a dedicated server and the following standard extensions. Please see the test files for more examples.
...
sub name     { return 'UniRegistry::CREDITUNION'; }
