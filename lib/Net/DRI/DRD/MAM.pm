...
sub tlds     {
  my @uncontested = qw/bible bradesco budapest country ecom london luxe nrw review xn--g2xx48c/;
  my @contested = qw/app art baby beauty blog cloud coupon cpa cricket data dds deals design dog eco flowers gay green home hotel immo inc latino lawyer llc love pizza property realestate restaurant school site soccer store style tech video website/;
  return @uncontested;
}
