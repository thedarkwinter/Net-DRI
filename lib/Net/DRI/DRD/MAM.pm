...
sub tlds     { 
  ...
  my @contested = qw/app art baby beauty blog book cloud coupon cpa cricket data dds deals design dog eco fashion flowers garden gay green home hotel immo inc latino lawyer llc love pizza property realestate restaurant school site soccer store style tech video vip website wedding yoga/;
  return @uncontested;
}
