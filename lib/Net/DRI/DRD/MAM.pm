...
sub tlds     {
  my @uncontested = qw/bradesco budapest country ecom luxe nrw xn--g2xx48c/;
  my @contested = qw/app art baby beauty blog cloud cpa data dds deals design dog flowers gay green home hotel immo inc latino lawyer llc love pizza property realestate restaurant school site soccer store style tech video website/;
  return @uncontested;
}
