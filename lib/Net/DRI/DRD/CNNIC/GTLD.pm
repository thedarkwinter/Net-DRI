## Domain Registry Interface, CNNIC gTLD policies
##
...
package Net::DRI::DRD::CNNIC::GTLD;

use strict;
use warnings;

use base qw/Net::DRI::DRD/;
use Net::DRI::Data::Contact::CNNIC;

=pod

=head1 NAME

Net::DRI::DRD::CNNIC::GTLD - Afilias (Main) Driver for Net::DRI

=head1 DESCRIPTION

Additional domain extensions CNNIC GTLD Registry Platform.
...
L<Net::DRI::Protocol::EPP::Extensions::CNNIC::CDN> urn:centralnic:params:xml:ns:cdn-1.0
...
sub name     { return 'CNNIC::GTLD'; }

sub tlds     { return qw/xn--io0a7i xn--1qqw23a xn--xhq521b xn--55qx5d/; }
...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::Socket',{},'Net::DRI::Protocol::EPP::Extensions::CNNIC',{}) if $type eq 'epp';
 return;
}
