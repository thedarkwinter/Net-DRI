## Domain Registry Interface, TeleInfo Registry GTLD Driver for multiple TLDs
##
...
Net::DRI::DRD::TeleInfo - TeleInfo Registry GTLD driver for Net::DRI

=head1 DESCRIPTION

Additional domain extensions used by TeleInfo Generic TLDs

TeleInfo utilises the following standard extensions. Please see the test files for more examples.
...
=head3 L<Net::DRI::Protocol::EPP::Extensions::CentralNic::Fee> urn:centralnic:params:xml:ns:fee-0.9
...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::Socket',{},'Net::DRI::Protocol::EPP::Extensions::NEWGTLD',{'custom' => ['CentralNic::Fee'], 'disable_idn' => 1, 'brown_fee_version' => '0.9'}) if $type eq 'epp';
 return;
}
