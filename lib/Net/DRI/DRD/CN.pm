...
sub name     { return 'CN'; }
sub tlds     { return (qw/cn cn.com/, map { $_.'.cn'} qw/ah bj com cq fj gd gs gx gz ha hb he hi hk hl hn jl js jx ln mo net nm nx org qh sc sd sh sn sx tj tw xj xn--55qx5d xz yn zj/ ); } # FIXME: missing .com.cn
