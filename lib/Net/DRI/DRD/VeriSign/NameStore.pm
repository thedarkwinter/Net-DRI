...
{
 my ($self,$type)=@_;
 return ('Net::DRI::Transport::Socket',{remote_host=>'otessl.verisign-grs.com', remote_port=>700},'Net::DRI::Protocol::EPP::Extensions::VeriSign::Platforms::NameStore',{'fee_version' => '0.9'}) if $type eq 'epp';
