...
package Net::DRI::DRD::VeriSign::VeriSign;
...
Net::DRI::DRD::VeriSign::VeriSign - VeriSign Base Registry driver for Net::DRI

=head1 DESCRIPTION

This DRD is used for inheritance only. Please use Verisign::COM_NET, ::NAME, or NameStore
...
sub name          { return 'VeriSign::VeriSign'; }
