...
sub tlds     { return qw/co.za net.za org.za web.za joburg durban capetown africa wien cologne koeln tirol/; }
...
sub transport_protocol_default
{
 ...
 return ('Net::DRI::Transport::Socket',{'ssl_version'=>'TLSv12', 'ssl_cipher_list' => undef},'Net::DRI::Protocol::EPP::Extensions::ZACR',{}) if $type eq 'epp';
 return;
}
