...
=cut
 ...
 return {
     ...
     tlds => [
        ...
        'vivo', 'voting', 'vu', 'vuelos', 'walter', 'weather', 'weatherchannel', 'webcam', 'williamhill', 'win', 'winners', 'woodside',
