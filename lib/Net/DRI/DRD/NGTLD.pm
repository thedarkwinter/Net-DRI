...
=cut
  ...
  return {
      ...
      tlds => ['xn--t60b56a','xn--tckwe','xn--mk1bu44c'],
  ...
  } if $bep eq 'verisign' && $tld =~ m/(?:xn--t60b56a|xn--tckwe|xn--mk1bu44c)/;

  return {
     bep_type => 2,
     contact_i18n => 2, # FIXME: they appear to only accept one address, might be they either is valid?
     tlds => ['com','net','cc','tv','bz','jobs','xn--pssy2u','xn--c1yn36f','xn--11b4c3d','xn--c2br7g','xn--42c2d9a','xn--j1aef','xn--3pxu8k','xn--hdb9cza1b','xn--fhbei','azure','bank','bing','broker','career','cfd','crs','forex','hotmail','insurance','java','maif','makeup','markets','microsoft','ooo','oracle','pictet','realtor','sca','shell','sky','spreadbetting','trading','xbox','windows'],
