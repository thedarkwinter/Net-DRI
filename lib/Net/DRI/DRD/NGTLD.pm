...
art bar basketball best budapest ceo college contact design fans feedback forum fun gent host icu ink love observer online ooo pid press protection realty reit rent rest rugby security site space storage store tech theatre tickets website wiki wme xyz
...
=cut
 ...
 return {
     ...
     transport_protocol_default => ['Net::DRI::Transport::Socket',{},'Net::DRI::Protocol::EPP::Extensions::NEWGTLD',{custom => ['CoCCA::Notifications', 'Fee']}],
   } if $bep eq 'cocca';
