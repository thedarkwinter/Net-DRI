...
=cut
 ...
 return {
     ...
     tlds => [
        ...
        'courses', 'cricket', 'cuisinella', 'date', 'dealer', 'dell', 'discover', 'doha', 'download', 'duns', 'dupont', 'earth', 'everbank',
        ...
        'tel', 'teva', 'tjmaxx', 'tjx', 'tkmaxx', 'tmall', 'trade', 'travel', 'trust', 'tube', 'uno', 'us', 'virgin', 'vista', 'vistaprint',
        'vivo', 'vuelos', 'walter', 'watches', 'weather', 'weatherchannel', 'webcam', 'whoswho', 'williamhill', 'win', 'winners', 'woodside',
...
=cut
 ...
 return {
     ...
     transport_protocol_default => ['Net::DRI::Transport::Socket',{'ssl_version'=>'TLSv12', 'ssl_cipher_list' => undef},'Net::DRI::Protocol::EPP::Extensions::UniRegistry',{'brown_fee_version' => '0.7', 'default_product'=>'ICM'}],
     factories => [ {'object'=>'contact','factory' => sub { return Net::DRI::Data::Contact::UniRegistry->new(@_); } } ],
     requires => [ 'Net::DRI::Data::Contact::UniRegistry'],
     whois_server => (defined $tld && $tld =~ m/\w+/ ? 'whois.nic.' . $tld : undef),
   } if $bep eq 'unireg_icm';
...
xn--pssy2u xn--c1yn36f xn--11b4c3d xn--t60b56a xn--c2br7g xn--42c2d9a xn--j1aef xn--3pxu8k xn--hdb9cza1b xn--mk1bu44c xn--fhbei xn--tckwe xn--9dbq2a azure bank bing broker career cfd crs forex hotmail java maif makeup markets microsoft oracle pictet realestate realtor sca shell sky spreadbetting trading xbox windows
