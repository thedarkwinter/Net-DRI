...
sub object_types  { return $_[0]->_get_bep_key('object_types') ? @{$_[0]->_get_bep_key('object_types')} : (); }
...
=head3 Status: Working 06 March 2014
...
L<Net::DRI::Protocol::EPP::Extensions::CentralNic::Fee> urn:centralnic:params:xml:ns:fee-0.4 - NOT IMPLEMENTED
