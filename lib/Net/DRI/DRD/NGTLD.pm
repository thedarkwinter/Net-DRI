...
ngtlds: xn--4gbrim xn--kput3i bnpparibas eco ged global indians ist istanbul ltda onl rich srl vegas zara
gtlds: mobi
...
=cut
 ...
 if ($bep eq 'afiliassrs') {
   my @ngtlds = qw/xn--4gbrim xn--kput3i bnpparibas eco ged global indians ist istanbul ltda onl rich srl vegas zara/;
   my @gtlds = qw/asia/;
   my @cctlds = (
...
art auto autos baby bar basketball beauty best blog boats bond budapest build cam car cars ceo cfd college cyou desi design fans feedback forum fun gay gent hair homes host icu ink love luxury makeup monster motorcycles online ooo pid press protection qpon quest reit rent rest rugby saarland security site skin space spreadbetting storage store tech theatre tickets uno website wiki wme xyz yachts
...
=cut
 ...
 return {
     bep_type => 1, # dedicated registry
     tlds => ['abogado', 'bayern', 'beer', 'boston', 'bradesco', 'broadway', 'casa', 'cooking', 'dds', 'fashion', 'fishing', 'fit', 'garden', 'gop', 'gucci', 'horse', 'law', 'london', 'luxe', 'miami', 'rodeo', 'surf', 'vip', 'vodka', 'wedding', 'work', 'yoga'],
