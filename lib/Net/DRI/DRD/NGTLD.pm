...
=cut
 ...
 return {
     ...
     tlds => [
        ...
        'vivo', 'vu', 'vuelos', 'walter', 'watches', 'weather', 'weatherchannel', 'webcam', 'williamhill', 'win', 'winners', 'woodside',
