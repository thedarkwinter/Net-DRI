## Domain Registry Interface, CGIBR Registry GTLD Driver for multiple TLDs
##
...
package Net::DRI::DRD::CGIBR::GTLD;
...
Net::DRI::DRD::CGIBR::GTLD - CGIBR Registry GTLD driver for Net::DRI

=head1 DESCRIPTION

Additional domain extensions used by CGIBR Generic TLDs

CGIBR utilises the following standard extensions. Please see the test files for more examples.
...
sub name         { return 'CGIBR::GTLD'; }
sub tlds         { return (qw/bom final rio/); }
