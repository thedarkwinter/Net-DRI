...
{
 return qw/AdamsNames Afilias::Afilias Afilias::DotAsia Afilias::IN Afilias::PIR Afilias::Shared AFNIC::AFNIC AFNIC::GTLD ARNES auDA BookMyName CentralNic::CentralNic CentralNic::Gateway CGIBR::BR CGIBR::GTLD CIRA::CA CIRA::Fury CNNIC::CN CNNIC::GTLD CoCCA::CoCCA CoCCA::GTLD CoCCA::PH CRR Deloitte DENIC DKHostmaster DNSBelgium DNSPT Domicilium DotCooperation ECOMLAC EURid FRED Gandi GDI GMO HostmasterUA ICANN IENUMAT IIS IITCNR InternetNZ IRegistry ISPAPI KNET KSRegistry LVRegistry NASK Neustar::BIZ Neustar::COInternet Neustar::Narwal Neustar::Telnic Neustar::Tralliance Neustar::US NGTLD NicAT::AT NicAT::RegBox NICEC NICMexico NICRO Nominet::GTLD Nominet::MMX Nominet::UK NORID OpenSRS OVH PANDI puntCAT RedES RESTENA SIDN::GTLD SIDN::NL SITA SONIC SWITCH TangoRS::CORE TangoRS::TangoRS TCI::GTLD TCI::MSKIX TCI::RF TCI::RU TCI::SU TCI::TCI TeleInfo TELEGreenland TMDB TRA::AE TRA::BH UniRegistry UnitedTLD::Donuts UnitedTLD::Rightside UPU VeriSign::COM_NET VeriSign::NAME VeriSign::NameStore VeriSign::VeriSign ZACR/;
}
