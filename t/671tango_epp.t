...
###################################################################################################
## Tango uses the fee-0.6 of Gavin Brown (CentralNic) extension: https://tools.ietf.org/html/draft-brown-epp-fees-03
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example4.ruhr</domain:name></domain:cd><domain:cd><domain:name avail="1">example4.ruhr</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.6"><fee:cd><fee:name premium="false">example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>create</fee:command><fee:period unit="y">1</fee:period><fee:fee>10.00</fee:fee></fee:cd><fee:cd><fee:name premium="false">example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>renew</fee:command><fee:period unit="y">1</fee:period><fee:fee>10.00</fee:fee></fee:cd><fee:cd><fee:name premium="false">example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>transfer</fee:command><fee:period unit="y">1</fee:period><fee:fee>5.00</fee:fee></fee:cd><fee:cd><fee:name premium="false">example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>restore</fee:command><fee:period unit="y">1</fee:period><fee:fee>20.00</fee:fee></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check_price('example4.ruhr');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example4.ruhr</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.6" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.6 fee-0.6.xsd"><fee:domain><fee:name>example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>create</fee:command><fee:period unit="y">1</fee:period></fee:domain><fee:domain><fee:name>example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>renew</fee:command><fee:period unit="y">1</fee:period></fee:domain><fee:domain><fee:name>example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>transfer</fee:command><fee:period unit="y">1</fee:period></fee:domain><fee:domain><fee:name>example4.ruhr</fee:name><fee:currency>USD</fee:currency><fee:command>restore</fee:command><fee:period unit="y">1</fee:period></fee:domain></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check_price build');
