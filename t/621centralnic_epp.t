...
####################################################################################################
## Centralnic (currenty) Uses the 0.4 version of Gavin Browns (CentralNic) extension. We use a greeting here to switch the namespace version here to 0.5
...
####################################################################################################
## Fee extension (Test based on: http://tools.ietf.org/html/draft-brown-epp-fees-01#section-4.1)
## Added xsi and xsd - the example of the previous link don't contemplate that

### EPP Query Commands ###
## Check: single domain
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="0">example.wiki</domain:name><domain:reason>In use</domain:reason></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.4"><fee:domain>example.wiki</fee:domain><fee:currency>EUR</fee:currency><fee:action>transfer</fee:action><fee:period unit="y">2</fee:period><fee:fee>2.50</fee:fee></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example.wiki',{fee=>{currency=>'EUR',action=>'transfer',duration=>$dri->local_object('duration','years',2)}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.wiki</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example.wiki</fee:domain><fee:currency>EUR</fee:currency><fee:action>transfer</fee:action><fee:period unit="y">2</fee:period></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
...
$rc=$dri->domain_check('example1.cafe','example2.bar','example3.wiki',{fee=>\@fees});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example1.cafe</domain:name><domain:name>example2.bar</domain:name><domain:name>example3.wiki</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example1.cafe</fee:domain><fee:currency>USD</fee:currency><fee:action phase="sunrise">create</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example2.bar</fee:domain><fee:currency>EUR</fee:currency><fee:action phase="claims" subphase="landrush">create</fee:action><fee:period unit="y">2</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example3.wiki</fee:domain><fee:currency>EUR</fee:currency><fee:action>transfer</fee:action><fee:period unit="y">2</fee:period></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check multi build');
is($rc->is_success(),1,'domain_check multi is_success');
is($dri->get_info('action'),'check','domain_check multi get_info (action)');
is($dri->get_info('exist','domain','example1.cafe'),0,'domain_check multi get_info(exist) 1/2');
is($dri->get_info('exist','domain','example2.bar'),1,'domain_check multi get_info(exist) 2/3');
is($dri->get_info('exist','domain','example3.wiki'),1,'domain_check multi get_info(exist) 3/3');
$d = shift $dri->get_info('fee','domain','example1.cafe');
is($d->{domain},'example1.cafe','domain_check multi get_info(domain) 1/3');
...
$d = shift $dri->get_info('fee','domain','example3.wiki');
is($d->{domain},'example3.wiki','domain_check multi get_info(domain) 3/3');
...
# using the standardised methods
is($dri->get_info('is_premium','domain','example3.wiki'),undef,'domain_check_multi get_info (is_premium) undef');
is($dri->get_info('price_duration','domain','example1.cafe')->years(),1,'domain_check get_info (price_duration)');
is($dri->get_info('create_price','domain','example2.bar'),'5.00','domain_check_multi get_info (create_price)');
is($dri->get_info('transfer_price','domain','example3.wiki'),'2.50','domain_check_multi get_info (transfer_price)');
...
$rc=$dri->domain_check('example4.wiki',{fee=>\@fees});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example4.wiki</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>create</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>renew</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>transfer</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>restore</fee:action><fee:period unit="y">1</fee:period></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build with multiple prices');
$d = shift $dri->get_info('fee');
is($d->{domain},'example4.wiki','domain_check multi get_info(domain) 1/3');
is($d->{currency},'USD','domain_check multi get_info(currency) 1/3');
is($d->{action},'create','domain_check multi get_info(action) 1/3');
is($d->{duration}->years(),'1','domain_check multi get_info(duration) 1/3');
...
$rc=$dri->domain_check_price('example4.wiki');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example4.wiki</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>create</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>renew</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>transfer</fee:action><fee:period unit="y">1</fee:period></fee:check><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:domain>example4.wiki</fee:domain><fee:currency>USD</fee:currency><fee:action>restore</fee:action><fee:period unit="y">1</fee:period></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check_price build');
...
$rc=$dri->domain_info('example.cafe',{fee=>{currency=>'USD',phase=>'sunrise',action=>'create',duration=>$dri->local_object('duration','years',1)}});
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name hosts="all">example.cafe</domain:name></domain:info></info><extension><fee:info xmlns:fee="urn:ietf:params:xml:ns:fee-0.4" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.4 fee-0.4.xsd"><fee:currency>USD</fee:currency><fee:action phase="sunrise">create</fee:action><fee:period unit="y">1</fee:period></fee:info></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_info build');
$rc=$dri->domain_info('example.cafe');
is($rc->is_success(),1,'domain_info is is_success');
is($dri->get_info('action'),'info','domain_info get_info (action)');
is($dri->get_info('name'),'example.cafe','domain_info get_info (name)');
