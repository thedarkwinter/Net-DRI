...
our $E1='<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-response xmlns="http://registry.denic.de/global/4.0" xmlns:tr="http://registry.denic.de/transaction/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:contact="http://registry.denic.de/contact/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0">';
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:msg="http://registry.denic.de/msg/4.0"><msg:queue-read/></registry-request>', 'Noop XML correct (sending message_retrieve)');

$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result></tr:transaction>' . $E2;
$rc = $dri->process('session', 'login', ['user','password']);
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Login successful');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0"><login><user>user</user><password>password</password></login></registry-request>', 'Login XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:contact="http://registry.denic.de/contact/4.0"><contact:check><contact:handle>DENIC-12345-BSP</contact:handle></contact:check></registry-request>', 'Check Contact XML correct');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Contact successfully requested (version 4.0)');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:contact="http://registry.denic.de/contact/4.0"><contact:create><contact:handle>DENIC-99995-GENREQ</contact:handle><contact:type>REQUEST</contact:type><contact:uri-template>https://denic.de/contact/form{?Alabel,Ulabel}</contact:uri-template></contact:create><ctid>ABC-12345</ctid></registry-request>', 'Request Contact XML correct (version 4.0)');

# Contact check (based on RRI v4.0 sample)
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is(defined($rc) && $rc->is_success(), 1, 'Contact successfully checked (version 4.0)');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:contact="http://registry.denic.de/contact/4.0"><contact:check><contact:handle>DENIC-1000002-MAX</contact:handle></contact:check></registry-request>', 'Check Contact XML correct (version 4.0)');
is($dri->get_info('exist', 'contact', 'DENIC-1000002-MAX'), 1, 'Contact exists');

# Contact update (based on RRI v4.0 sample)
my $todo = $dri->local_object('changes');
$todo->set('info', $c2);
$rc = $dri->contact_update($c2, $todo);
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Contact successfully updated (version 4.0)');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:contact="http://registry.denic.de/contact/4.0"><contact:update><contact:handle>DENIC-99995-GENREQ</contact:handle><contact:type>REQUEST</contact:type><contact:uri-template>https://denic.de/contact/form{?Alabel,Ulabel}</contact:uri-template></contact:update><ctid>ABC-12345</ctid></registry-request>', 'Update Contact XML correct (version 4.0)');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Contact successfully queried (version 4.0)');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:contact="http://registry.denic.de/contact/4.0"><contact:info><contact:handle>DENIC-99995-GENREQ</contact:handle></contact:info></registry-request>', 'Query Contact XML correct (version 4.0)');
...
is($c->type() . '|' . $c->uri_template(),
	...
	'Selected info from contact (version 4.0)');
my $mod = $dri->get_info('upDate', 'contact', 'DENIC-99995-GENREQ');
isa_ok($mod, 'DateTime');
is($mod->ymd . 'T' . $mod->hms, '2010-03-31T15:51:08', 'Update Date (version 4.0)');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:contact="http://registry.denic.de/contact/4.0"><contact:info><contact:handle>DENIC-99989-BSP</contact:handle></contact:info></registry-request>', 'Query Contact XML correct');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:check><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:check></registry-request>', 'Check Domain XML correct');
...
my $command = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:check><domain:handle>rriüberdomain.de</domain:handle><domain:ace>xn--rriberdomain-flb.de</domain:ace></domain:check></registry-request>';
utf8::encode($command);
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
utf8::encode($R1); # this encoding is normally done at transport so we have to encode it manually for this test to pass
$command = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:check><domain:handle>rriüberdomain.de</domain:handle><domain:ace>xn--rriberdomain-flb.de</domain:ace></domain:check></registry-request>';
utf8::encode($command);
is($R1, $command, 'Check Domain XML correct');
is($dri->get_info('exist'), 0, 'domain get_info(exist)');
is($dri->get_info('exist', 'domain', 'xn--rriberdomain-flb.de'), 0, 'domain get_info(exist) from cache ace');
...
# Domain create (based on RRI v4.0 sample)
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result></tr:transaction>' . $E2;
...
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result><tr:data>
      <domain:infoData xmlns:domain="http://registry.denic.de/domain/4.0">
        ...
        <domain:contact role="generalrequest">
          <contact:handle xmlns:contact="http://registry.denic.de/contact/4.0">DENIC-1000006-GENERAL-REQUEST</contact:handle>
          <contact:type xmlns:contact="http://registry.denic.de/contact/4.0">REQUEST</contact:type>
          <contact:uri-template xmlns:contact="http://registry.denic.de/contact/4.0">mailto:dbs@denic.de</contact:uri-template>
          <contact:changed xmlns:contact="http://registry.denic.de/contact/4.0">2018-08-13T14:14:18+02:00</contact:changed>
        </domain:contact>
        <domain:contact role="abusecontact">
          <contact:handle xmlns:contact="http://registry.denic.de/contact/4.0">DENIC-1000006-ABUSE-CONTACT</contact:handle>
          <contact:type xmlns:contact="http://registry.denic.de/contact/4.0">REQUEST</contact:type>
          <contact:uri-template xmlns:contact="http://registry.denic.de/contact/4.0">mailto:abuse@denic.de?subject=domain:{Ulabel}</contact:uri-template>
          <contact:changed xmlns:contact="http://registry.denic.de/contact/4.0">2018-08-13T14:14:18+02:00</contact:changed>
        </domain:contact>
        <domain:contact role="holder">
          <contact:handle xmlns:contact="http://registry.denic.de/contact/4.0">DENIC-1000006-DENIC</contact:handle>
          <contact:type xmlns:contact="http://registry.denic.de/contact/4.0">ORG</contact:type>
          <contact:name xmlns:contact="http://registry.denic.de/contact/4.0">DENIC eG</contact:name>
          <contact:postal xmlns:contact="http://registry.denic.de/contact/4.0">
          ...
          <contact:email xmlns:contact="http://registry.denic.de/contact/4.0">info@denic.de</contact:email>
          <contact:changed xmlns:contact="http://registry.denic.de/contact/4.0">2017-01-06T15:51:08+02:00</contact:changed>
        </domain:contact>
        <dnsentry:dnsentry xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="dnsentry:NS">
        ...
        <dnsentry:dnsentry xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="dnsentry:DNSKEY">
          <dnsentry:owner>denic.de.</dnsentry:owner>
          <dnsentry:rdata>
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:info recursive="true"><domain:handle>denic.de</domain:handle><domain:ace>denic.de</domain:ace></domain:info></registry-request>', 'Query Domain XML correct (version 4.0)');
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully queried (version 4.0)');
...
# domain:CHPROV (based on RRI v4.0 sample)
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result></tr:transaction>' . $E2;
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:chprov><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace><domain:contact role="abusecontact">DENIC-1000002-ABUSE</domain:contact><domain:contact role="generalrequest">DENIC-1000002-GENERAL</domain:contact><domain:contact role="holder">DENIC-1000002-MAX</domain:contact><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>de-example.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>ns1.provider.de.</dnsentry:nameserver></dnsentry:rdata></dnsentry:dnsentry><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>de-example.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>ns2.provider.de.</dnsentry:nameserver></dnsentry:rdata></dnsentry:dnsentry><domain:authInfo>SupermanistSuper</domain:authInfo></domain:chprov><ctid>ABC-12345</ctid></registry-request>', 'Transfer Domain XML correct');
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:chprovNack><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:chprovNack><ctid>ABC-12345</ctid></registry-request>', 'Refuse Transfer XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:chprovAck><domain:handle>rritestdomain2.de</domain:handle><domain:ace>rritestdomain2.de</domain:ace></domain:chprovAck><ctid>ABC-12345</ctid></registry-request>', 'Accept Transfer XML correct');

# Domain delete
$rc = $dri->domain_delete('rritestdomain3.de', { contact => $cs });
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully deleted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:delete><domain:handle>rritestdomain3.de</domain:handle><domain:ace>rritestdomain3.de</domain:ace><domain:contact role="holder">DENIC-1000002-MAX</domain:contact></domain:delete><ctid>ABC-12345</ctid></registry-request>', 'Delete Domain XML correct');

# Domain delete (based on RRI v4.0 sample)
$rc = $dri->domain_delete('de-example.de', { contact => $cs });
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully deleted (version 4.0 sample)');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:domain="http://registry.denic.de/domain/4.0"><domain:delete><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace><domain:contact role="holder">DENIC-1000002-MAX</domain:contact></domain:delete><ctid>ABC-12345</ctid></registry-request>', 'Delete Domain XML correct (version 4.0 sample)');

# Domain delete authinfo (based on RRI v4.0 sample)
$rc = $dri->domain_delete_authinfo('de-example.de');
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully deleted authinfo');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:deleteAuthInfo1><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace></domain:deleteAuthInfo1><ctid>ABC-12345</ctid></registry-request>', 'Domain Delete Authinfo XML correct');

# Domain restore (based on RRI v4.0 sample)
$rc = $dri->domain_restore('de-example.de');
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully restored');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:restore><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace></domain:restore><ctid>ABC-12345</ctid></registry-request>', 'Domain restore XML correct');

# Domain create authinfo1 (based on RRI v4.0 sample)
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:createAuthInfo1 expire="20100815" hash="4213d924230224fd719218b4acbd92f96ebe4344f3d5d1478dede1aa44e4cf4b"><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace></domain:createAuthInfo1><ctid>ABC-12345</ctid></registry-request>', 'Domain Create Authinfo1 XML correct');

# Domain create authinfo2 (based on RRI v4.0 sample)
$rc = $dri->domain_create_authinfo('de-example.de');
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully created authinfo2');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:createAuthInfo2><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace></domain:createAuthInfo2><ctid>ABC-12345</ctid></registry-request>', 'Domain Create Authinfo2 XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:chholder><domain:handle>rritestdomain2.de</domain:handle><domain:ace>rritestdomain2.de</domain:ace><domain:contact role="holder">DENIC-99990-10240-BSP5</domain:contact></domain:chholder><ctid>ABC-12345</ctid></registry-request>', 'Trade Domain XML correct');

# Domain trade | domain:CHHOLDER (based on RRI v4.0 sample)
$cs = $dri->local_object('contactset');
$cs->add($dri->local_object('contact')->srid('DENIC-1000002-MAX'), 'registrant');
$cs->add($dri->local_object('contact')->srid('DENIC-1000002-ABUSE'), 'abuse');
$cs->add($dri->local_object('contact')->srid('DENIC-1000002-GENERAL'), 'general');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:transit disconnect="true"><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:transit><ctid>ABC-12345</ctid></registry-request>', 'Transit Domain XML correct');

# Domain transit (based on RRI v4.0 sample)
$rc = $dri->domain_transit('de-example.de', {disconnect => 'true'});
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully transitted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:transit disconnect="true"><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace></domain:transit><ctid>ABC-12345</ctid></registry-request>', 'Transit Domain (true) XML correct');
$rc = $dri->domain_transit('de-example.de', {disconnect => 'false'});
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully transitted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:transit disconnect="false"><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace></domain:transit><ctid>ABC-12345</ctid></registry-request>', 'Transit Domain (false) XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:update><domain:handle>de-example.de</domain:handle><domain:ace>de-example.de</domain:ace><domain:contact role="abusecontact">DENIC-1000002-ABUSE</domain:contact><domain:contact role="generalrequest">DENIC-1000002-GENERAL</domain:contact><domain:contact role="holder">DENIC-1000002-MAX</domain:contact><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>de-example.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>ns1.de-example.de.</dnsentry:nameserver></dnsentry:rdata></dnsentry:dnsentry><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>de-example.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>ns2.de-example.de.</dnsentry:nameserver><dnsentry:address>193.171.255.36</dnsentry:address></dnsentry:rdata></dnsentry:dnsentry><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>de-example.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>ns4.de-example.de.</dnsentry:nameserver><dnsentry:address>87.233.175.19</dnsentry:address></dnsentry:rdata></dnsentry:dnsentry></domain:update><ctid>ABC-12345</ctid></registry-request>', 'Update Domain XML correct');
...
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result><tr:data>
      <domain:infoData xmlns:domain="http://registry.denic.de/domain/4.0">
        ...
        <dnsentry:dnsentry xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="dnsentry:A">
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully updated');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:dnsentry="http://registry.denic.de/dnsentry/4.0" xmlns:domain="http://registry.denic.de/domain/4.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:update><domain:handle>de-example-entry-only.de</domain:handle><domain:ace>de-example-entry-only.de</domain:ace><domain:contact role="abusecontact">DENIC-1000002-ABUSE</domain:contact><domain:contact role="generalrequest">DENIC-1000002-GENERAL</domain:contact><domain:contact role="holder">DENIC-1000002-MAX</domain:contact><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>de-example-entry-only.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>ns4.de-example-entry-only.de.</dnsentry:nameserver><dnsentry:address>87.233.175.19</dnsentry:address></dnsentry:rdata></dnsentry:dnsentry></domain:update><ctid>ABC-12345</ctid></registry-request>', 'Update Domain Two XML correct');
...
# Message retrieve
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result><tr:data><msg:message xmlns:msg="http://registry.denic.de/msg/4.0" msgid="423" msgcnt="42" msgtime="2007-12-27T14:52:13+02:00"><msg:chprovAuthInfo><msg:domain><msg:handle>blafasel.de</msg:handle><msg:ace>blafasel.de</msg:ace></msg:domain><msg:new>DENIC eG</msg:new><msg:old>RoedelDoedelCorp</msg:old></msg:chprovAuthInfo></msg:message></tr:data></tr:transaction>' . $E2;
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:msg="http://registry.denic.de/msg/4.0"><msg:queue-read/></registry-request>', 'Retrieve Message XML correct');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Message successfully deleted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:msg="http://registry.denic.de/msg/4.0"><msg:delete msgid="423"/><ctid>ABC-12345</ctid></registry-request>', 'Delete Message XML correct');
...
<registry-response xmlns="http://registry.denic.de/global/4.0" xmlns:tr="http://registry.denic.de/transaction/4.0">
  <tr:transaction>
    <tr:stid>eb7c2a09-a963-11e9-aba1-217bf86bcda0</tr:stid>
    <tr:result>success</tr:result>
    <tr:data>
      <regacc:infoData xmlns:regacc="http://registry.denic.de/regacc/4.0">
        ...
        <regacc:contact role="generalrequest">
          <contact:type xmlns:contact="http://registry.denic.de/contact/4.0">REQUEST</contact:type>
          <contact:uri-template xmlns:contact="http://registry.denic.de/contact/4.0">mailto:general@denic.de?subject=domain:{Ulabel}</contact:uri-template>
          <contact:changed xmlns:contact="http://registry.denic.de/contact/4.0">2019-01-01T01:00:00+01:00</contact:changed>
        </regacc:contact>
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/4.0" xmlns:regacc="http://registry.denic.de/regacc/4.0"><regacc:info><regacc:handle>DENIC-99995</regacc:handle></regacc:info></registry-request>', 'Query RegAcc XML correct (version 4.0)');
is($rc->is_success(), 1, 'RegAcc successfully queried (version 4.0)');
