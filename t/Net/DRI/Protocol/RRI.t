...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1"><login><user>user</user><password>password</password></login></registry-request>', 'Login XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:contact="http://registry.denic.de/contact/2.1"><contact:check><contact:handle>DENIC-12345-BSP</contact:handle></contact:check></registry-request>', 'Check Contact XML correct');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is(defined($rc) && $rc->is_success(), 1, 'Contact successfully checked');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:contact="http://registry.denic.de/contact/2.1"><contact:check><contact:handle>DENIC-99990-10240-BSP</contact:handle></contact:check></registry-request>', 'Check Contact XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:contact="http://registry.denic.de/contact/2.1"><contact:info><contact:handle>DENIC-99989-BSP</contact:handle></contact:info></registry-request>', 'Query Contact XML correct');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:domain="http://registry.denic.de/domain/2.1"><domain:check><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:check></registry-request>', 'Check Domain XML correct');
...
my $command = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:domain="http://registry.denic.de/domain/2.1"><domain:check><domain:handle>rriüberdomain.de</domain:handle><domain:ace>xn--rriberdomain-flb.de</domain:ace></domain:check></registry-request>';
utf8::encode($command);
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
utf8::encode($R1); # this encoding is normally done at transport so we have to encode it manually for this test to pass
$command = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:domain="http://registry.denic.de/domain/2.1"><domain:check><domain:handle>rriüberdomain.de</domain:handle><domain:ace>xn--rriberdomain-flb.de</domain:ace></domain:check></registry-request>';
utf8::encode($command);
is($R1, $command, 'Check Domain XML correct');
is($dri->get_info('exist'), 0, 'domain get_info(exist)');
is($dri->get_info('exist', 'domain', 'xn--rriberdomain-flb.de'), 0, 'domain get_info(exist) from cache ace');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:chprov><domain:handle>sygroup.de</domain:handle><domain:ace>sygroup.de</domain:ace><domain:contact role="admin-c">DENIC-99990-10240-BSP1</domain:contact><domain:contact role="holder">DENIC-99990-10240-BSP</domain:contact><domain:contact role="tech-c">DENIC-99990-10240-BSP2</domain:contact><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>sygroup.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>dns1.syhosting.ch.</dnsentry:nameserver><dnsentry:address>193.219.115.46</dnsentry:address></dnsentry:rdata></dnsentry:dnsentry><domain:authInfo>test-auth</domain:authInfo></domain:chprov><ctid>ABC-12345</ctid></registry-request>', 'Transfer Domain XML correct');
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully transferred');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:domain="http://registry.denic.de/domain/2.1"><domain:chprovNack><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:chprovNack><ctid>ABC-12345</ctid></registry-request>', 'Refuse Transfer XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:domain="http://registry.denic.de/domain/2.1"><domain:chprovAck><domain:handle>rritestdomain2.de</domain:handle><domain:ace>rritestdomain2.de</domain:ace></domain:chprovAck><ctid>ABC-12345</ctid></registry-request>', 'Accept Transfer XML correct');

# Domain delete
$rc = $dri->domain_delete('rritestdomain3.de', { contact =>	$cs });
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully deleted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:domain="http://registry.denic.de/domain/2.1"><domain:delete><domain:handle>rritestdomain3.de</domain:handle><domain:ace>rritestdomain3.de</domain:ace><domain:contact role="holder">DENIC-99990-10240-BSP</domain:contact></domain:delete><ctid>ABC-12345</ctid></registry-request>', 'Delete Domain XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:chholder><domain:handle>rritestdomain2.de</domain:handle><domain:ace>rritestdomain2.de</domain:ace><domain:contact role="holder">DENIC-99990-10240-BSP5</domain:contact></domain:chholder><ctid>ABC-12345</ctid></registry-request>', 'Trade Domain XML correct');

# Domain update
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result><tr:data><domain:infoData><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace><domain:status>connect</domain:status><domain:regAccId>DENIC-1000006</domain:regAccId><domain:contact role="holder"><contact:handle>DENIC-1000006-1</contact:handle></domain:contact><domain:contact role="holder"><contact:handle>DENIC-1000006-2</contact:handle></domain:contact><domain:contact role="admin-c"><contact:handle>DENIC-1000006-SD</contact:handle></domain:contact><domain:contact role="tech-c"><contact:handle>DENIC-1000006-OPS</contact:handle></domain:contact><domain:contact role="zone-c"><contact:handle>DENIC-1000006-OPS</contact:handle></domain:contact><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>rritestdomain.de</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>dns1.rritestdomain.de</dnsentry:nameserver><dnsentry:address>194.25.2.129</dnsentry:address><dnsentry:address>2001:4d88:ffff:ffff:2:b345:af62:2</dnsentry:address></dnsentry:rdata></dnsentry:dnsentry><domain:changed>2001-09-11T11:45:23-07:00</domain:changed></domain:infoData></tr:data></tr:transaction>' . $E2;
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:update><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace><domain:contact role="admin-c">DENIC-1000006-SD</domain:contact><domain:contact role="holder">DENIC-1000006-1</domain:contact><domain:contact role="holder">DENIC-1000006-2</domain:contact><domain:contact role="tech-c">ALFRED-RIPE</domain:contact><domain:contact role="zone-c">DENIC-1000006-OPS</domain:contact><dnsentry:dnsentry xsi:type="dnsentry:NS"><dnsentry:owner>rritestdomain.de.</dnsentry:owner><dnsentry:rdata><dnsentry:nameserver>dns1.syhosting.ch.</dnsentry:nameserver><dnsentry:address>193.219.115.46</dnsentry:address></dnsentry:rdata></dnsentry:dnsentry></domain:update><ctid>ABC-12345</ctid></registry-request>', 'Update Domain XML correct');

# Domain transit
$rc = $dri->domain_transit('rritestdomain.de', {disconnect => 'true'});
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Domain successfully transitted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:transit disconnect="true"><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:transit><ctid>ABC-12345</ctid></registry-request>', 'Transit Domain XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:migrate-descr><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace><domain:contact role="holder">DENIC-99990-10240-BSP5</domain:contact></domain:migrate-descr><ctid>ABC-12345</ctid></registry-request>', 'Migrate Domain XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:createAuthInfo1 expire="20121010" hash="444"><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:createAuthInfo1><ctid>ABC-12345</ctid></registry-request>', 'Domain Create Authinfo XML correct');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:dnsentry="http://registry.denic.de/dnsentry/2.1" xmlns:domain="http://registry.denic.de/domain/2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><domain:deleteAuthInfo1><domain:handle>rritestdomain.de</domain:handle><domain:ace>rritestdomain.de</domain:ace></domain:deleteAuthInfo1><ctid>ABC-12345</ctid></registry-request>', 'Domain Delete Authinfo XML correct');

####################################################################################################
## Poll Message Operations

# Message retrieve
$R2 = $E1 . '<tr:transaction><tr:stid>' . $TRID . '</tr:stid><tr:result>success</tr:result><tr:data><msg:message xmlns:msg="http://registry.denic.de/msg/2.1" msgid="423" msgcnt="42" msgtime="2007-12-27T14:52:13+02:00"><msg:chprovAuthInfo><msg:domain><msg:handle>blafasel.de</msg:handle><msg:ace>blafasel.de</msg:ace></msg:domain><msg:new>DENIC eG</msg:new><msg:old>RoedelDoedelCorp</msg:old></msg:chprovAuthInfo></msg:message></tr:data></tr:transaction>' . $E2;
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:msg="http://registry.denic.de/msg/2.1"><msg:queue-read/></registry-request>', 'Retrieve Message XML correct');
...
isa_ok($rc, 'Net::DRI::Protocol::ResultStatus');
is($rc->is_success(), 1, 'Message successfully deleted');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><registry-request xmlns="http://registry.denic.de/global/2.1" xmlns:msg="http://registry.denic.de/msg/2.1"><msg:delete msgid="423"/><ctid>ABC-12345</ctid></registry-request>', 'Delete Message XML correct');
