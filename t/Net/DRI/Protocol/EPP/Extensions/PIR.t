...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testing2.ngo</domain:name></domain:update></update><extension><validation:update xmlns:validation="urn:afilias:params:xml:ns:validation-1.0"><validation:chg><validation:ownership/></validation:chg></validation:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Validation extension: domain_update build');
...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testing.ngo</domain:name><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>sunrise</launch:phase>'.$smd.'</launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build [Sunrise Period]');
is($rc->is_success(),1,'domain_create is_success');
...
is ($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">testing.ngo</domain:name></domain:info></info><extension><launch:info xmlns:launch="urn:ietf:params:xml:ns:launch-1.0" includeMark="true"><launch:phase>sunrise</launch:phase><launch:applicationID>123</launch:applicationID></launch:info></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_info build_xml');
...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testing.ngo</domain:name><domain:period unit="y">2</domain:period><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>landrush</launch:phase></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build [Landrush/Claims Period] - label not presented on the DNL');
is($rc->is_success(),1,'domain_create is_success');
...
$R2='';
$rc=$dri->domain_info('testing.ngo',{lp => $lp});
is($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">testing.ngo</domain:name></domain:info></info><extension><launch:info xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>claims</launch:phase><launch:applicationID>123</launch:applicationID></launch:info></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build [Landrush/Claims Period] - sample request for a claims application');
...
$R2='';
$rc=$dri->domain_info('testing.ngo',{lp=>$lp});
is($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">testing.ngo</domain:name></domain:info></info><extension><launch:info xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>landrush</launch:phase><launch:applicationID>123</launch:applicationID></launch:info></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build [Landrush/Claims Period] - sample request for a landrush application');
is($rc->is_success(),1,'domain_info is_success');
...
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testing1.ngo</domain:name><domain:name>testing2.ngo</domain:name></domain:check></check><extension><launch:check xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>claims</launch:phase></launch:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build [during Claims Period]');
...
$R2='';
$rc=$dri->domain_create('testing.ngo',{pure_create=>1,duration=>DateTime::Duration->new(years=>2),contact=>$cs,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testing.ngo</domain:name><domain:period unit="y">2</domain:period><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>open</launch:phase></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build [During GA/Claims Period]');
is($rc->is_success(),1,'domain_create is_success');
