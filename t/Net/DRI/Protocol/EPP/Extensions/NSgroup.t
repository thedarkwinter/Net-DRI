...
is($R1,$E1.'<command><check><nsgroup:check xmlns:nsgroup="http://www.dns.be/xml/epp/nsgroup-1.0"><nsgroup:name>mynsgroup1</nsgroup:name><nsgroup:name>mynsgroup2</nsgroup:name></nsgroup:check></check><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.0 check_multi is_success');
...
is($R1,$E1.'<command><info><nsgroup:info xmlns:nsgroup="http://www.dns.be/xml/epp/nsgroup-1.0"><nsgroup:name>mynsgroup1</nsgroup:name></nsgroup:info></info><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.0 info build');
...
is($dri->protocol()->ns()->{'nsgroup'},'http://www.eurid.eu/xml/epp/nsgroup-1.1','nsgroup-1.1 for server announcing 1.1');
...
is($R1,$E1.'<command><check><nsgroup:check xmlns:nsgroup="http://www.eurid.eu/xml/epp/nsgroup-1.1"><nsgroup:name>nsg-a-1349684934</nsgroup:name><nsgroup:name>my-ns-group</nsgroup:name></nsgroup:check></check><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.1 check_multi build_xml');
...
$rc=$dri->nsgroup_create($c1);
is($R1,$E1.'<command><create><nsgroup:create xmlns:nsgroup="http://www.eurid.eu/xml/epp/nsgroup-1.1"><nsgroup:name>nsgroup-1349428719</nsgroup:name><nsgroup:ns>ns1.some-domain.eu</nsgroup:ns><nsgroup:ns>ns2.some-domain.eu</nsgroup:ns></nsgroup:create></create><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.0 create build');
is($rc->is_success(),1,'nsgroup-1.0 create is_success');
...
$rc=$dri->nsgroup_delete($c1);
is($R1,$E1.'<command><delete><nsgroup:delete xmlns:nsgroup="http://www.eurid.eu/xml/epp/nsgroup-1.1"><nsgroup:name>nsgroup-phenix</nsgroup:name></nsgroup:delete></delete><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.0 create build');
is($rc->is_success(),1,'nsgroup-1.0 create is_success');
...
is($R1,$E1.'<command><info><nsgroup:info xmlns:nsgroup="http://www.eurid.eu/xml/epp/nsgroup-1.1"><nsgroup:name>nsg-a-1349684934</nsgroup:name><nsgroup:authInfo><nsgroup:pw>XXXX-2MRN-MRAP-MXVR</nsgroup:pw></nsgroup:authInfo></nsgroup:info></info><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.0 create build');
is($rc->is_success(),1,'nsgroup-1.0 create is_success');
...
$toc->set('ns',$c2);
$rc=$dri->nsgroup_update($c1,$toc);
is($R1,$E1.'<command><update><nsgroup:update xmlns:nsgroup="http://www.eurid.eu/xml/epp/nsgroup-1.1"><nsgroup:name>nsgroup-1349428719</nsgroup:name><nsgroup:ns>ns1.some-other-domain.eu</nsgroup:ns><nsgroup:ns>ns2.some-other-domain.eu</nsgroup:ns></nsgroup:update></update><clTRID>clientref-123007</clTRID></command>'.$E2,'nsgroup-1.0 create build');
is($rc->is_success(),1,'nsgroup-1.0 create is_success');
