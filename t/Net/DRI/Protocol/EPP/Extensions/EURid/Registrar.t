...
is($dri->protocol()->ns()->{'registrarFinance'},'http://www.eurid.eu/xml/epp/registrarFinance-1.0','registrarFinance-1.0 for server announcing 1.0');
is($dri->protocol()->ns()->{'registrarHitPoints'},'http://www.eurid.eu/xml/epp/registrarHitPoints-1.0','registrarHitPoints-1.0 for server announcing 1.0');
is($dri->protocol()->ns()->{'registrationLimit'},'http://www.eurid.eu/xml/epp/registrationLimit-1.1','registrationLimit-1.1 for server announcing 1.1');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><registrar:info xmlns:registrar="http://www.eurid.eu/xml/epp/registrarFinance-1.0"/></info><clTRID>ABC-12345</clTRID></command></epp>','registrar_info finance (default) build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><registrar:info xmlns:registrar="http://www.eurid.eu/xml/epp/registrarFinance-1.0"/></info><clTRID>ABC-12345</clTRID></command></epp>','registrar_info finance build');
is($dri->get_info('action'),'info','registrar_info get_info(action)');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><registrar:info xmlns:registrar="http://www.eurid.eu/xml/epp/registrarHitPoints-1.0"/></info><clTRID>ABC-12345</clTRID></command></epp>','registrar_info hit_points build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><registrar:info xmlns:registrar="http://www.eurid.eu/xml/epp/registrationLimit-1.1"/></info><clTRID>ABC-12345</clTRID></command></epp>','registrar_info registration_limit build');
