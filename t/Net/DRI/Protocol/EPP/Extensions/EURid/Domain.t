...
is($dri->protocol()->ns()->{'domain-ext'},'http://www.eurid.eu/xml/epp/domain-ext-2.4','domain-ext 2.4 for server announcing 2.4');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>europa.eu</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command></epp>','domain_check build');
is($rc->is_success(),1,'domain_check is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>123.xn--e1a4c</domain:name><domain:name>xn--80aicaztaaflfnmi8azba8ddf.xn--e1a4c</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command></epp>','domain_check build');
is($rc->is_success(),1,'domain_check is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">domain-0006.eu</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">domain-0007.eu</domain:name></domain:info></info><extension><authInfo:info xmlns:authInfo="http://www.eurid.eu/xml/epp/authInfo-1.1"><authInfo:request/></authInfo:info></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
is($rc->is_success(),1,'domain_info is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">domain-0007c.eu</domain:name></domain:info></info><extension><authInfo:info xmlns:authInfo="http://www.eurid.eu/xml/epp/authInfo-1.1"><authInfo:cancel/></authInfo:info></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">domínio-qq.eu</domain:name><domain:authInfo><domain:pw>XXXX-2MRN-MRAP-MXVR</domain:pw></domain:authInfo></domain:info></info><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
is($rc->is_success(),1,'domain_info is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">nomen-hawg3nwn.eu</domain:name><domain:authInfo><domain:pw>XXXX-2MRN-MRAP-MXVR</domain:pw></domain:authInfo></domain:info></info><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
is($rc->is_success(),1,'domain_info is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">20190315-test001.eu</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
is($rc->is_success(),1,'domain_info is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testmldomupd-14092012001-01.eu</domain:name></domain:update></update><extension><domain-ext:update xmlns:domain-ext="http://www.eurid.eu/xml/epp/domain-ext-2.4"><domain-ext:add><domain-ext:nsgroup>nsg-b-1349684934</domain-ext:nsgroup><domain-ext:contact type="onsite">c165</domain-ext:contact><domain-ext:contact type="reseller">c164</domain-ext:contact></domain-ext:add><domain-ext:rem><domain-ext:nsgroup>nsg-a-1349684934</domain-ext:nsgroup><domain-ext:contact type="onsite">c163</domain-ext:contact></domain-ext:rem></domain-ext:update></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_update build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><delete><domain:delete xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdelete-1349683848.eu</domain:name></domain:delete></delete><extension><domain-ext:delete xmlns:domain-ext="http://www.eurid.eu/xml/epp/domain-ext-2.4"><domain-ext:schedule><domain-ext:delDate>2015-01-01T00:00:00.000000000Z</domain-ext:delDate></domain-ext:schedule></domain-ext:delete></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_delete (exDate) build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><delete><domain:delete xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdelete-1349683850.eu</domain:name></domain:delete></delete><clTRID>ABC-12345</clTRID></command></epp>','domain_delete (exDate) build');
is($rc->is_success(),1,'domain_delete is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><transfer op="query"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>вмкйршаудхыийведйкгг.ею</domain:name></domain:transfer></transfer><clTRID>ABC-12345</clTRID></command></epp>','domain_transfer_query build');
...
is_string($R1,$E1.'<command><info><dnsQuality:info xmlns:dnsQuality="http://www.eurid.eu/xml/epp/dnsQuality-2.0"><dnsQuality:name>dnsq_domain.eu</dnsQuality:name></dnsQuality:info></info><clTRID>ABC-12345</clTRID></command></epp>','domain_info build');
is($rc->is_success(),1,'domain_info is_success');
...
$R2=$E1.'<response>'.r().'<resData><domain:infData  xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>somedomain.eu</domain:name><domain:roid>somedomain_eu-EURID</domain:roid><domain:status s="ok"/><domain:clID>#non-disclosed#</domain:clID><domain:crID>#non-disclosed#</domain:crID><domain:crDate>2018-03-23T10:03:49.428Z</domain:crDate><domain:upID>#non-disclosed#</domain:upID><domain:upDate>2018-03-23T10:03:49.000Z</domain:upDate><domain:exDate>2019-03-23T22:59:59.999Z</domain:exDate></domain:infData></resData><extension xmlns:domain-ext-2.3="http://www.eurid.eu/xml/epp/domain-ext-2.4" xmlns:idn="http://www.eurid.eu/xml/epp/idn-1.0"><domain-ext-2.3:infData><domain-ext-2.3:onHold>false</domain-ext-2.3:onHold><domain-ext-2.3:quarantined>false</domain-ext-2.3:quarantined><domain-ext-2.3:suspended>false</domain-ext-2.3:suspended><domain-ext-2.3:seized>false</domain-ext-2.3:seized><domain-ext-2.3:delayed>false</domain-ext-2.3:delayed></domain-ext-2.3:infData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_info('somedomain.eu',{auth=>{pw=>'XXXX-393Y-DCZA-7XNS'}});
is($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">somedomain.eu</domain:name><domain:authInfo><domain:pw>XXXX-393Y-DCZA-7XNS</domain:pw></domain:authInfo></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build with auth - GDPR');
is($dri->get_info('action'),'info','domain_info get_info(action)');
is($dri->get_info('exist'),1,'domain_info get_info(exist)');
...
is_string($R1,$E1.'<command><info><dnssecEligibility:info xmlns:dnssecEligibility="http://www.eurid.eu/xml/epp/dnssecEligibility-1.0"><dnssecEligibility:name>somedomain.eu</dnssecEligibility:name></dnssecEligibility:info></info><clTRID>ABC-12345</clTRID></command></epp>','dnssec_eligibility_info build');
...
is_string($R1,$E1.'<command><info><dnssecEligibility:info xmlns:dnssecEligibility="http://www.eurid.eu/xml/epp/dnssecEligibility-1.0"><dnssecEligibility:name>somedomain2.eu</dnssecEligibility:name></dnssecEligibility:info></info><clTRID>ABC-12345</clTRID></command></epp>','dnssec_eligibility_info2 build');
...
# <domain:check>
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="false">somedomainlock.eu</domain:name><domain:reason lang="en">registered</domain:reason></domain:cd></domain:chkData></resData><extension xmlns:domain-ext-2.4="http://www.eurid.eu/xml/epp/domain-ext-2.4"><domain-ext-2.4:chkData><domain-ext-2.4:domain><domain-ext-2.4:name>somedomainlock.eu</domain-ext-2.4:name><domain-ext-2.4:status s="clientTransferProhibited"/></domain-ext-2.4:domain></domain-ext-2.4:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('somedomainlock.eu');
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>somedomainlock.eu</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command></epp>','domain_check build');
is($rc->is_success(),1,'domain_check is_success');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>somedomain-multiyear-transfer.eu</domain:name><domain:period unit="y">5</domain:period><domain:authInfo><domain:pw>XXXX-3GN6-Y27V-LTYY</domain:pw></domain:authInfo></domain:transfer></transfer><extension><domain-ext:transfer xmlns:domain-ext="http://www.eurid.eu/xml/epp/domain-ext-2.4"><domain-ext:request><domain-ext:registrant>c24</domain-ext:registrant><domain-ext:contact type="billing">c23</domain-ext:contact><domain-ext:contact type="onsite">c25</domain-ext:contact></domain-ext:request></domain-ext:transfer></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_transfer_start multi year build');
