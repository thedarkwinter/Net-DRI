...
## domain-ext-2.3 adds the delayed flag
...
# 2.2.1 (domain-ext-2.3) adds delayed emlement which i have monkeyed into this response
...
is($dri->get_info('delayed'), 1, 'domain get_info(delayed)');
