...
$toc->set('info',$co2);
$rc=$dri->contact_update($co,$toc);
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:ietf:params:xml:ns:epp-1.0 epp-1.0.xsd"><command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>sb3249</contact:id></contact:update></update><extension><contact-ext:update xmlns:contact-ext="http://www.eurid.eu/xml/epp/contact-ext-1.3" xsi:schemaLocation="http://www.eurid.eu/xml/epp/contact-ext-1.3 contact-ext-1.3.xsd"><contact-ext:chg><contact-ext:lang>nl</contact-ext:lang><contact-ext:naturalPerson>true</contact-ext:naturalPerson><contact-ext:countryOfCitizenship>NL</contact-ext:countryOfCitizenship></contact-ext:chg></contact-ext:update></extension><clTRID>TRID-0001</clTRID></command></epp>','contact_update build 3');
...
$toc->set('info',$co2);
$rc=$dri->contact_update($co,$toc);
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:ietf:params:xml:ns:epp-1.0 epp-1.0.xsd"><command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>sb3249</contact:id><contact:chg><contact:postalInfo type="loc"><contact:org/></contact:postalInfo></contact:chg></contact:update></update><extension><contact-ext:update xmlns:contact-ext="http://www.eurid.eu/xml/epp/contact-ext-1.3" xsi:schemaLocation="http://www.eurid.eu/xml/epp/contact-ext-1.3 contact-ext-1.3.xsd"><contact-ext:chg><contact-ext:vat/></contact-ext:chg></contact-ext:update></extension><clTRID>TRID-0001</clTRID></command></epp>','contact_update build 4');
