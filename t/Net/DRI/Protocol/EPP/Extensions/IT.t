...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">test.it</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('test.it');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test.it</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check standard build');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">tëst.it</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('xn--tst-jma.it');
utf8::encode($R1);
my $command = $E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>tëst.it</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2;
utf8::encode($command);
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">tëst2.it</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('tëst2.it');
utf8::encode($R1);
$command = $E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>tëst2.it</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2;
utf8::encode($command);
...
is_string($R1,$E1 . '<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">esempio.it</domain:name></domain:info></info><extension><extdom:infContacts op="all" xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"/></extension><clTRID>ABC-12345</clTRID></command>' . $E2,'domain_info build');
...
is_string($R1,$E1 . '<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">esempio2.it</domain:name></domain:info></info><extension><extdom:infContacts op="registrant" xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"/></extension><clTRID>ABC-12345</clTRID></command>' . $E2,'domain_info build');
is($dri->get_info('exist'),1,'domain_info get_info(exist)');
...
is_string($R1,$E1 . '<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esempio.it</domain:name><domain:authInfo><domain:pw>ABC321</domain:pw></domain:authInfo></domain:transfer></transfer><extension><extdom:trade xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"><extdom:transferTrade><extdom:newRegistrant>C123</extdom:newRegistrant><extdom:newAuthInfo><extdom:pw>ABC123</extdom:pw></extdom:newAuthInfo></extdom:transferTrade></extdom:trade></extension><clTRID>ABC-12345</clTRID></command>' . $E2,'domain_transfer_start build');
...
is_string($R1,$E1 . '<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>ABC-123</contact:id></contact:info></info><clTRID>ABC-12345</clTRID></command>' . $E2,'contact_info build');
...
is_string($R1,$E1 . '<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>TECH001</contact:id></contact:info></info><clTRID>ABC-12345</clTRID></command>' . $E2,'contact_info build');
$c = $dri->get_info('self');
...
is_string($R1,$E1 . '<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>MR0001</contact:id></contact:info></info><clTRID>ABC-12345</clTRID></command>' . $E2,'contact_info build');
$c = $dri->get_info('self');
...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esempio.it</domain:name><domain:period unit="y">1</domain:period><domain:ns><domain:hostAttr><domain:hostName>x.dns.it</domain:hostName></domain:hostAttr><domain:hostAttr><domain:hostName>y.dns.it</domain:hostName></domain:hostAttr></domain:ns><domain:registrant>mm001</domain:registrant><domain:contact type="admin">mm001</domain:contact><domain:contact type="tech">mb001</domain:contact><domain:authInfo><domain:pw>22fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><secDNS:create xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:dsData><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>4347d0f8ba661234a8eadc005e2e1d1b646c9682</secDNS:digest></secDNS:dsData></secDNS:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create SecDNS build');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esempio.it</domain:name></domain:update></update><extension><secDNS:update xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:rem><secDNS:dsData><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>4347d0f8ba661234a8eadc005e2e1d1b646c9682</secDNS:digest></secDNS:dsData></secDNS:rem><secDNS:add><secDNS:dsData><secDNS:keyTag>45063</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>2</secDNS:digestType><secDNS:digest>E9B696C3AC8644735BF0A6409BE6D77BBFB4142D667E0EB0D41AD75BCC9D0D43</secDNS:digest></secDNS:dsData></secDNS:add></secDNS:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update SecDNS build');
...
$toc->del('secdns','all');
$rc=$dri->domain_update('esempio.it',$toc);
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esempio.it</domain:name></domain:update></update><extension><secDNS:update xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:rem><secDNS:all>true</secDNS:all></secDNS:rem></secDNS:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update SecDNS build (remove ALL)');
...
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esempio.it</domain:name><domain:roid>ITNIC-306194</domain:roid><domain:status s="inactive" lang="en"/><domain:registrant>MM001</domain:registrant><domain:contact type="admin">MM001</domain:contact><domain:contact type="tech">MB001</domain:contact><domain:clID>DEMO-REG</domain:clID><domain:crID>DEMO-REG</domain:crID><domain:crDate>2016-06-29T08:26:44.000+02:00</domain:crDate><domain:exDate>2017-06-29T23:59:59.000+02:00</domain:exDate><domain:authInfo><domain:pw>22fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><extdom:infData xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"><extdom:ownStatus s="dnsHold" lang="en"/></extdom:infData><extdom:infNsToValidateData xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"><extdom:nsToValidate><domain:hostAttr xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:hostName>m.dns.it</domain:hostName></domain:hostAttr><domain:hostAttr xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:hostName>j.dns.it</domain:hostName></domain:hostAttr></extdom:nsToValidate></extdom:infNsToValidateData><extsecDNS:infDsOrKeyToValidateData xmlns:extsecDNS="http://www.nic.it/ITNIC-EPP/extsecDNS-1.0"><extsecDNS:dsOrKeysToValidate><secDNS:dsData xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>4347d0f8ba661234a8eadc005e2e1d1b646c9682</secDNS:digest></secDNS:dsData></extsecDNS:dsOrKeysToValidate></extsecDNS:infDsOrKeyToValidateData></extension>'.$TRID.'</response>'.$E2;
...
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esempio.it</domain:name><domain:roid>ITNIC-306194</domain:roid><domain:status s="inactive" lang="en"/><domain:registrant>MM001</domain:registrant><domain:contact type="admin">MM001</domain:contact><domain:contact type="tech">MB001</domain:contact><domain:clID>DEMO-REG</domain:clID><domain:crID>DEMO-REG</domain:crID><domain:crDate>2016-06-29T08:26:44.000+02:00</domain:crDate><domain:exDate>2017-06-29T23:59:59.000+02:00</domain:exDate><domain:authInfo><domain:pw>22fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><extdom:infData xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"><extdom:ownStatus s="dnsHold" lang="en"/></extdom:infData><extdom:infNsToValidateData xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"><extdom:nsToValidate><domain:hostAttr xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:hostName>m.dns.it</domain:hostName></domain:hostAttr><domain:hostAttr xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:hostName>j.dns.it</domain:hostName></domain:hostAttr></extdom:nsToValidate></extdom:infNsToValidateData><extsecDNS:infDsOrKeyToValidateData xmlns:extsecDNS="http://www.nic.it/ITNIC-EPP/extsecDNS-1.0"><extsecDNS:dsOrKeysToValidate><secDNS:dsData xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>4347d0f8ba661234a8eadc005e2e1d1b646c9682</secDNS:digest></secDNS:dsData><secDNS:dsData xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:keyTag>45063</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>2</secDNS:digestType><secDNS:digest>E9B696C3AC8644735BF0A6409BE6D77BBFB4142D667E0EB0D41AD75BCC9D0D43</secDNS:digest></secDNS:dsData></extsecDNS:dsOrKeysToValidate></extsecDNS:infDsOrKeyToValidateData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_info('esenpio.it');
...
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esenpio2.it</domain:name><domain:roid>ITNIC-306194</domain:roid><domain:status s="pendingUpdate" lang="en"/><domain:registrant>MM001</domain:registrant><domain:contact type="admin">MM001</domain:contact><domain:contact type="tech">MB001</domain:contact><domain:ns><domain:hostAttr><domain:hostName>m.dns.it</domain:hostName></domain:hostAttr><domain:hostAttr><domain:hostName>j.dns.it</domain:hostName></domain:hostAttr></domain:ns><domain:clID>DEMO-REG</domain:clID><domain:crID>DEMO-REG</domain:crID><domain:crDate>2016-06-29T08:26:44.000+02:00</domain:crDate><domain:upID>DEMO-REG</domain:upID><domain:upDate>2016-06-29T08:26:45.000+02:00</domain:upDate><domain:exDate>2017-06-29T23:59:59.000+02:00</domain:exDate><domain:authInfo><domain:pw>22fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><extdom:infNsToValidateData xmlns:extdom="http://www.nic.it/ITNIC-EPP/extdom-2.0"><extdom:nsToValidate><domain:hostAttr xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:hostName>n.dns.it</domain:hostName></domain:hostAttr><domain:hostAttr xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:hostName>k.dns.it</domain:hostName></domain:hostAttr></extdom:nsToValidate></extdom:infNsToValidateData><secDNS:infData xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:dsData><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>4347d0f8ba661234a8eadc005e2e1d1b646c9682</secDNS:digest></secDNS:dsData></secDNS:infData><extsecDNS:infDsOrKeyToValidateData xmlns:extsecDNS="http://www.nic.it/ITNIC-EPP/extsecDNS-1.0"><extsecDNS:dsOrKeysToValidate><secDNS:dsData xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:keyTag>45063</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>2</secDNS:digestType><secDNS:digest>E9B696C3AC8644735BF0A6409BE6D77BBFB4142D667E0EB0D41AD75BCC9D0D43</secDNS:digest></secDNS:dsData></extsecDNS:dsOrKeysToValidate></extsecDNS:infDsOrKeyToValidateData></extension>'.$TRID.'</response>'.$E2;
...
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>esenpio3.it</domain:name><domain:roid>ITNIC-306194</domain:roid><domain:status s="pendingUpdate" lang="en"/><domain:registrant>MM001</domain:registrant><domain:contact type="admin">MM001</domain:contact><domain:contact type="tech">MB001</domain:contact><domain:ns><domain:hostAttr><domain:hostName>m.dns.it</domain:hostName></domain:hostAttr><domain:hostAttr><domain:hostName>j.dns.it</domain:hostName></domain:hostAttr></domain:ns><domain:clID>DEMO-REG</domain:clID><domain:crID>DEMO-REG</domain:crID><domain:crDate>2016-06-29T08:26:44.000+02:00</domain:crDate><domain:upID>DEMO-REG</domain:upID><domain:upDate>2016-06-29T08:26:45.000+02:00</domain:upDate><domain:exDate>2017-06-29T23:59:59.000+02:00</domain:exDate><domain:authInfo><domain:pw>22fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><secDNS:infData xmlns:secDNS="urn:ietf:params:xml:ns:secDNS-1.1"><secDNS:dsData><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>4347d0f8ba661234a8eadc005e2e1d1b646c9682</secDNS:digest></secDNS:dsData></secDNS:infData><extsecDNS:infDsOrKeyToValidateData xmlns:extsecDNS="http://www.nic.it/ITNIC-EPP/extsecDNS-1.0"><extsecDNS:remAll/></extsecDNS:infDsOrKeyToValidateData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><create><contact:create xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>mr0001</contact:id><contact:postalInfo type="loc"><contact:name>Mario Rossi</contact:name><contact:addr><contact:street>Via Moruzzi 1</contact:street><contact:city>Pisa</contact:city><contact:sp>PI</contact:sp><contact:pc>56124</contact:pc><contact:cc>IT</contact:cc></contact:addr></contact:postalInfo><contact:voice x="2111">+39.050315</contact:voice><contact:fax>+39.0503152593</contact:fax><contact:email>mario.rossi@example.it</contact:email><contact:authInfo><contact:pw/></contact:authInfo></contact:create></create><extension><extcon:create xmlns:extcon="http://www.nic.it/ITNIC-EPP/extcon-1.0"><extcon:consentForPublishing>true</extcon:consentForPublishing></extcon:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_create build');
...
$toc->set('info',$co2);
$rc=$dri->contact_update($co,$toc);
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>mm001</contact:id></contact:update></update><extension><extcon:update xmlns:extcon="http://www.nic.it/ITNIC-EPP/extcon-1.0"><extcon:consentForPublishing>false</extcon:consentForPublishing></extcon:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update extcon build');
