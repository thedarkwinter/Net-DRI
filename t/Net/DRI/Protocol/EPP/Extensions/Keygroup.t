...
is($dri->protocol()->ns()->{'keygroup'},'http://www.dns.be/xml/epp/keygroup-1.0','keygroup-1.0 for server announcing 1.0');

$rc=$dri->keygroup_create('kwkwwyjzorsqljbvlssqhzz');
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><create><keygroup:create xmlns:keygroup="http://www.dns.be/xml/epp/keygroup-1.0"><keygroup:name>kwkwwyjzorsqljbvlssqhzz</keygroup:name></keygroup:create></create><clTRID>TRID-0001</clTRID></command></epp>','keygroup-1.0 create build 1');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><keygroup:check xmlns:keygroup="http://www.dns.be/xml/epp/keygroup-1.0"><keygroup:name>zgrruirkeklhgeclxjnsccnwawexfigfzxvqwyjzzrrfdar</keygroup:name><keygroup:name>jbzrndytpkijpejbmogzdoxmtfqzxus</keygroup:name><keygroup:name>dhrejofkvcdrwwwddxqblgdpbpxgqayowadwvedqewnpqdyi</keygroup:name><keygroup:name>bcoriadjxfgdtrapgkjwlyatof</keygroup:name></keygroup:check></check><clTRID>TRID-0001</clTRID></command></epp>','keygroup-1.0 check build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><keygroup:info xmlns:keygroup="http://www.dns.be/xml/epp/keygroup-1.0"><keygroup:name>jbzrndytpkijpejbmogzdoxmtfqzxus</keygroup:name></keygroup:info></info><clTRID>TRID-0001</clTRID></command></epp>','keygroup-1.0 info build');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><update><keygroup:update xmlns:keygroup="http://www.dns.be/xml/epp/keygroup-1.0"><keygroup:name>krqkdcnjtiigrbvgrsom</keygroup:name></keygroup:update></update><clTRID>TRID-0001</clTRID></command></epp>','keygroup-1.0 update empty keys');
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><update><keygroup:update xmlns:keygroup="http://www.dns.be/xml/epp/keygroup-1.0"><keygroup:name>latrvxveoruzciiuuqfurexahnxqf</keygroup:name><keygroup:key><keygroup:keyTag>49049</keygroup:keyTag><keygroup:flags>256</keygroup:flags><keygroup:protocol>3</keygroup:protocol><keygroup:algorithm>7</keygroup:algorithm><keygroup:pubKey>AwEAAaQx/SAfK9rmTYsyThhUgvUBQORqQhUNbcIx67sfUtC6Ii1WHn0CdIMcO8FUMT3PE7BhJ04zYiJdX2Gr6VEHXW0=</keygroup:pubKey></keygroup:key><keygroup:key><keygroup:keyTag>57695</keygroup:keyTag><keygroup:flags>256</keygroup:flags><keygroup:protocol>3</keygroup:protocol><keygroup:algorithm>7</keygroup:algorithm><keygroup:pubKey>AwEAAdVHFEnY8q8xuiiSO0XvX0LWlcCMWQByFyyCzPFfUmso0677qjIZ YEF/fIx/WJuIRup1/Ay58U8pvCnsk0iXIV0=</keygroup:pubKey></keygroup:key></keygroup:update></update><clTRID>TRID-0001</clTRID></command></epp>','keygroup-1.0 update add 2 keys');
...
$rc=$dri->process('session','noop',[]);
is($dri->protocol()->ns()->{'keygroup'},'http://www.eurid.eu/xml/epp/keygroup-1.1','keygroup 1.1 for server announcing 1.1');
...
is_string($R1,$E1.'<command><check><keygroup:check xmlns:keygroup="http://www.eurid.eu/xml/epp/keygroup-1.1"><keygroup:name>keygroup-135089830472</keygroup:name><keygroup:name>keygroup-1350898304165</keygroup:name></keygroup:check></check><clTRID>TRID-0001</clTRID></command>'.$E2,'keygroup-1.1 check_multi build_xml');
...
is_string($R1,$E1.'<command><create><keygroup:create xmlns:keygroup="http://www.eurid.eu/xml/epp/keygroup-1.1"><keygroup:name>keygroup-135089830472</keygroup:name></keygroup:create></create><clTRID>TRID-0001</clTRID></command>'.$E2,'keygroup-1.1 create build_xml');
...
is_string($R1,$E1.'<command><info><keygroup:info xmlns:keygroup="http://www.eurid.eu/xml/epp/keygroup-1.1"><keygroup:name>keygroup-empty</keygroup:name></keygroup:info></info><clTRID>TRID-0001</clTRID></command>'.$E2,'keygroup-1.1 info build_xml');
...
is_string($R1,$E1.'<command><info><keygroup:info xmlns:keygroup="http://www.eurid.eu/xml/epp/keygroup-1.1"><keygroup:name>keygroup-full</keygroup:name><keygroup:authInfo><keygroup:pw>XXXX-2MRN-MRAP-MXVR</keygroup:pw></keygroup:authInfo></keygroup:info></info><clTRID>TRID-0001</clTRID></command>'.$E2,'keygroup-1.1 info build_xml');
is($rc->is_success(),1,'keygroup-1.1 info is_success');
...
is_string($R1,$E1.'<command><update><keygroup:update xmlns:keygroup="http://www.eurid.eu/xml/epp/keygroup-1.1"><keygroup:name>keygroup-1350898304275</keygroup:name></keygroup:update></update><clTRID>TRID-0001</clTRID></command>'.$E2,'keygroup-1.1 update remove_all_keys build_xml');
