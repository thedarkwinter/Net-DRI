...
is( is_decimal($d->{command}->{create}->{fee_registration_fee}), 1, 'fee_registration_fee is a decimal number' );
is( is_decimal($d->{command}->{create}->{fee_application_fee}), 1, 'fee_application_fee is a decimal number' );
is( is_decimal($d->{command}->{create}->{fee}), 1, 'fee_application_fee is a decimal number' );
