...
$dri->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv}, {extensions=>['-CentralNic::Fee','Fee'],brown_fee_version=>'0.21'});
...
####################################################################################################
## Fee extension version 0.21 https://tools.ietf.org/html/draft-ietf-regext-epp-fees-05
## We use a greeting here to switch the namespace version here to -0.21 testing
$R2=$E1.'<greeting><svID>fee-0.21-server</svID><svDate>2014-11-21T10:10:46.0751Z</svDate><svcMenu><version>1.0</version><lang>en</lang><objURI>urn:ietf:params:xml:ns:host-1.0</objURI><objURI>urn:ietf:params:xml:ns:domain-1.0</objURI><objURI>urn:ietf:params:xml:ns:contact-1.0</objURI><svcExtension><extURI>urn:ietf:params:xml:ns:launch-1.0</extURI><extURI>urn:ietf:params:xml:ns:rgp-1.0</extURI><extURI>urn:ietf:params:xml:ns:secDNS-1.1</extURI><extURI>urn:ietf:params:xml:ns:fee-0.21</extURI></svcExtension></svcMenu><dcp><access><all /></access><statement><purpose><admin /><prov /></purpose><recipient><ours /><public /></recipient><retention><stated /></retention></statement></dcp></greeting>'.$E2;
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-1.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using action)');

# specify command(s) as an array
$rc=$dri->domain_check('explore-2.space',{fee=>{currency => 'USD',command=>('create')}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-2.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using array)');

# specify command(s) as an arrayref
$rc=$dri->domain_check('explore-3.space',{fee=>{currency => 'USD',command=>['create']}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-3.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using ref array)');
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-4.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create" phase="sunrise"/><fee:command name="renew"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using array of hashes with two commands)');
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-5.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"><fee:period unit="y">2</fee:period></fee:command></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using array of hashes inclding duration)');
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-0.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_...');
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore.space</domain:name><domain:name>discover.space</domain:name><domain:name>colonize.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"><fee:period unit="y">2</fee:period></fee:command><fee:command name="renew"/><fee:command name="transfer"/><fee:command name="restore"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_...');
...
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore.space</domain:name><domain:crDate>1999-04-03T22:00:00.0Z</domain:crDate><domain:exDate>2001-04-03T22:00:00.0Z</domain:exDate></domain:creData></resData><extension><fee:creData xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee description="Registration Fee" refundable="1" grace-period="P5D">5.00</fee:fee><fee:balance>-5.00</fee:balance><fee:creditLimit>1000.00</fee:creditLimit></fee:creData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-more.space</domain:name><domain:period unit="y">2</domain:period><domain:ns><domain:hostObj>ns1.discover.space</domain:hostObj><domain:hostObj>ns2.discover.space</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><fee:create xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee>5.00</fee:fee><fee:fee description="Early Access Period">100.00</fee:fee></fee:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_create build_xml');

$fee = {currency=>'USD',fee=>[{fee=>'5.00', description=>'create'}, {fee=>'100.00', 'description'=>'Early Access Period'}]};
$rc=$dri->domain_create('explore-more.space',{pure_create=>1,duration=>DateTime::Duration->new(years=>2),ns=>$dri->local_object('hosts')->set(['ns1.discover.space'],['ns2.discover.space']),contact=>$cs,auth=>{pw=>'2fooBAR'},fee=>$fee});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-more.space</domain:name><domain:period unit="y">2</domain:period><domain:ns><domain:hostObj>ns1.discover.space</domain:hostObj><domain:hostObj>ns2.discover.space</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><fee:create xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee description="create">5.00</fee:fee><fee:fee description="Early Access Period">100.00</fee:fee></fee:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_create build_xml');

###################
###### domain_delete

$R2=$E1.'<response>'.r().'<extension><fee:delData xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:credit description="AGP Credit">-5.00</fee:credit><fee:balance>1005.00</fee:balance></fee:delData></extension>'.$TRID.'</response>'.$E2;
...
$R2=$E1.'<response>'.r().'<resData><domain:renData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore.space</domain:name><domain:exDate>2005-04-03T22:00:00.0Z</domain:exDate></domain:renData></resData><extension><fee:renData xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee refundable="1" grace-period="P5D">5.00</fee:fee><fee:balance>1000.00</fee:balance></fee:renData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore.space</domain:name><domain:period unit="y">1</domain:period><domain:authInfo><domain:pw roid="JD1234-REP">2fooBAR</domain:pw></domain:authInfo></domain:transfer></transfer><extension><fee:transfer xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee>5.00</fee:fee></fee:transfer></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_transfer_start build_xml');
...
$R2=$E1.'<response>'.r().'<extension><fee:updData xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee>5.00</fee:fee></fee:updData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore.space</domain:name><domain:chg><domain:registrant>sh8013</domain:registrant></domain:chg></domain:update></update><extension><fee:update xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:fee>5.00</fee:fee></fee:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_update (restore) build_xml');
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>premium-0.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check (premium) build_xml');
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-11.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create" phase="sunrise"/><fee:command name="renew"/><fee:command name="transfer"/><fee:command name="restore"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using array of hashes with two commands)');

$rc=$dri->domain_check_price('explore-12.space',{'currency' => 'USD', 'phase'=>'custom', 'sub_phase' => 'prebook', 'duration' => 5});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-12.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:currency>USD</fee:currency><fee:command name="create" phase="custom" subphase="prebook"><fee:period unit="y">5</fee:period></fee:command><fee:command name="renew"><fee:period unit="y">5</fee:period></fee:command><fee:command name="transfer"><fee:period unit="y">5</fee:period></fee:command><fee:command name="restore"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using array of hashes with two commands)');

$rc=$dri->domain_check_price('explore-13.space');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>explore-13.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:command name="create"/><fee:command name="renew"/><fee:command name="transfer"/><fee:command name="restore"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build_xml (using array of hashes with two commands)');


####################################################################################################
###### domain_check (premium domain - TangoRS::CORE)
###### This test is taken from .radio manual - but not all TangoRS registries use this extension!

$dri->add_current_registry('TangoRS::CORE');
$dri->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv}, {extensions=>['Fee'],fee_version=>'0.21'});

$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="false">premium-pc-400.radio</domain:name><domain:reason>not registrable in this phase</domain:reason></domain:cd></domain:chkData></resData><extension><chkData xmlns="urn:ietf:params:xml:ns:fee-0.21"><currency>EUR</currency><cd><objID>premium-pc-400.radio</objID><command name="create" phase="open"><reason>the requested launch phase is not suitable for the domain</reason></command><command name="create" phase="custom" subphase="open-400"><period unit="y">1</period><fee applied="immediate" description="domain creation in phase \'open-400\'" grace-period="PT1M" refundable="true">400.00</fee></command></cd></chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('premium-pc-400.radio',{fee=>{command=>'create'}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>premium-pc-400.radio</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.21"><fee:command name="create"/></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check (TangoRS premium) build_xml');

is($rc->is_success(),1,'domain_check is_success');
is($dri->get_info('action'),'check','domain_check get_info (action)');
$d = shift @{$dri->get_info('fee')};
is($d->{domain},'premium-pc-400.radio','domain_check get_info(domain)');
#is($d->{price_avail},1,'domain_check parse fee (price_avail)'); # not used!
is($d->{premium},1,'domain_check parse premium');
is($d->{currency},'EUR','domain_check get_info(currency)');
is($d->{command}->{create}->{fee},400.00,'domain_check get_info(fee)');
is($d->{command}->{create}->{phase},'custom','domain_check get_info(phase)');
is($d->{command}->{create}->{sub_phase},'open-400','domain_check get_info(sub_phase)');
is($d->{command}->{create}->{duration}->years(),'1','domain_check get_info(duration)');
