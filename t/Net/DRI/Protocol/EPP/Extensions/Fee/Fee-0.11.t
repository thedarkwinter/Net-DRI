...
$dri->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv},{extensions=>['Fee','-CentralNIC::Fee','-VeriSign::NameStore'],});

my ($rc,$s,$d,$dh,@c,$toc,$cs,$c1,$c2,@fees);

####################################################################################################
## Fee extension version 0.11 https://tools.ietf.org/html/draft-ietf-regext-epp-fees-00
...
####################################################################################################
### check command and response copied draft-ietf-regext-epp-fees-00 5.1.1 but names changes, and I have stuck in some extra stuff to test more
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">tourism.com</domain:name></domain:cd><domain:cd><domain:name avail="1">holidays.com</domain:name></domain:cd><domain:cd><domain:name avail="1">hotels.com</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.11" xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><fee:cd avail="1"><fee:object><domain:name>tourism.com</domain:name></fee:object><fee:command phase="sunrise">create</fee:command><fee:currency>USD</fee:currency><fee:period unit="y">1</fee:period><fee:fee description="Registration Fee" refundable="1" grace-period="P5D">5.00</fee:fee></fee:cd><fee:cd avail="1"><fee:object><domain:name>holidays.com</domain:name></fee:object><fee:command phase="claims" subphase="landrush">create</fee:command><fee:currency>EUR</fee:currency><fee:period unit="y">2</fee:period><fee:fee description="Registration Fee" refundable="1" grace-period="P5D">5.00</fee:fee></fee:cd><fee:cd avail="0"><fee:object><domain:name>hotels.com</domain:name></fee:object><fee:command>transfer</fee:command><fee:currency>EUR</fee:currency><fee:period unit="y">2</fee:period><fee:reason>minimum period is 2 years.</fee:reason></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
...
@fees = (
  { domain=>'tourism.com','element'=>'name',currency=>'USD',action=>'create',phase=>'sunrise' },
  { domain=>'holidays.com',currency=>'EUR',action=>'create',phase=>'claims',sub_phase=>'landrush',duration=>$dri->local_object('duration','years',2) },
  { domain=>'hotels.com',currency=>'EUR',action=>'transfer' },
  { domain=>'restaurants.com',action=>'restore' }
);
$rc=$dri->domain_check('tourism.com','holidays.com','hotels.com', {fee=>\@fees});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>tourism.com</domain:name><domain:name>holidays.com</domain:name><domain:name>hotels.com</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.11" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.11 fee-0.11.xsd"><fee:command phase="sunrise">create</fee:command><fee:currency>USD</fee:currency></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check_multi build backwards compatibility');

$dri->cache_clear();
$rc=$dri->domain_check('tourism.com','holidays.com','hotels.com', { fee=> { action => 'create', 'currency' => 'USD' } });
...
is($dri->get_info('exist','domain','tourism.com'),0,'domain_check multi get_info(exist) 1/3');
is($dri->get_info('exist','domain','holidays.com'),0,'domain_check multi get_info(exist) 2/3');
is($dri->get_info('exist','domain','hotels.com'),0,'domain_check multi get_info(exist) 3/3');
$d = shift @{$dri->get_info('fee','domain','tourism.com')};
is($d->{domain},'tourism.com','domain_check multi get_info(domain) 1/4');
...
$d = shift @{$dri->get_info('fee','domain','holidays.com')};
is($d->{domain},'holidays.com','domain_check multi get_info(domain) 2/4');
...
$d = shift @{$dri->get_info('fee','domain','hotels.com')};
is($d->{domain},'hotels.com','domain_check multi get_info(domain) 3/4');
...
is($dri->get_info('is_premium','domain','hotels.com'),0,'domain_check_multi get_info (is_premium) undef');
is($dri->get_info('price_duration','domain','tourism.com')->years(),1,'domain_check get_info (price_duration)');
is($dri->get_info('create_price','domain','holidays.com'),5.00,'domain_check_multi get_info (create_price)');
#is($dri->get_info('transfer_price','domain','hotels.com'),12.50,'domain_check_multi get_info (transfer_price)');
#is($dri->get_info('restore_price','domain','restaurants.com'),25,'domain_check_multi get_info (restore_price)');

####################################################################################################
### Copied From fee-0.9 tests an manually adjusted

## Check: single domain - minimum data on renew for premium
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">check-claims-landrush.com</domain:name></domain:cd><domain:cd><domain:name avail="1">check-claims-landrush.com</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.11" xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><fee:cd avail="1"><fee:object><domain:name>check-claims-landrush.com</domain:name></fee:object><fee:command>renew</fee:command><fee:currency>EUR</fee:currency><fee:period unit="y">2</fee:period><fee:fee description="Renewal Fee" refundable="1" grace-period="P5D">650.00</fee:fee><fee:class>premium</fee:class></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('check-claims-landrush.com',{fee=>{action=>'renew', duration=>DateTime::Duration->new(years=>2), 'currency' => 'EUR'}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>check-claims-landrush.com</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.11" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.11 fee-0.11.xsd"><fee:command>renew</fee:command><fee:currency>EUR</fee:currency><fee:period unit="y">2</fee:period></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
...
is($d->{domain},'check-claims-landrush.com','Fee extension: domain_check single parse domain');
...
$dri->cache_clear();
# domain_check_price
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">check-sunrise.com</domain:name></domain:cd><domain:cd><domain:name avail="1">check-claims-landrush.com</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.11" xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><fee:cd avail="1"><fee:object><domain:name>check-sunrise.com</domain:name></fee:object><fee:command phase="sunrise">create</fee:command><fee:currency>USD</fee:currency><fee:period unit="y">2</fee:period><fee:fee description="Registration Fee" refundable="1" grace-period="P5D">5000.00</fee:fee><fee:class>premium</fee:class></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check_price('check-sunrise.com',{action=>'create', duration=>DateTime::Duration->new(years=>2), 'currency' => 'USD', 'phase' => 'sunrise'});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>check-sunrise.com</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.11" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.11 fee-0.11.xsd"><fee:command phase="sunrise">create</fee:command><fee:currency>USD</fee:currency><fee:period unit="y">2</fee:period></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
is($dri->get_info('action'),'check','domain_check_price get_info(action)');
is($dri->get_info('exist'),0,'domain_check_price get_info(exist)');
$d = shift @{$dri->get_info('fee')};
is($d->{domain},'check-sunrise.com','Fee extension: domain_check_price single parse domain');
