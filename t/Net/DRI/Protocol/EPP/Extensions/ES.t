...
our $ES_EXT = '<extension><es_creds:es_creds xmlns:es_creds="urn:red.es:xml:ns:es_creds-1.0"><es_creds:clID>LOGIN</es_creds:clID><es_creds:pw>PASSWORD</es_creds:pw></es_creds:es_creds></extension>';
...
is($R1,$E1.'<command><info><es_bandeja:info xmlns:es_bandeja="urn:red.es:xml:ns:es_bandeja-1.0"><es_bandeja:fechaDesde>2013-01-01T00:00:00</es_bandeja:fechaDesde><es_bandeja:fechaHasta>2013-01-21T00:00:00</es_bandeja:fechaHasta><es_bandeja:nombreDominio>test1.es</es_bandeja:nombreDominio><es_bandeja:tipoCategoria>10</es_bandeja:tipoCategoria><es_bandeja:tipoMensaje>3</es_bandeja:tipoMensaje></es_bandeja:info></info>'.$ES_EXT.'<clTRID>ABC-12345</clTRID></command>'.$E2,'tray_info build');
...
## Domain commands
#check
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">test1.es</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('test1.es');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test1.es</domain:name></domain:check></check>'.$ES_EXT.'<clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test1.es</domain:name><domain:add><domain:ns>ns3.example.info</domain:ns><domain:contact type="tech">98765</domain:contact></domain:add><domain:rem><domain:contact type="tech">12347</domain:contact></domain:rem><domain:autoRenew>true</domain:autoRenew></domain:update></update>'.$ES_EXT.'<clTRID>ABC-12345</clTRID></command></epp>', 'domain_update build');
is($rc->is_success(), 1, 'domain_update is success');

#renew
$R2=$E1.'<response>'.r().'<resData><domain:renData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test1.es</domain:name><domain:exDate>2015-01-01T00:00:00.01</domain:exDate></domain:renData></resData>'.$TRID.'</response>'.$E2;
...
#transfer
$R2=$E1.'<response>'.r().'<resData><domain:trnData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test1.es</domain:name><domain:trStatus>pending</domain:trStatus><domain:reID>re123</domain:reID><domain:reDate>2013-03-06T02:45:23</domain:reDate><domain:acID>ac32</domain:acID><domain:acDate>2013-04-01T13:00:00</domain:acDate><domain:exDate>2015-01-01T00:00:00.00</domain:exDate></domain:trnData></resData>'.$TRID.'</response>'.$E2;
$rc = $dri->domain_transfer_start('test1.es',{auto_renew=>'no'} );
is($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test1.es</domain:name><domain:autoRenew>false</domain:autoRenew></domain:transfer></transfer>'.$ES_EXT.'<clTRID>ABC-12345</clTRID></command></epp>', 'domain_transfer_start build');
...
#check
$R2=$E1.'<response>'.r().'<resData><contact:chkData xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:cd><contact:id avail="true">12345</contact:id></contact:cd></contact:chkData></resData>'.$TRID.'</response>'.$E2;
$rc = $dri->contact_check($dri->local_object('contact')->srid('12345'));
is($R1, $E1.'<command><check><contact:check xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>12345</contact:id></contact:check></check>'.$ES_EXT.'<clTRID>ABC-12345</clTRID></command></epp>', 'contact_check build');
...
is($R1, $E1.'<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>12345</contact:id></contact:info></info>'.$ES_EXT.'<clTRID>ABC-12345</clTRID></command></epp>', 'contact_info build');
...
is($R1,$E1.'<command><create><host:create xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns14.testepp.es</host:name><host:addr ip="v4">192.168.0.14</host:addr><host:addr ip="v6">2001:0DB8:02de::0e13</host:addr></host:create></create><extension><es_creds:es_creds xmlns:es_creds="urn:red.es:xml:ns:es_creds-1.0"><es_creds:clID>LOGIN</es_creds:clID><es_creds:pw>PASSWORD</es_creds:pw></es_creds:es_creds></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'host_create build');
####################################################################################################
