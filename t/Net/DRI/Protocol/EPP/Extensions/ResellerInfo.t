...
$cs->set($c2,'billing');
$R2='';
$rc=$dri->domain_create('reseller.com',{pure_create=>1,duration=>DateTime::Duration->new(years=>3),ns=>$dri->local_object('hosts')->set(['ns1.example.com']),contact=>$cs,auth=>{pw=>'fooBAR',roid=>'ddddd-dddd'}, reseller => { id => 'myreseller', name => 'example'}});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>reseller.com</domain:name><domain:period unit="y">3</domain:period><domain:ns><domain:hostObj>ns1.example.com</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="billing">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw roid="ddddd-dddd">fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><resellerext:create xmlns:resellerext="urn:ietf:params:xml:ns:resellerext-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:resellerext-1.0 resellerext-1.0.xsd"><resellerext:resID>myreseller</resellerext:resID><resellerext:resName>example</resellerext:resName></resellerext:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build');



$R2='';
my $toc=$dri->local_object('changes');
$toc->add('reseller',{ id => 'myreseller', name => 'example' });
$rc=$dri->domain_update('example.com',$toc);
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.com</domain:name></domain:update></update><extension><resellerext:update xmlns:resellerext="urn:ietf:params:xml:ns:resellerext-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:resellerext-1.0 resellerext-1.0.xsd"><resellerext:add><resellerext:resID>myreseller</resellerext:resID><resellerext:resName>example</resellerext:resName></resellerext:add></resellerext:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update add build');

$toc=$dri->local_object('changes');
$toc->del('reseller',{ id => 'myreseller' });
$rc=$dri->domain_update('example.com',$toc);
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.com</domain:name></domain:update></update><extension><resellerext:update xmlns:resellerext="urn:ietf:params:xml:ns:resellerext-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:resellerext-1.0 resellerext-1.0.xsd"><resellerext:rem><resellerext:resID>myreseller</resellerext:resID></resellerext:rem></resellerext:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update rem build');

$toc=$dri->local_object('changes');
$toc->set('reseller',{ id => 'myreseller' });
$rc=$dri->domain_update('example.com',$toc);
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.com</domain:name></domain:update></update><extension><resellerext:update xmlns:resellerext="urn:ietf:params:xml:ns:resellerext-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:resellerext-1.0 resellerext-1.0.xsd"><resellerext:chg><resellerext:resID>myreseller</resellerext:resID></resellerext:chg></resellerext:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update chg build');
