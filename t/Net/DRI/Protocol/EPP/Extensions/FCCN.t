...
is_string($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>telepac2.pt</domain:name></domain:transfer></transfer><extension><ptdomain:renounce xmlns:ptdomain="http://eppdev.dns.pt/schemas/ptdomain-1.0" xsi:schemaLocation="http://eppdev.dns.pt/schemas/ptdomain-1.0 ptdomain-1.0.xsd"><ptdomain:roid/><ptdomain:renounce>true</ptdomain:renounce></ptdomain:renounce></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renounce build');
