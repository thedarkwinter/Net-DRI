...
is($R1,$E1 . '<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>CONT4</contact:id><contact:chg><contact:authInfo><contact:pw/></contact:authInfo><contact:disclose flag="0"><contact:org type="loc"/><contact:addr type="loc"/></contact:disclose></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command></epp>','contact update disclose_enabled build_xml');
...
is($R1,$E1 . '<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>CONT5</contact:id><contact:chg><contact:authInfo><contact:pw/></contact:authInfo><contact:disclose flag="1"><contact:org type="loc"/><contact:addr type="loc"/></contact:disclose></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command></epp>','contact update disclose_disabled build_xml');
...
# unrenew
$R2='<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><response>'.r(). '<resData><domain:renData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>testdom1.co.uk</domain:name><domain:exDate>2013-01-02T11:56:40</domain:exDate></domain:renData></resData>'.$TRID.'</response>'.$E2;
...
# referral_reject
$R2='<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="10" id="12345"><qDate>2007-09-26T07:31:30</qDate><msg>Referral Rejected Notification</msg></msgQ><resData><n:domainFailData xmlns:n="http://www.nominet.org.uk/epp/xml/std-notifications-1.2" xsi:schemaLocation="http://www.nominet.org.uk/epp/xml/std-notifications-1.2 std-notifications-1.2.xsd"><n:domainName>epp-example2.ltd.uk</n:domainName><n:reason>V205 Registrant does not match domain name</n:reason></n:domainFailData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
