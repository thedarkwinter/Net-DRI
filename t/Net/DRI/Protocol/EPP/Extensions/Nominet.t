...
## Host Commands
# check
$R2=$E1.'<response>'.r().'<resData><host:chkData xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:cd><host:name avail="0">ns2.example2.com</host:name><host:reason>In use</host:reason></host:cd></host:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->host_check('ns2.example2.com');
is($R1,$E1.'<command><check><host:check xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns2.example2.com</host:name></host:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'host_check build');
is($dri->get_info('exist'),1,'host_check get_info(exist)');

# info
$R2=$E1.'<response>'.r().'<resData><host:infData xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns2.example2.co.uk.</host:name><host:roid>123-UK</host:roid><host:status s="ok"/><host:addr ip="v4">111.22.33.44</host:addr><host:clID>NOMIQ</host:clID><host:crID>NOMIQ</host:crID><host:crDate>2013-02-21T13:49:36</host:crDate></host:infData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->host_info('ns2.example2.co.uk');
is($R1,$E1.'<command><info><host:info xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns2.example2.co.uk</host:name></host:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'host_info build');
...
is($R1,$E1 . '<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>CONT1</contact:id><contact:chg><contact:postalInfo type="loc"><contact:name>Testname</contact:name><contact:org>Testorg</contact:org><contact:addr><contact:street>1 London Road</contact:street><contact:city>London</contact:city><contact:pc>SW9 9WS</contact:pc><contact:cc>GB</contact:cc></contact:addr></contact:postalInfo><contact:voice>+44.20701020203</contact:voice><contact:fax>+44.20701020206</contact:fax><contact:email>testadmin@testdomain.co.uk</contact:email><contact:authInfo><contact:pw/></contact:authInfo></contact:chg></contact:update></update><extension><contact-nom-ext:update xmlns:contact-nom-ext="http://www.nominet.org.uk/epp/xml/contact-nom-ext-1.0"><contact-nom-ext:trad-name>Still Awestome</contact-nom-ext:trad-name><contact-nom-ext:type>LTD</contact-nom-ext:type><contact-nom-ext:co-no>12344321</contact-nom-ext:co-no><contact-nom-ext:opt-out>N</contact-nom-ext:opt-out></contact-nom-ext:update></extension>'.'<clTRID>ABC-12345</clTRID></command></epp>','contact update build_xml');


# update /w disclose enabled
my $c5 = $dri->local_object('contact')->srid('CONT4');
$c5->disclose({org_loc=>0, addr_loc=>0});
my $toc1=$dri->local_object('changes');
$toc1->set('info',$c5);
$rc=$dri->contact_update($c5,$toc1);
is($rc->is_success(), 1, 'contact update disclose_enabled is_success');
is($R1,$E1 . '<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>CONT4</contact:id><contact:chg><contact:authInfo><contact:pw/></contact:authInfo><contact:disclose flag="0"><contact:org type="loc"/><contact:addr type="loc"/></contact:disclose></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command></epp>','contact update disclose_enabled build_xml');

# update /w disclose disabled
my $c6 = $dri->local_object('contact')->srid('CONT5');
$c6->disclose({org_loc=>1, addr_loc=>1});
my $toc2=$dri->local_object('changes');
$toc2->set('info',$c6);
$rc=$dri->contact_update($c6,$toc2);
is($rc->is_success(), 1, 'contact update disclose_disabled is_success');
is($R1,$E1 . '<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>CONT5</contact:id><contact:chg><contact:authInfo><contact:pw/></contact:authInfo><contact:disclose flag="1"><contact:org type="loc"/><contact:addr type="loc"/></contact:disclose></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command></epp>','contact update disclose_disabled build_xml');
...
is($R1,$E1 . '<command><update><f:fork xmlns:f="http://www.nominet.org.uk/epp/xml/std-fork-1.0"><f:contactID>CONT1</f:contactID><f:newContactId>CONT555</f:newContactId><f:domainName>testdom1.co.uk</f:domainName><f:domainName>testdom2.co.uk</f:domainName></f:fork></update><clTRID>ABC-12345</clTRID></command></epp>','contact fork build_xml');

#lock (whois_optout)
$R2=$E1.'<response>'.r().$TRID.'</response>'.$E2;
$rc=$dri->contact_lock($dri->local_object('contact')->srid('CONT1'),{type=> 'opt-out'});
is($rc->is_success(),1,'contact_lock is_success');
is_string($R1,$E1.'<command><update><l:lock xmlns:l="http://www.nominet.org.uk/epp/xml/std-locks-1.0" object="contact" type="opt-out"><l:contactId>CONT1</l:contactId></l:lock></update><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_lock build xml');

####################################################################################################
## Domain Commands
# check
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="0">example.co.uk</domain:name></domain:cd><domain:cd><domain:name avail="1">example2.co.uk</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example.co.uk','example2.co.uk');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example.co.uk</domain:name><domain:name>example2.co.uk</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build');
...
# info
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdom1.co.uk</domain:name><domain:roid>123453-UK</domain:roid><domain:registrant>CONT123</domain:registrant><domain:clID>ClientX</domain:clID><domain:crID>EPP-NOMINET-2000</domain:crID><domain:crDate>2013-02-21T13:48:58</domain:crDate><domain:exDate>2014-02-21T13:48:58</domain:exDate></domain:infData></resData><extension><domain-nom-ext:infData xmlns:domain-nom-ext="http://www.nominet.org.uk/epp/xml/domain-nom-ext-1.2"><domain-nom-ext:reg-status>Registered until expiry date.</domain-nom-ext:reg-status></domain-nom-ext:infData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_info('testdom1.co.uk');
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">testdom1.co.uk</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build xml');
...
# create
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdom1.co.uk</domain:name><domain:crDate>2013-02-21T13:48:58</domain:crDate><domain:exDate>2014-02-21T13:48:58</domain:exDate></domain:creData></resData><extension><warning:ignored-field field-name="domain:authInfo" xmlns:warning="http://www.nominet.org.uk/epp/xml/std-warning-1.1">Field \'authInfo\' found; this field has been ignored.</warning:ignored-field></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdom1.co.uk</domain:name><domain:period unit="y">1</domain:period><domain:registrant>CONT123</domain:registrant><domain:authInfo><domain:pw/></domain:authInfo></domain:create></create><extension><domain-nom-ext:create xmlns:domain-nom-ext="http://www.nominet.org.uk/epp/xml/domain-nom-ext-1.2"><domain-nom-ext:recur-bill>bc</domain-nom-ext:recur-bill><domain-nom-ext:auto-period>3</domain-nom-ext:auto-period></domain-nom-ext:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build xml');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdom1.co.uk</domain:name><domain:chg><domain:registrant>CONT987</domain:registrant></domain:chg></domain:update></update><extension><domain-nom-ext:update xmlns:domain-nom-ext="http://www.nominet.org.uk/epp/xml/domain-nom-ext-1.2"><domain-nom-ext:auto-bill>0</domain-nom-ext:auto-bill><domain-nom-ext:renew-not-required>N</domain-nom-ext:renew-not-required></domain-nom-ext:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build xml');

# delete
$R2=$E1.'<response>'.r().$TRID.'</response>'.$E2;
$rc=$dri->domain_delete('testdom1.co.uk', {pure_delete=>1});
is($rc->is_success(),1,'domain_delete is_success');
is_string($R1,$E1.'<command><delete><domain:delete xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdom1.co.uk</domain:name></domain:delete></delete><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_delete build xml');

# unrenew
$R2=$E1.'<response>'.r(). '<resData><domain:renData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>testdom1.co.uk</domain:name><domain:exDate>2013-01-02T11:56:40</domain:exDate></domain:renData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_unrenew('testdom1.co.uk');
is($rc->is_success(),1,'domain_unrenew is_success');
is_string($R1,$E1.'<command><update><u:unrenew xmlns:u="http://www.nominet.org.uk/epp/xml/std-unrenew-1.0"><u:domainName>testdom1.co.uk</u:domainName></u:unrenew></update><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_unrenew build xml');
is($dri->get_info('exDate'),'2013-01-02T11:56:40','domain_unrenew get_info(exDate)');

# list
$R2=$E1.'<response>'.r().'<resData><list:listData xmlns:list="http://www.nominet.org.uk/epp/xml/std-list-1.0" noDomains="2"><list:domainName>test1.co.uk</list:domainName><list:domainName>test2.co.uk</list:domainName></list:listData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_list({regMonth => new DateTime({year => 2012, month=>12})});
is($rc->is_success(),1,'domain_list is_success');
is_string($R1,$E1.'<command><info><l:list xmlns:l="http://www.nominet.org.uk/epp/xml/std-list-1.0"><l:month>2012-12</l:month></l:list></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_list build xml');
...
is_string($R1,$E1.'<command><update><l:lock xmlns:l="http://www.nominet.org.uk/epp/xml/std-locks-1.0" object="domain" type="investigation"><l:domainName>testdom1.co.uk</l:domainName></l:lock></update><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_lock build xml');
...
is_string($R1,$E1.'<command><update><r:release xmlns:r="http://www.nominet.org.uk/epp/xml/std-release-1.0"><r:domainName>testdom1.co.uk</r:domainName><r:registrarTag>NewTAG</r:registrarTag></r:release></update><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_release build xml');
...
is($R1,$E1 . '<command><update><r:release xmlns:r="http://www.nominet.org.uk/epp/xml/std-release-1.0"><r:registrant>CONT1</r:registrant><r:registrarTag>NewTAG</r:registrarTag></r:release></update><clTRID>ABC-12345</clTRID></command></epp>','account release build_xml');
...
$R2=$E1.'<response>'.r().'<resData><h:hanData xmlns:h="http://www.nominet.org.uk/epp/xml/std-handshake-1.0"><h:caseId>6</h:caseId><h:domainListData noDomains="2"><h:domainName>example1.co.uk</h:domainName><h:domainName>example2.co.uk</h:domainName></h:domainListData></h:hanData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_transfer_accept('null.co.uk', {case_id => '665544', registrant=> 'CONT123'});
is($rc->is_success(),1,'handshake_accept is_success');
is_string($R1,$E1.'<command><update><h:accept xmlns:h="http://www.nominet.org.uk/epp/xml/std-handshake-1.0"><h:caseId>665544</h:caseId><h:registrant>CONT123</h:registrant></h:accept></update><clTRID>ABC-12345</clTRID></command>'.$E2,'handshake_accept build xml');
...
is_string($R1,$E1.'<command><update><h:reject xmlns:h="http://www.nominet.org.uk/epp/xml/std-handshake-1.0"><h:caseId>665544</h:caseId></h:reject></update><clTRID>ABC-12345</clTRID></command>'.$E2,'handshake_reject build xml');

# check - rights with no options
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example.uk</domain:name></domain:cd></domain:chkData></resData><extension><nom-direct-rights:chkData xmlns:nom-direct-rights="http://www.nominet.org.uk/epp/xml/nom-direct-rights-1.0"><nom-direct-rights:ror>example.sld.uk</nom-direct-rights:ror></nom-direct-rights:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example.uk');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example.uk</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check rights build');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example2.uk</domain:name></domain:cd></domain:chkData></resData><extension><nom-direct-rights:chkData xmlns:nom-direct-rights="http://www.nominet.org.uk/epp/xml/nom-direct-rights-1.0"><nom-direct-rights:ror>example2.sld.uk</nom-direct-rights:ror></nom-direct-rights:chkData></extension>'.$TRID.'</response>'.$E2;
#$rc=$dri->domain_check('example2.uk',{registrant => $c});
$rc=$dri->domain_check('example2.uk',{registrant => 'CONT1'});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example2.uk</domain:name></domain:check></check><extension><nom-direct-rights:check xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xmlns:nom-direct-rights="http://www.nominet.org.uk/epp/xml/nom-direct-rights-1.0"><nom-direct-rights:registrant>CONT1</nom-direct-rights:registrant></nom-direct-rights:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check rights build');
is($rc->is_success(),1,'domain_check rights is_success');
is($dri->get_info('exist'),0,'domain_check rights get_info(exist)');
...
# domain cancelled
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="10" id="123456"><qDate>2007-09-26T07:31:30</qDate><msg>Domain name Cancellation Notification</msg></msgQ><resData><n:cancData xmlns:n="http://www.nominet.org.uk/epp/xml/std-notifications-1.2"><n:domainName>epp-example1.co.uk</n:domainName>3<n:orig>example@nominet</n:orig></n:cancData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
# referral_accept
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="10" id="123456"><qDate>2007-09-26T07:31:30</qDate><msg>Referral Accepted Notification</msg></msgQ><resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>epp-example1.ltd.uk</domain:name><domain:crDate>2007-09-25T11:30:45</domain:crDate><domain:exDate>2009-09-25T11:30:45</domain:exDate></domain:creData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
