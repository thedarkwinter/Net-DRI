...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>exampledomain.co.za</domain:name></domain:update></update><extension><cozadomain:update xmlns:cozadomain="http://co.za/epp/extensions/cozadomain-1-0"><cozadomain:chg><cozadomain:autorenew>false</cozadomain:autorenew></cozadomain:chg></cozadomain:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update auto_renew');

$R2='';
$rc=$dri->domain_update('exampledomain.co.za',$dri->local_object('changes')->set('cancel_action','PendingSuspension'));
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>exampledomain.co.za</domain:name></domain:update></update><extension><cozadomain:update xmlns:cozadomain="http://co.za/epp/extensions/cozadomain-1-0" cancelPendingAction="PendingSuspension"/></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_update cancel_action');
...
is_string($R1,$E1.'<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>testCont</contact:id></contact:info></info><extension><cozacontact:info xmlns:cozacontact="http://co.za/epp/extensions/cozacontact-1-0"><cozacontact:domainListing>true</cozacontact:domainListing></cozacontact:info></extension><clTRID>ABC-12345</clTRID></command></epp>','contact_info domain_listing');
...
is_string($R1,$E1.'<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>examplerar</contact:id></contact:info></info><extension><cozacontact:info xmlns:cozacontact="http://co.za/epp/extensions/cozacontact-1-0"><cozacontact:balance>true</cozacontact:balance></cozacontact:info></extension><clTRID>ABC-12345</clTRID></command></epp>','registrar_balance');
...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>testCont2</contact:id></contact:update></update><extension><cozacontact:update xmlns:cozacontact="http://co.za/epp/extensions/cozacontact-1-0" cancelPendingAction="PendingUpdate"/></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update cancel_action');
...
$R2=$E1.'<response>'.r().'<resData><contact:creData xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>sh8015</contact:id><contact:crDate>1999-04-03T22:00:00.0Z</contact:crDate></contact:creData></resData>'.$TRID.'</response>'.$E2;
