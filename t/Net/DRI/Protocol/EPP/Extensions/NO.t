...
is_string($R1,$E1.'<extension><no-ext-epp:command xmlns:no-ext-epp="http://www.norid.no/xsd/no-ext-epp-1.0" xsi:schemaLocation="http://www.norid.no/xsd/no-ext-epp-1.0 no-ext-epp-1.0.xsd"><no-ext-epp:transfer op="execute"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example205.no</domain:name><domain:period unit="m">5</domain:period><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:transfer></no-ext-epp:transfer><no-ext-epp:clTRID>ABC-12345</no-ext-epp:clTRID></no-ext-epp:command></extension>'.$E2,'domain_transfer_execute build');
