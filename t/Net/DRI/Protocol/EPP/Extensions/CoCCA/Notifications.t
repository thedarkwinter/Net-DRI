...
$rc=$dri->process('session','noop',[]);
is($dri->protocol()->ns()->{fee}->[0],'urn:ietf:params:xml:ns:epp:fee-1.0','CoCCA Fee-1.0 loaded correctly');
is_deeply([$dri->tlds()],[qw/as cc cm cx gs mg mu na ng af com.af ai com.ai net.ai off.ai org.ai gg co.gg net.gg org.gg gl co.gl com.gl gy co.gy com.gy net.gy hn com.hn ht com.ht je co.je net.je org.je ki com.ki ms com.ms org.ms nf com.nf sb com.sb net.sb so com.so edu.so gov.so me.so net.so org.so tl com.tl/],'CoCCA cctld: all tlds');
