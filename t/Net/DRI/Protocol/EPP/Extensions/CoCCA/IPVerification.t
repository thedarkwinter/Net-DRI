...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>mychipdomain.cx</domain:name><domain:period unit="y">1</domain:period><domain:registrant>regis-AmQyW885sq</domain:registrant><domain:authInfo><domain:pw>nHOiQttnHO</domain:pw></domain:authInfo></domain:create></create><extension><cocca:extension xmlns:cocca="https://production.coccaregistry.net/cocca-ip-verification-1.1"><cocca:chip><cocca:code>CHIP Code</cocca:code></cocca:chip></cocca:extension></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_create with chip code');
