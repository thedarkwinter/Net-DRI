...
is($dri->protocol()->ns()->{'defReg'},'http://www.nic.name/epp/defReg-1.0','defReg-1.0 for server announcing 1.0');

##############
# defreg Check
# set all levels to premium
$R2=$E1.'<response><result code="1000"><msg>Command completed successfully</msg></result><resData><defReg:chkData xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:cd><defReg:name level="premium" avail="1">fred</defReg:name></defReg:cd><defReg:cd><defReg:name level="standard" avail="0">def.fred</defReg:name><defReg:reason>Conflicting object exists</defReg:reason></defReg:cd></defReg:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->defreg_check('fred', 'jed.fred', { level => 'premium' });
is_string($R1,$E1.'<command><check><defReg:check xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:name level="premium">fred</defReg:name><defReg:name level="premium">jed.fred</defReg:name></defReg:check></check><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_check all premium build_xml');

# defreg Check
# # set only specific name to premium
$R2=$E1.'<response><result code="1000"><msg>Command completed successfully</msg></result><resData><defReg:chkData xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:cd><defReg:name level="premium" avail="1">doe</defReg:name></defReg:cd><defReg:cd><defReg:name level="standard" avail="0">john.doe</defReg:name><defReg:reason>Conflicting object exists</defReg:reason></defReg:cd></defReg:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->defreg_check('doe', 'john.doe', { level_doe => 'premium' });
is_string($R1,$E1.'<command><check><defReg:check xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:name level="premium">doe</defReg:name><defReg:name level="standard">john.doe</defReg:name></defReg:check></check><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_check specific premium build_xml');
...
is_string($R1,$E1.'<command><info><defReg:info xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE1-REP</defReg:roid><defReg:authInfo><defReg:pw>ABC555</defReg:pw></defReg:authInfo></defReg:info></info><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_info build_xml');
is($rc->is_success(),1,'defreg_check is_success');
...
is_string($R1,$E1.'<command><transfer op="query"><defReg:transfer xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE2-REP</defReg:roid><defReg:authInfo><defReg:pw roid="JD1234-REP">2fooBAR</defReg:pw></defReg:authInfo></defReg:transfer></transfer><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_transfer_query build_xml');
...
is_string($R1,$E1.'<command><transfer op="request"><defReg:transfer xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE3-REP</defReg:roid><defReg:period unit="y">1</defReg:period><defReg:authInfo><defReg:pw roid="JD1234-REP">2fooBAR</defReg:pw></defReg:authInfo></defReg:transfer></transfer><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_transfer_start build_xml');
...
is_string($R1,$E1.'<command><transfer op="cancel"><defReg:transfer xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE4-REP</defReg:roid></defReg:transfer></transfer><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_transfer_stop build_xml');
$rc=$dri->defreg_transfer_accept('EXAMPLE5-REP');
is_string($R1,$E1.'<command><transfer op="approve"><defReg:transfer xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE5-REP</defReg:roid></defReg:transfer></transfer><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_transfer_accept build_xml');
$rc=$dri->defreg_transfer_refuse('EXAMPLE6-REP');
is_string($R1,$E1.'<command><transfer op="reject"><defReg:transfer xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE6-REP</defReg:roid></defReg:transfer></transfer><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_transfer_refuse build_xml');

# defreg create (with IDN - required language tag)
$R2=$E1.'<response><result code="1000"><msg>Command completed successfully</msg></result><resData><defReg:creData xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE7-REP</defReg:roid><defReg:name level="premium">xn--gya</defReg:name><defReg:crDate>1999-04-03T22:00:00.0Z</defReg:crDate><defReg:exDate>2000-04-03T22:00:00.0Z</defReg:exDate></defReg:creData></resData>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><create><defReg:create xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:name level="premium">xn--gya</defReg:name><defReg:registrant>jd1234</defReg:registrant><defReg:tm>XYZ-123</defReg:tm><defReg:tmCountry>US</defReg:tmCountry><defReg:tmDate>1990-04-03</defReg:tmDate><defReg:adminContact>sh8013</defReg:adminContact><defReg:authInfo><defReg:pw>2fooBAR</defReg:pw></defReg:authInfo></defReg:create></create><extension><idnLang:tag xmlns:idnLang="http://www.verisign.com/epp/idnLang-1.0">GRE</idnLang:tag><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_create build_xml');
...
is_string($R1,$E1.'<command><delete><defReg:delete xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE8-REP</defReg:roid></defReg:delete></delete><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_delete build_xml');

# defreg renew
$R2=$E1.'<response><result code="1000"><msg>Command completed successfully</msg></result><resData><defReg:renData xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE9-REP</defReg:roid><defReg:exDate>2001-04-03T22:00:00.0Z</defReg:exDate></defReg:renData></resData>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><renew><defReg:renew xmlns:defReg="http://www.nic.name/epp/defReg-1.0"><defReg:roid>EXAMPLE9-REP</defReg:roid><defReg:curExpDate>2000-04-03</defReg:curExpDate><defReg:period unit="y">1</defReg:period></defReg:renew></renew><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1"><namestoreExt:subProduct>name</namestoreExt:subProduct></namestoreExt:namestoreExt></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'defreg_renew build_xml');
