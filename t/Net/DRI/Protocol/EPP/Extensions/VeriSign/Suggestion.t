...
$R2='';
my $rc=$dri->domain_suggest('mimisflowershop.com',{language=>'ENG',contentfilter=>'false',customfilter=>'false',forsale=>'off',maxlength=>30,maxresults=>20,usehyphens=>1,usenumbers=>1,useidns=>0,view=>'grid',action=>{basic=>'medium',related=>'high',similar=>'off',topical=>'high'},tld=>['COM','Net'], geo => {lat=>38.9544,lon=>-7.73463}, sub_id => '3X564T4J3B'});
is_string($R1,$E1.'<command><info><suggestion:info xmlns:suggestion="http://www.verisign-grs.com/epp/suggestion-1.1"><suggestion:key>mimisflowershop.com</suggestion:key><suggestion:language>ENG</suggestion:language><suggestion:filter contentfilter="false" customfilter="false" forsale="off" maxlength="30" maxresults="20" usehyphens="1" useidns="0" usenumbers="1" view="grid"><suggestion:action name="basic" weight="medium"/><suggestion:action name="related" weight="high"/><suggestion:action name="similar" weight="off"/><suggestion:action name="topical" weight="high"/><suggestion:tld>COM</suggestion:tld><suggestion:tld>Net</suggestion:tld><suggestion:geo><suggestion:coordinates lat="38.9544" lon="-7.73463"/></suggestion:geo></suggestion:filter><suggestion:subID>3X564T4J3B</suggestion:subID></suggestion:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_suggest build');



$R2='<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><response>'.r().'<resData><suggestion:infData xmlns:suggestion="http://www.verisign-grs.com/epp/suggestion-1.1" xsi:schemaLocation="http://www.verisign-grs.com/epp/suggestion-1.1 suggestion-1.1.xsd"><suggestion:key>harrypotterquidditchgame.com</suggestion:key><suggestion:language>ENG</suggestion:language><suggestion:token name="harrypotter"><suggestion:related>wizard</suggestion:related></suggestion:token><suggestion:token name="quidditch"/><suggestion:token name="game"><suggestion:related>videogame</suggestion:related><suggestion:related>contest</suggestion:related></suggestion:token><suggestion:answer><suggestion:table><suggestion:row name="HarrypotterQuidditchGame.com" score="1000" status="registered"/><suggestion:row name="HarryPotterVideoGame.com" score="952" status="available"/><suggestion:row name="TheHarryPotterMovie.com" score="945" status="available"/><suggestion:row name="HarryPotterTehMovie.com" score="923" status="available"/><suggestion:row name="MovieAboutHarryPotter.com" score="919" status="forsale"/><suggestion:row name="HarryPotterChatter.com" score="899" status="available"/></suggestion:table></suggestion:answer></suggestion:infData></resData>'.$TRID.'</response>'.$E2;
