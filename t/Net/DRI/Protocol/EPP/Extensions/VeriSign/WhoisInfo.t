...
$R2='<?xml version="1.0" encoding="UTF-8"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><response><result code="1000"><msg>Command completed successfully</msg></result><resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example2.com</domain:name><domain:roid>EXAMPLE1-VRSN</domain:roid><domain:status s="ok"/><domain:clID>ClientX</domain:clID><domain:crID>ClientY</domain:crID><domain:crDate>2005-11-11T18:09:52.0354Z</domain:crDate><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><whoisInf:whoisInfData xmlns:whoisInf="http://www.verisign.com/epp/whoisInf-1.0"><whoisInf:registrar>Example Registrar Inc.</whoisInf:registrar><whoisInf:whoisServer>whois.example.com</whoisInf:whoisServer><whoisInf:url>http://www.example.com</whoisInf:url><whoisInf:irisServer>iris.example.com</whoisInf:irisServer></whoisInf:whoisInfData></extension><trID><clTRID>ABC-12345</clTRID><svTRID>54321-XYZ</svTRID></trID></response></epp>';
my $rc=$dri->domain_info('example2.com',{whois_info => 1});
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">example2.com</domain:name></domain:info></info><extension><whoisInf:whoisInf xmlns:whoisInf="http://www.verisign.com/epp/whoisInf-1.0"><whoisInf:flag>1</whoisInf:flag></whoisInf:whoisInf></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build');
