...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example.com</domain:name><domain:add><domain:ns><domain:hostObj>ns1.example.com</domain:hostObj></domain:ns></domain:add></domain:update></update><extension><authExt:authActions xmlns:authExt="http://www.verisign.com/epp/authExt-1.0" xmlns:authSession="http://www.verisign.com/epp/authSession-1.0"><authExt:validate><authExt:tokenData><authExt:tokenProvider>VRSN</authExt:tokenProvider><authExt:token><authSession:serviceProvider>VIP</authSession:serviceProvider><authSession:credentialId>xyz1234</authSession:credentialId><authSession:crDate>2010-12-28T02:25:38.020500Z</authSession:crDate><authSession:exDate>2010-12-28T02:25:38.020500Z</authSession:exDate></authExt:token><authExt:signature>UjBsR09EbGhjZ0dTQUxNQUFBUUNBRU1tQ1p0dU1GUXhEUzhi</authExt:signature></authExt:tokenData></authExt:validate></authExt:authActions></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update auth.validate build');
