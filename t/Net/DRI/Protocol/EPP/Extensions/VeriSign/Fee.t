...
$dri->add_registry('NGTLD',{provider => 'verisign', name => 'xn--t60b56a'});
$dri->target('xn--t60b56a')->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv});
...
## Copied from Fee-0.9.t however they are NOT interchangable. XML is specific to verisign.
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">tourism.xn--tckwe</domain:name></domain:cd><domain:cd><domain:name avail="0">holidays.xn--tckwe</domain:name><domain:reason>In use</domain:reason></domain:cd><domain:cd><domain:name avail="0">hotels.xn--tckwe</domain:name><domain:reason>In use</domain:reason></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.9"><fee:cd><fee:objID>tourism.xn--tckwe</fee:objID><fee:currency>USD</fee:currency><fee:command phase="sunrise">create</fee:command><fee:period unit="y">1</fee:period><fee:fee description="Application Fee" refundable="0">5.00</fee:fee><fee:fee description="Registration Fee" refundable="1" grace-period="P5D">5.00</fee:fee></fee:cd><fee:cd><fee:objID>holidays.xn--tckwe</fee:objID><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period><fee:fee>5.00</fee:fee></fee:cd><fee:cd><fee:objID>hotels.xn--tckwe</fee:objID><fee:currency>EUR</fee:currency><fee:command>transfer</fee:command><fee:period unit="y">2</fee:period><fee:fee description="Transfer Fee" refundable="0">2.50</fee:fee><fee:fee description="Renewal Fee" refundable="1" grace-period="P5D">10.00</fee:fee></fee:cd><fee:cd><fee:objID>restaurants.xn--tckwe</fee:objID><fee:currency>GBP</fee:currency><fee:command>restore</fee:command><fee:fee description="Restore Fee" refundable="0">25</fee:fee><fee:class>premium-tier1</fee:class></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
@fees = (
  { domain=>'tourism.xn--tckwe','element'=>'name',currency=>'USD',action=>'create',phase=>'sunrise',duration=>$dri->local_object('duration','years',1) },
  { domain=>'holidays.xn--tckwe',currency=>'EUR',action=>'create',phase=>'claims',sub_phase=>'landrush',duration=>$dri->local_object('duration','years',2) },
  { domain=>'hotels.xn--tckwe',currency=>'EUR',action=>'transfer' },
  { domain=>'restaurants.xn--tckwe',action=>'restore' }
);
$rc=$dri->domain_check('tourism.xn--tckwe','holidays.xn--tckwe','hotels.xn--tckwe', {fee=>\@fees});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>tourism.xn--tckwe</domain:name><domain:name>holidays.xn--tckwe</domain:name><domain:name>hotels.xn--tckwe</domain:name></domain:check></check><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1" xsi:schemaLocation="http://www.verisign-grs.com/epp/namestoreExt-1.1 namestoreExt-1.1.xsd"><namestoreExt:subProduct>XN--TCKWE</namestoreExt:subProduct></namestoreExt:namestoreExt><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.9" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.9 fee-0.9.xsd"><fee:object objURI="urn:ietf:params:xml:ns:domain-1.0"><fee:objID element="name">tourism.xn--tckwe</fee:objID><fee:currency>USD</fee:currency><fee:command phase="sunrise">create</fee:command><fee:period unit="y">1</fee:period></fee:object><fee:object><fee:objID>holidays.xn--tckwe</fee:objID><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period></fee:object><fee:object><fee:objID>hotels.xn--tckwe</fee:objID><fee:currency>EUR</fee:currency><fee:command>transfer</fee:command></fee:object><fee:object><fee:objID>restaurants.xn--tckwe</fee:objID><fee:command>restore</fee:command></fee:object></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check_multi build');
is($rc->is_success(),1,'domain_check multi is_success');
is($dri->get_info('action'),'check','domain_check multi get_info (action)');
is($dri->get_info('exist','domain','tourism.xn--tckwe'),0,'domain_check multi get_info(exist) 1/2');
is($dri->get_info('exist','domain','holidays.xn--tckwe'),1,'domain_check multi get_info(exist) 2/4');
is($dri->get_info('exist','domain','hotels.xn--tckwe'),1,'domain_check multi get_info(exist) 3/4');
$d = shift @{$dri->get_info('fee','domain','tourism.xn--tckwe')};
is($d->{domain},'tourism.xn--tckwe','domain_check multi get_info(domain) 1/4');
...
$d = shift @{$dri->get_info('fee','domain','holidays.xn--tckwe')};
is($d->{domain},'holidays.xn--tckwe','domain_check multi get_info(domain) 2/4');
...
$d = shift @{$dri->get_info('fee','domain','hotels.xn--tckwe')};
is($d->{domain},'hotels.xn--tckwe','domain_check multi get_info(domain) 3/4');
...
$d = shift @{$dri->get_info('fee','domain','restaurants.xn--tckwe')};
is($d->{domain},'restaurants.xn--tckwe','domain_check multi get_info(domain) 4/4');
...
is($dri->get_info('is_premium','domain','hotels.xn--tckwe'),0,'domain_check_multi get_info (is_premium) undef');
is($dri->get_info('price_duration','domain','tourism.xn--tckwe')->years(),1,'domain_check get_info (price_duration)');
is($dri->get_info('create_price','domain','holidays.xn--tckwe'),5.00,'domain_check_multi get_info (create_price)');
is($dri->get_info('transfer_price','domain','hotels.xn--tckwe'),12.50,'domain_check_multi get_info (transfer_price)');
is($dri->get_info('restore_price','domain','restaurants.xn--tckwe'),25,'domain_check_multi get_info (restore_price)');

####################################################################################################
## Copied from Fee-0.9.t however they are NOT interchangable. XML is specific to verisign.

## Check: single domain - minimum data
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">check-claims-landrush.xn--tckwe</domain:name></domain:cd><domain:cd><domain:name avail="1">check-claims-landrush.xn--tckwe</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.9"><fee:cd><fee:objID>check-claims-landrush.xn--tckwe</fee:objID><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period><fee:fee description="Application Fee" refundable="0">150.00</fee:fee><fee:fee description="Registration Fee" refundable="1">500.00</fee:fee><fee:class>premium-tier1</fee:class></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('check-claims-landrush.xn--tckwe',{fee=>{action=>'create', duration=>DateTime::Duration->new(years=>2), 'currency' => 'EUR', 'phase'=>'claims', 'sub_phase'=>'landrush'}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>check-claims-landrush.xn--tckwe</domain:name></domain:check></check><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1" xsi:schemaLocation="http://www.verisign-grs.com/epp/namestoreExt-1.1 namestoreExt-1.1.xsd"><namestoreExt:subProduct>XN--TCKWE</namestoreExt:subProduct></namestoreExt:namestoreExt><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.9" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.9 fee-0.9.xsd"><fee:object><fee:objID>check-claims-landrush.xn--tckwe</fee:objID><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period></fee:object></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
...
is($d->{domain},'check-claims-landrush.xn--tckwe','Fee extension: domain_check single parse domain');
...
$cs->set($c2,'admin');
$cs->set($c2,'tech');
$rc=$dri->domain_create('exdomain.xn--tckwe',{pure_create=>1,duration=>DateTime::Duration->new(years=>2),ns=>$dri->local_object('hosts')->set(['ns1.example.bar'],['ns2.example.bar']),contact=>$cs,auth=>{pw=>'2fooBAR'},fee=>{currency=>'USD',fee=>'5.00'}});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>exdomain.xn--tckwe</domain:name><domain:period unit="y">2</domain:period><domain:ns><domain:hostObj>ns1.example.bar</domain:hostObj><domain:hostObj>ns2.example.bar</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><namestoreExt:namestoreExt xmlns:namestoreExt="http://www.verisign-grs.com/epp/namestoreExt-1.1" xsi:schemaLocation="http://www.verisign-grs.com/epp/namestoreExt-1.1 namestoreExt-1.1.xsd"><namestoreExt:subProduct>XN--TCKWE</namestoreExt:subProduct></namestoreExt:namestoreExt><fee:create xmlns:fee="urn:ietf:params:xml:ns:fee-0.9" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.9 fee-0.9.xsd"><fee:currency>USD</fee:currency><fee:fee>5.00</fee:fee></fee:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_create build');
