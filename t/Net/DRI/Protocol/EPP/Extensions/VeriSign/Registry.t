...
$dri->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv},{extensions=>['VeriSign::Registry']});
...
$R2=$E1.'<response>'.r().'<resData><registry:chkData xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:cd><registry:name avail="0">zone1</registry:name><registry:reason>Client not authorized</registry:reason></registry:cd></registry:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->registry_check('zone1');
is_string($R1,$E1.'<command><check><registry:check xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:name>zone1</registry:name></registry:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'registry_check build (single)');
...
$R2=$E1.'<response>'.r().'<resData><registry:chkData xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:cd><registry:name avail="0">zone1</registry:name><registry:reason>Client not authorized</registry:reason></registry:cd><registry:cd><registry:name avail="0">zone2</registry:name><registry:reason>Already supported</registry:reason></registry:cd><registry:cd><registry:name avail="1">zone3</registry:name></registry:cd></registry:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->registry_check(qw/zone1 zone2 zone3/);
is_string($R1,$E1.'<command><check><registry:check xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:name>zone1</registry:name><registry:name>zone2</registry:name><registry:name>zone3</registry:name></registry:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'registry check: registry_check build (multi)');
...
# simple
$R2=$E1.'<response>'.r().'<resData><registry:infData xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:zone><registry:name>zone1</registry:name><registry:crDate>2012-10-01T00:00:00.0Z</registry:crDate><registry:upDate>2012-10-15T00:00:00.0Z</registry:upDate></registry:zone></registry:infData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->registry_info('zone1');
is_string($R1,$E1.'<command><info><registry:info xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:name>zone1</registry:name></registry:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'registry info: registry_info build (one zone object)');
...
$R2=$E1.'<response>'.r().'<resData><registry:creData xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:name>zone1</registry:name><registry:crDate>2012-10-30T22:00:00.0Z</registry:crDate></registry:creData></resData>'.$TRID.'</response>'.$E2;
# related node
...
is_string($R1,$E1.'<command><delete><registry:delete xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:name>EXAMPLE</registry:name></registry:delete></delete><clTRID>ABC-12345</clTRID></command>'.$E2,'registry_delete build');
...
is_string($R1,$E1.'<command><update><registry:update xmlns:registry="http://www.verisign.com/epp/registry-1.0"><registry:zone><registry:name>EXAMPLE</registry:name><registry:group>STANDARD</registry:group><registry:subProduct>EXAMPLE</registry:subProduct></registry:zone></registry:update></update><clTRID>ABC-12345</clTRID></command>'.$E2,'registry_update build');
