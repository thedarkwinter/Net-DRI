...
$dri->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv},{extensions=>['AusRegistry::Sync','-VeriSign::Sync', '-VeriSign::NameStore','-VeriSign::IDNLanguage']});
