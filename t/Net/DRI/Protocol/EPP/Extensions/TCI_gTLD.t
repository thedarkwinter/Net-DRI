...
$dri->add_current_registry('TCI::GTLD');
...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>CLDC1</contact:id><contact:chg><contact:voice>+7.4951234567</contact:voice></contact:chg></contact:update></update><extension><contact:update xmlns:contact="http://www.tcinet.ru/epp/tci-contact-ext-1.0"><contact:chg><contact:person><contact:birthday>1986-11-10</contact:birthday><contact:passport>01 23 123456, выдан ОВД энского р-на</contact:passport></contact:person></contact:chg></contact:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update (change element) for an individual build');
...
$rc = $dri->contact_update($c,$toc);
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>CLDC2</contact:id><contact:rem><contact:status s="clientDeleteProhibited"/></contact:rem></contact:update></update><extension><contact:update xmlns:contact="http://www.tcinet.ru/epp/tci-contact-ext-1.0"><contact:chg><contact:organization><contact:legalAddr type="loc"><contact:street>ул. Примерная,</contact:street><contact:street>д. 98</contact:street><contact:street/><contact:city>Москва</contact:city><contact:pc>123456</contact:pc><contact:cc>ru</contact:cc></contact:legalAddr><contact:TIN>1234567890</contact:TIN></contact:organization></contact:chg></contact:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update (remove element) for a organization build');
