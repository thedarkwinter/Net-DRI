...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.gift</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create>'.'<extension><urc:registrant xmlns:urc="http://ns.uniregistry.net/centric-1.0"><urc:postalInfo type="loc"><urc:name>Juan Ordonez</urc:name><urc:org>Ejemplo Compania An6nima</urc:org><urc:addr><urc:street>123 Calle Ejemplo</urc:street><urc:street>Local numero 60</urc:street><urc:city>Caracas</urc:city><urc:sp>DC</urc:sp><urc:pc>1010</urc:pc><urc:cc>VE</urc:cc></urc:addr></urc:postalInfo><urc:postalInfo type="int"><urc:name>John Doe</urc:name><urc:org>Example Inc.</urc:org><urc:addr><urc:street>123 Example Dr.</urc:street><urc:street>Suite 100</urc:street><urc:city>Dulles</urc:city><urc:sp>VA</urc:sp><urc:pc>20166-6503</urc:pc><urc:cc>US</urc:cc></urc:addr></urc:postalInfo><urc:voice x="1234">+1.7035555555</urc:voice><urc:fax x="4321">+1.7035555556</urc:fax><urc:email>jdoe@example.com</urc:email><urc:emailAlt>jdoe2@foobar.net</urc:emailAlt><urc:mobile>+1.6504231234</urc:mobile><urc:security><urc:challenge><urc:question>Question 1</urc:question><urc:answer>Answer 1</urc:answer></urc:challenge><urc:challenge><urc:question>Question 2</urc:question><urc:answer>Answer 2</urc:answer></urc:challenge><urc:challenge><urc:question>Question 3</urc:question><urc:answer>Answer 3</urc:answer></urc:challenge></urc:security></urc:registrant></extension>'.'<clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build_xml');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.gift</domain:name></domain:update></update>'.'<extension><urc:registrant xmlns:urc="http://ns.uniregistry.net/centric-1.0"><urc:postalInfo type="loc"><urc:name>Juan Ordonez</urc:name><urc:org>Ejemplo Compania An6nima</urc:org><urc:addr><urc:street>123 Calle Ejemplo</urc:street><urc:street>Local numero 60</urc:street><urc:city>Caracas</urc:city><urc:sp>DC</urc:sp><urc:pc>1010</urc:pc><urc:cc>VE</urc:cc></urc:addr></urc:postalInfo><urc:postalInfo type="int"><urc:name>John Doe</urc:name><urc:org>Example Inc.</urc:org><urc:addr><urc:street>123 Example Dr.</urc:street><urc:street>Suite 100</urc:street><urc:city>Dulles</urc:city><urc:sp>VA</urc:sp><urc:pc>20166-6503</urc:pc><urc:cc>US</urc:cc></urc:addr></urc:postalInfo><urc:voice x="1234">+1.7035555555</urc:voice><urc:fax x="4321">+1.7035555556</urc:fax><urc:email>jdoe@example.com</urc:email><urc:emailAlt>jdoe2@foobar.net</urc:emailAlt><urc:mobile>+1.6504231234</urc:mobile><urc:security><urc:challenge><urc:question>Question 1</urc:question><urc:answer>Answer 1</urc:answer></urc:challenge><urc:challenge><urc:question>Question 2</urc:question><urc:answer>Answer 2</urc:answer></urc:challenge><urc:challenge><urc:question>Question 3</urc:question><urc:answer>Answer 3</urc:answer></urc:challenge></urc:security></urc:registrant></extension>'.'<clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build_xml');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example22.inc</domain:name></domain:cd><domain:cd><domain:name avail="0">examexample2.inc</domain:name><domain:reason>In use</domain:reason></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example22.inc','examexample2.inc');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example22.inc</domain:name><domain:name>examexample2.inc</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check .inc multi build');
...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3-with-urc.inc</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create>'.'<extension><urc:registrant xmlns:urc="http://ns.uniregistry.net/centric-1.0"><urc:postalInfo type="loc"><urc:name>Juan Ordonez</urc:name><urc:org>Ejemplo Compania An6nima</urc:org><urc:addr><urc:street>123 Calle Ejemplo</urc:street><urc:street>Local numero 60</urc:street><urc:city>Caracas</urc:city><urc:sp>DC</urc:sp><urc:pc>1010</urc:pc><urc:cc>VE</urc:cc></urc:addr></urc:postalInfo><urc:postalInfo type="int"><urc:name>John Doe</urc:name><urc:org>Example Inc.</urc:org><urc:addr><urc:street>123 Example Dr.</urc:street><urc:street>Suite 100</urc:street><urc:city>Dulles</urc:city><urc:sp>VA</urc:sp><urc:pc>20166-6503</urc:pc><urc:cc>US</urc:cc></urc:addr></urc:postalInfo><urc:voice x="1234">+1.7035555555</urc:voice><urc:fax x="4321">+1.7035555556</urc:fax><urc:email>jdoe@example.com</urc:email><urc:emailAlt>jdoe2@foobar.net</urc:emailAlt><urc:mobile>+1.6504231234</urc:mobile><urc:security><urc:challenge><urc:question>Question 1</urc:question><urc:answer>Answer 1</urc:answer></urc:challenge><urc:challenge><urc:question>Question 2</urc:question><urc:answer>Answer 2</urc:answer></urc:challenge><urc:challenge><urc:question>Question 3</urc:question><urc:answer>Answer 3</urc:answer></urc:challenge></urc:security></urc:registrant></extension>'.'<clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create .inc with urc build_xml');
...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3-without-urc.inc</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create>'.'<clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create .inc without urc build_xml');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example22.adult</domain:name></domain:cd><domain:cd><domain:name avail="0">examexample2.sex</domain:name><domain:reason>In use</domain:reason></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example22.adult','examexample2.sex');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example22.adult</domain:name><domain:name>examexample2.sex</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check unireg_icm multi build');
...
is($R1,$E1.'<command><login><clID>ClientX</clID><pw>foo-BAR2</pw><newPW>bar-FOO2</newPW><options><version>1.0</version><lang>en</lang></options><svcs><objURI>urn:ietf:params:xml:ns:domain-1.0</objURI><objURI>urn:ietf:params:xml:ns:host-1.0</objURI><objURI>urn:ietf:params:xml:ns:contact-1.0</objURI><objURI>http://ns.uniregistry.net/eps-1.0</objURI><svcExtension><extURI>http://ns.uniregistry.net/centric-1.0</extURI><extURI>http://ns.uniregistry.net/market-1.0</extURI><extURI>http://www.verisign.com/epp/sync-1.0</extURI><extURI>urn:afilias:params:xml:ns:association-1.0</extURI><extURI>urn:ietf:params:xml:ns:fee-0.7</extURI><extURI>urn:ietf:params:xml:ns:idn-1.0</extURI><extURI>urn:ietf:params:xml:ns:launch-1.0</extURI><extURI>urn:ietf:params:xml:ns:rgp-1.0</extURI><extURI>urn:ietf:params:xml:ns:secDNS-1.1</extURI></svcExtension></svcs></login><clTRID>ABC-12345</clTRID></command>'.$E2,'ICM - session login build only_local_extensions = 1');
...
$R2='';
$rc=$dri->process('session','login',['ClientX','foo-BAR2',{client_newpassword => 'bar-FOO2', only_local_extensions => 1}]);
is($R1,$E1.'<command><login><clID>ClientX</clID><pw>foo-BAR2</pw><newPW>bar-FOO2</newPW><options><version>1.0</version><lang>en</lang></options><svcs><objURI>urn:ietf:params:xml:ns:domain-1.0</objURI><objURI>urn:ietf:params:xml:ns:host-1.0</objURI><objURI>urn:ietf:params:xml:ns:contact-1.0</objURI><objURI>http://ns.uniregistry.net/eps-1.0</objURI><svcExtension><extURI>http://ns.uniregistry.net/centric-1.0</extURI><extURI>http://ns.uniregistry.net/market-1.0</extURI><extURI>http://www.verisign.com/epp/sync-1.0</extURI><extURI>urn:ietf:params:xml:ns:fee-0.7</extURI><extURI>urn:ietf:params:xml:ns:idn-1.0</extURI><extURI>urn:ietf:params:xml:ns:launch-1.0</extURI><extURI>urn:ietf:params:xml:ns:rgp-1.0</extURI><extURI>urn:ietf:params:xml:ns:secDNS-1.1</extURI></svcExtension></svcs></login><clTRID>ABC-12345</clTRID></command>'.$E2,'ICM - session login build only_local_extensions = 1');
