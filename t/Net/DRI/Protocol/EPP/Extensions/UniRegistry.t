...
$rc=$dri->domain_check('example22.creditunion','examexample2.creditunion');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example22.creditunion</domain:name><domain:name>examexample2.creditunion</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check .creditunion multi build');
is($rc->is_success(),1,'domain_check .creditunion multi is_success');
...
#####################
## test different greeting/per profile: unireg and icm
...
is_string($R1,$E1.'<hello/>'.$E2,'session noop build (hello command)');
...
is_string($R1,$E1.'<command><create><host:create xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns101.example1.com</host:name><host:addr ip="v4">193.0.2.2</host:addr><host:addr ip="v4">193.0.2.29</host:addr><host:addr ip="v6">2000:0:0:0:8:800:200C:417A</host:addr></host:create></create><clTRID>ABC-12345</clTRID></command>'.$E2,'host_create build');
