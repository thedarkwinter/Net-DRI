...
is($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>abcde</contact:id><contact:chg><contact:postalInfo type="loc"><contact:name>abc</contact:name><contact:org>abc.org</contact:org><contact:addr><contact:street>123 d street</contact:street><contact:city>reston</contact:city><contact:sp>NY</contact:sp><contact:pc>20194</contact:pc><contact:cc>US</contact:cc></contact:addr></contact:postalInfo><contact:postalInfo type="int"><contact:name>abc</contact:name><contact:org>abc.org</contact:org><contact:addr><contact:street>123 d street</contact:street><contact:city>reston</contact:city><contact:sp>NY</contact:sp><contact:pc>20194</contact:pc><contact:cc>US</contact:cc></contact:addr></contact:postalInfo><contact:fax x="1234">+1.2345678901</contact:fax><contact:email>xxx@yyy.com</contact:email><contact:authInfo><contact:pw>123456</contact:pw></contact:authInfo></contact:chg></contact:update></update><extension><cnnic-contact:update xmlns:cnnic-contact="urn:ietf:params:xml:ns:cnnic-contact-1.0"><cnnic-contact:chg><cnnic-contact:contact type="YLJGZY">55555555</cnnic-contact:contact></cnnic-contact:chg></cnnic-contact:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_updatre nexus build_xml');
...
# Contact info
$R2 = $E1 . '<response>'.r().'<resData><contact:infData xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>abcde</contact:id></contact:infData></resData><extension><cnnic-registry:infData xmlns:cnnic-registry="urn:ietf:params:xml:ns:cnnic-registry-1.0"><cnnic-registry:registry>cnnic</cnnic-registry:registry></cnnic-registry:infData><cnnic-contact:infData xmlns:cnnic-contact="urn:ietf:params:xml:ns:cnnic-contact-1.0"><cnnic-contact:contact type="SFZ">110101190001010001</cnnic-contact:contact></cnnic-contact:infData></extension>' . $TRID . '</response>' . $E2;
$rc = $dri->contact_info($dri->local_object('contact')->srid('abcde'));
is_string($R1,$E1 . '<command><info><contact:info xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>abcde</contact:id></contact:info></info><clTRID>ABC-12345</clTRID></command>' . $E2,'contact_info build');
...
# Host create
$R2=$E1.'<response>'.r().'<resData><host:creData xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns101.example1.com</host:name><host:crDate>1999-04-03T22:00:00.0Z</host:crDate></host:creData></resData>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">xn--fsq270a.xn--fiqs8s</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build');
...
## Create
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>xn--fsq270a.xn--fiqs8s</domain:name><domain:crDate>1999-04-03T22:00:00.0Z</domain:crDate><domain:exDate>2001-04-03T22:00:00.0Z</domain:exDate></domain:creData></resData>'.$TRID.'</response>'.$E2;
...
$command = $E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>xn--fsq270a.xn--fiqs8s</domain:name><domain:period unit="y">2</domain:period><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><cdn:create xmlns:cdn="urn:ietf:params:xml:ns:cdn-1.0"><cdn:VCDNList><cdn:VCDN>実例.中國</cdn:VCDN></cdn:VCDNList></cdn:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2;
...
is_string($R1,$E1.'<command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>xn--fsq270a.xn--fiqs8s</domain:name><domain:curExpDate>2000-04-03</domain:curExpDate><domain:period unit="y">5</domain:period></domain:renew></renew><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew build');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>xn--fsq270a.xn--fiqs8s</domain:name></domain:update></update><extension><cdn:update xmlns:cdn="urn:ietf:params:xml:ns:cdn-1.0"><cdn:add><cdn:VCDN>実例.中國</cdn:VCDN></cdn:add><cdn:rem><cdn:VCDN>実例.中國</cdn:VCDN></cdn:rem><cdn:chg><cdn:TCDN>實例.中國</cdn:TCDN></cdn:chg></cdn:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build');
