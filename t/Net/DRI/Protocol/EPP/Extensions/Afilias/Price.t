...
# Check
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example3premium.info</domain:name></domain:cd></domain:chkData></resData><extension><price:chkData xmlns:price="urn:afilias:params:xml:ns:price-1.0"><price:cd><price:domain type="premium">example3premium.info</price:domain><price:currency>USD</price:currency><price:period unit="y">1</price:period><price:pricing from="2014-06-10T04:00:00.0Z" to="2015-06-10T04:00:00.0Z"><price:amount type="transfer">123.00</price:amount><price:amount type="create">113.00</price:amount><price:amount type="renew">103.00</price:amount></price:pricing></price:cd></price:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example3premium.info');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3premium.info</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check price build');
...
# Renew
$R2=$E1.'<response>'.r().'<resData><domain:renData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3premium.info</domain:name><domain:exDate>2019-04-03T22:00:00.0Z</domain:exDate></domain:renData></resData><extension><price:renData xmlns:price="urn:afilias:params:xml:ns:price-1.0"><price:domain type="premium">example3premium.info</price:domain></price:renData></extension>'.$TRID.'</response>'.$E2;
...
is($R1,$E1.'<command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3premium.info</domain:name><domain:curExpDate>2014-04-03</domain:curExpDate><domain:period unit="y">5</domain:period></domain:renew></renew><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew price build');
...
# Transfer
$R2=$E1.'<response>'.r().'<resData><domain:trnData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3premium.info</domain:name><domain:trStatus>pending</domain:trStatus><domain:reID>ClientX</domain:reID><domain:reDate>2014-06-08T22:00:00.0Z</domain:reDate><domain:acID>ClientY</domain:acID><domain:acDate>2014-06-13T22:00:00.0Z</domain:acDate><domain:exDate>2014-09-08T22:00:00.0Z</domain:exDate></domain:trnData></resData><extension><price:trnData xmlns:price="urn:afilias:params:xml:ns:price-1.0"><price:domain type="premium">example3premium.info</price:domain></price:trnData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_transfer_start('example3premium.info',{auth=>{pw=>'2fooBAR',roid=>"JD1234-REP"},duration=>DateTime::Duration->new(years=>1)});
is($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3premium.info</domain:name><domain:period unit="y">1</domain:period><domain:authInfo><domain:pw roid="JD1234-REP">2fooBAR</domain:pw></domain:authInfo></domain:transfer></transfer><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer op="request" price build');
