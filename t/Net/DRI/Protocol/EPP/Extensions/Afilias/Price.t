...
# Check
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:cd><domain:name avail="1">example3premium.bnpparibas</domain:name></domain:cd></domain:chkData></resData><extension><price:chkData xmlns:price="urn:afilias:params:xml:ns:price-1.0" xsi:schemaLocation="urn:afilias:params:xml:ns:price-1.0 price-1.0.xsd"><price:cd><price:domain type="premium">example3premium.bnpparibas</price:domain><price:currency>USD</price:currency><price:period unit="y">1</price:period><price:pricing from="2014-06-10T04:00:00.0Z" to="2015-06-10T04:00:00.0Z"><price:amount type="transfer">123.00</price:amount><price:amount type="create">113.00</price:amount><price:amount type="renew">103.00</price:amount></price:pricing></price:cd></price:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example3premium.bnpparibas');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example3premium.bnpparibas</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check price build');
is($rc->is_success(),1,'domain_check price is_success');
is($dri->get_info('name'),'example3premium.bnpparibas','domain_check price info({name => "example3premium.bnpparibas"})');
...
is($price_ext->{'domain'},'example3premium.bnpparibas','domain_check price info({price_domain => "example3premium.bnpparibas"})');
...
# Renew
$R2=$E1.'<response>'.r().'<resData><domain:renData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example3premium.bnpparibas</domain:name><domain:exDate>2019-04-03T22:00:00.0Z</domain:exDate></domain:renData></resData><extension><price:renData xmlns:price="urn:afilias:params:xml:ns:price-1.0" xsi:schemaLocation="urn:afilias:params:xml:ns:price-1.0 price-1.0.xsd"><price:domain type="premium">example3premium.bnpparibas</price:domain></price:renData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_renew('example3premium.bnpparibas',{duration=>DateTime::Duration->new(years=>5),current_expiration=>DateTime->new(year=>2014,month=>4,day=>3,hour=>22)});
is($R1,$E1.'<command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example3premium.bnpparibas</domain:name><domain:curExpDate>2014-04-03</domain:curExpDate><domain:period unit="y">5</domain:period></domain:renew></renew><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew price build');
is($rc->is_success(),1,'domain_renew price is_success');
is($dri->get_info('name'),'example3premium.bnpparibas','domain_renew price info({name => "example3premium.bnpparibas"})');
...
is($price_ext->{'domain'},'example3premium.bnpparibas','domain_renew price info({price_domain => "example3premium.bnpparibas"})');
is($price_ext->{'premium'},'1','domain_check price info({premium => "1"})');
is($dri->get_info('is_premium'),1,'domain_check get_info (is_premium)');

# Transfer
$R2=$E1.'<response>'.r().'<resData><domain:trnData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example3premium.bnpparibas</domain:name><domain:trStatus>pending</domain:trStatus><domain:reID>ClientX</domain:reID><domain:reDate>2014-06-08T22:00:00.0Z</domain:reDate><domain:acID>ClientY</domain:acID><domain:acDate>2014-06-13T22:00:00.0Z</domain:acDate><domain:exDate>2014-09-08T22:00:00.0Z</domain:exDate></domain:trnData></resData><extension><price:trnData xmlns:price="urn:afilias:params:xml:ns:price-1.0" xsi:schemaLocation="urn:afilias:params:xml:ns:price-1.0 price-1.0.xsd"><price:domain type="premium">example3premium.bnpparibas</price:domain></price:trnData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_transfer_start('example3premium.bnpparibas',{auth=>{pw=>'2fooBAR',roid=>"JD1234-REP"},duration=>DateTime::Duration->new(years=>1)});
is($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example3premium.bnpparibas</domain:name><domain:period unit="y">1</domain:period><domain:authInfo><domain:pw roid="JD1234-REP">2fooBAR</domain:pw></domain:authInfo></domain:transfer></transfer><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer op="request" price build');
is($rc->is_success(),1,'domain_transfer price is_success');
is($dri->get_info('name'),'example3premium.bnpparibas','domain_transfer price info({name => "example3premium.bnpparibas"})');
