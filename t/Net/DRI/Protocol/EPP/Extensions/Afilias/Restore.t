...
$dri->add_registry('RDS');
$ok=eval {
	$dri->target('RDS')->add_current_profile('p1',
		'epp',
		{
			f_send=> \&mysend,
			f_recv=> \&myrecv
...
$ok=eval {
	$rc = $dri->domain_renew('deleted-by-accident.com.hn', {
		current_expiration => DateTime->new(year => 2008, month => 12,
			day => 24),
		rgp => 1});
	1;
};
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:ietf:params:xml:ns:epp-1.0 epp-1.0.xsd"><command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>deleted-by-accident.com.hn</domain:name><domain:curExpDate>2008-12-24</domain:curExpDate></domain:renew></renew><extension><argp:renew xmlns:argp="urn:EPP:xml:ns:ext:rgp-1.0" xsi:schemaLocation="urn:EPP:xml:ns:ext:rgp-1.0 rgp-1.0.xsd"><argp:restore/></argp:renew></extension><clTRID>ABC-12345</clTRID></command></epp>', 'Recover Domain XML correct');
