...
$dri->add_registry('MX');
$dri->target('MX')->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv});
print $@->as_string() if $@;
...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>sh8013</contact:id><contact:chg><contact:postalInfo type="loc"><contact:name>Example Name</contact:name><contact:addr><contact:street>Example Street 1</contact:street><contact:street>Example Street 2</contact:street><contact:street/><contact:city>Example City</contact:city><contact:sp>Example State</contact:sp><contact:pc>012345</contact:pc><contact:cc>MX</contact:cc></contact:addr></contact:postalInfo><contact:voice>+52.0123456789</contact:voice><contact:email>example@example.mx</contact:email></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update build');
...
is_string($R1,$E1.'<command><create><host:create xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns.example.mx</host:name><host:addr ip="v4">192.0.2.2</host:addr></host:create></create><clTRID>ABC-12345</clTRID></command>'.$E2,'host_create build');
...
is_string($R1,$E1.'<command><check><host:check xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns.example.mx</host:name></host:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'host_check build');
is($rc->is_success(),1,'host_check is_success');
# multi
$rc=$dri->host_check('ns1.example.mx','ns2.example.mx','ns3.example.mx');
is_string($R1,$E1.'<command><check><host:check xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns1.example.mx</host:name><host:name>ns2.example.mx</host:name><host:name>ns3.example.mx</host:name></host:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'host_check multi build');
is($rc->is_success(),1,'host_check multi is_success');

## 5.3 Host:info
$R2='';
$rc=$dri->host_info('ns.example.mx');
is_string($R1,$E1.'<command><info><host:info xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns.example.mx</host:name></host:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'host_info build');
...
is_string($R1,$E1.'<command><update><host:update xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns.example.mx</host:name><host:add><host:addr ip="v4">192.168.100.2</host:addr></host:add><host:rem><host:addr ip="v4">192.168.100.3</host:addr></host:rem></host:update></update><clTRID>ABC-12345</clTRID></command>'.$E2,'host_update build');
is($rc->is_success(),1,'host_update is_success');

## 5.5 Host:delete
$R2=$E1.'<response>'.r().$TRID.'</response>'.$E2;
$rc=$dri->host_delete('ns.example.mx');
is_string($R1,$E1.'<command><delete><host:delete xmlns:host="urn:ietf:params:xml:ns:host-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:host-1.0 host-1.0.xsd"><host:name>ns.example.mx</host:name></host:delete></delete><clTRID>ABC-12345</clTRID></command>'.$E2,'host_delete build');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.mx</domain:name><domain:period unit="y">5</domain:period><domain:registrant>reg1</domain:registrant><domain:contact type="admin">adm1</domain:contact><domain:contact type="billing">bil1</domain:contact><domain:contact type="tech">tec1</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build');
is($rc->is_success(),1,'domain_create is_success');

## 6.2 Domain:check
$R2='';
$rc=$dri->domain_check('example.mx');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.mx</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build');
is($rc->is_success(),1,'domain_check is_success');
# multi
$rc=$dri->domain_check('example-available.mx','example-reserved.mx','example-in-use.mx');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example-available.mx</domain:name><domain:name>example-reserved.mx</domain:name><domain:name>example-in-use.mx</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check multi build');
is($rc->is_success(),1,'domain_check multi is_success');

## 6.3 Domain:info
$R2='';
$rc=$dri->domain_info('example.mx');
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name hosts="all">example.mx</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build');
is($rc->is_success(),1,'domain_info is_success');

## 6.4 Domain:delete
$R2='';
$rc=$dri->domain_delete('example.mx');
is_string($R1,$E1.'<command><delete><domain:delete xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.mx</domain:name></domain:delete></delete><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_delete build');
...
is_string($R1,$E1.'<command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.mx</domain:name><domain:curExpDate>2011-08-27</domain:curExpDate><domain:period unit="y">1</domain:period></domain:renew></renew><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew build');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.mx</domain:name><domain:add><domain:status s="clientHold"/></domain:add></domain:update></update><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build');
is($rc->is_success(),1,'domain_update is_success');

## 6.7 Domain:restore
$R2='';
$rc=$dri->domain_restore(qw/example.mx/);
is_string($R1,$E1.'<command><renew><nicmx-domrst:restore xmlns:nicmx-domrst="http://www.nic.mx/nicmx-domrst-1.0" xsi:schemaLocation="http://www.nic.mx/nicmx-domrst-1.0 nicmx-domrst-1.0.xsd"><nicmx-domrst:name>example.mx</nicmx-domrst:name></nicmx-domrst:restore></renew><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_restore build');
is($rc->is_success(),1,'domain_restore is_success');

## 6.8 Domain:transfer
$R2=$E1.'<response>'.r().$TRID.'</response>'.$E2;
$rc=$dri->domain_transfer_start('example.mx',{auth=>{pw=>'2fooBAR'}});
is_string($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.mx</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:transfer></transfer><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_start build');
...
is_string($R1,$E1.'<command><transfer op="query"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example.com.mx</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:transfer></transfer><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_query build');
is($rc->is_success(),1,'domain_transfer_query is_success');

## 7.1 Rar:info (check the balance through EPP)
$R2=$E1.'<response><result code="1000"><msg>Command completed successfully</msg></result><msgQ count="34" id="3418"/><resData><rar:infData xmlns:rar="http://www.nic.mx/rar-1.0" xsi:schemaLocation="http://www.nic.mx/rar-1.0 rar-1.0.xsd"><rar:id>12345</rar:id><rar:roid>12345-MX</rar:roid><rar:name>reg-mx_example</rar:name><rar:balance>81.10</rar:balance></rar:infData></resData>'.$TRID.'</response>'.$E2;
