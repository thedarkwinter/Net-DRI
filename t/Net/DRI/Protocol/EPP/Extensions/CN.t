...
$dri->add_current_registry('CNNIC::CN');
$dri->target('CNNIC::CN')->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv});
print $@->as_string() if $@;
...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>cnnic</contact:id><contact:chg><contact:postalInfo type="loc"><contact:name>lily</contact:name><contact:org>itself</contact:org><contact:addr><contact:street>Foo</contact:street><contact:street>Bar</contact:street><contact:street>2</contact:street><contact:city>Example City</contact:city><contact:pc>20166-6503</contact:pc><contact:cc>CN</contact:cc></contact:addr></contact:postalInfo><contact:postalInfo type="int"><contact:name>lily</contact:name><contact:org>itself</contact:org><contact:addr><contact:street>Foo</contact:street><contact:street>Bar</contact:street><contact:street>2</contact:street><contact:city>Example City</contact:city><contact:pc>20166-6503</contact:pc><contact:cc>CN</contact:cc></contact:addr></contact:postalInfo><contact:voice>+1.9999999999</contact:voice><contact:fax>+1.5555555555</contact:fax><contact:email>a56165993@gmail.com</contact:email></contact:chg></contact:update></update><extension><cnnic-contact:update xmlns:cnnic-contact="urn:ietf:params:xml:ns:cnnic-contact-1.0"><cnnic-contact:chg><cnnic-contact:contact type="SFZ">110101190001010006</cnnic-contact:contact></cnnic-contact:chg></cnnic-contact:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update build');
is($rc->is_success(),1,'contact_update is_success');

## contact:delete
$R2=$E1.'<response>'.r().$TRID.'</response>'.$E2;
$rc=$dri->contact_delete($dri->local_object('contact')->srid('example1'));
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><delete><contact:delete xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>example1</contact:id></contact:delete></delete><clTRID>ABC-12345</clTRID></command></epp>','contact_delete build');
is($rc->is_success(),1,'contact_delete is_success');

## contact:transfer
$co=$dri->local_object('contact')->srid('example1')->auth({pw=>'foo-BAR2'});
$R2=$E1.'<response>'.r().'<resData><contact:trnData xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>example1</contact:id><contact:trStatus>pending</contact:trStatus><contact:reID>test</contact:reID><contact:reDate>2015-02-06T03:41:23.0Z</contact:reDate><contact:acID>cns</contact:acID><contact:acDate>2015-02-11T03:41:23.0Z</contact:acDate></contact:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->contact_transfer_start($co);
is($R1,$E1.'<command><transfer op="request"><contact:transfer xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>example1</contact:id><contact:authInfo><contact:pw>foo-BAR2</contact:pw></contact:authInfo></contact:transfer></transfer><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_transfer_start build');
...
## domain:info
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns="urn:ietf:params:xml:ns:domain-1.0" xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example.cn</domain:name><domain:roid>20150206s10001s72989693-cn</domain:roid><domain:status s="ok"/><domain:registrant>cnnic</domain:registrant><domain:contact type="admin">cnnic</domain:contact><domain:contact type="billing">cnnic</domain:contact><domain:contact type="tech">cnnic</domain:contact><domain:ns><domain:hostObj>ns.m.cn</domain:hostObj></domain:ns><domain:clID>test</domain:clID><domain:crID>test</domain:crID><domain:crDate>2015-02-06T04:01:21.0Z</domain:crDate><domain:exDate>2018-02-06T04:01:21.0Z</domain:exDate><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><rgp:infData xmlns:rgp="urn:ietf:params:xml:ns:rgp-1.0"><rgp:rgpStatus s="addPeriod"/></rgp:infData><cnnic-domain:infData xmlns:cnnic-domain="urn:ietf:params:xml:ns:cnnic-domain-1.0"><cnnic-domain:purveyor>mypurveyor</cnnic-domain:purveyor></cnnic-domain:infData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_info('example.cn',{auth=>{pw=>'2fooBAR'}});
is($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">example.cn</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info build with auth');
...
## domain:create
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns="urn:ietf:params:xml:ns:domain-1.0" xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example.cn</domain:name><domain:crDate>2015-02-06T04:01:21.0Z</domain:crDate><domain:exDate>2018-02-06T04:01:21.0Z</domain:exDate></domain:creData></resData>'.$TRID.'</response>'.$E2;
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example.cn</domain:name><domain:add><domain:ns><domain:hostObj>a.test.cn</domain:hostObj></domain:ns><domain:contact type="admin">cnnic2</domain:contact><domain:status s="clientDeleteProhibited"/></domain:add><domain:rem><domain:ns><domain:hostObj>ns.m.cn</domain:hostObj></domain:ns><domain:contact type="admin">cnnic1</domain:contact></domain:rem><domain:chg><domain:registrant>registrant1</domain:registrant><domain:authInfo><domain:pw>2BARfoo</domain:pw></domain:authInfo></domain:chg></domain:update></update><extension><cnnic-domain:update xmlns:cnnic-domain="urn:ietf:params:xml:ns:cnnic-domain-1.0"><cnnic-domain:chg><cnnic-domain:type>I</cnnic-domain:type><cnnic-domain:purveyor>mynewpurveyor</cnnic-domain:purveyor></cnnic-domain:chg></cnnic-domain:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build');
is($rc->is_success(),1,'domain_update is_success');

# test .xn--fiqs8s TLD
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example3.xn--fiqs8s</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example3.xn--fiqs8s');
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.xn--fiqs8s</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build');
...
## host:info
$R2=$E1.'<response>'.r().'<resData><host:infData xmlns="urn:ietf:params:xml:ns:host-1.0" xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns1.m.cn</host:name><host:roid>host7039266-cn</host:roid><host:status s="clientUpdateProhibited"/><host:addr ip="v6">0000:0000:0000:0000:0000:0000:c0a8:00c7</host:addr><host:addr ip="v4">192.168.0.199</host:addr><host:clID>test</host:clID><host:crID>test</host:crID><host:crDate>2015-02-06T03:23:45.000Z</host:crDate><host:upID>test</host:upID><host:upDate>2015-02-06T03:29:23.0Z</host:upDate></host:infData></resData><extension><cnnic-host:infData xmlns:cnnic-host="urn:ietf:params:xml:ns:cnnic-host-1.0"><cnnic-host:purveyor>my-purveyor</cnnic-host:purveyor></cnnic-host:infData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->host_info('ns1.m.cn');
is($R1,$E1.'<command><info><host:info xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns1.m.cn</host:name></host:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'host_info build');
...
is($R1,$E1.'<command><create><host:create xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns.bj.cn</host:name><host:addr ip="v4">218.241.111.111</host:addr></host:create></create><extension><cnnic-host:create xmlns:cnnic-host="urn:ietf:params:xml:ns:cnnic-host-1.0"><cnnic-host:purveyor>mypurveyor</cnnic-host:purveyor></cnnic-host:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'host_create build');
