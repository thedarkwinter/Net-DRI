...
####################################################################################################
## Fee extension version 0.8 http://tools.ietf.org/html/draft-brown-epp-fees-05
## fee-0.8 (Currently I don't know if in use)
## We use a greeting here to switch the namespace version here to -0.8 testing
$R2=$E1.'<greeting><svID>Fee-0.8-server</svID><svDate>2014-11-21T10:10:46.0751Z</svDate><svcMenu><version>1.0</version><lang>en</lang><objURI>urn:ietf:params:xml:ns:host-1.0</objURI><objURI>urn:ietf:params:xml:ns:domain-1.0</objURI><objURI>urn:ietf:params:xml:ns:contact-1.0</objURI><svcExtension><extURI>urn:ietf:params:xml:ns:launch-1.0</extURI><extURI>urn:ietf:params:xml:ns:rgp-1.0</extURI><extURI>urn:ietf:params:xml:ns:secDNS-1.1</extURI><extURI>urn:ietf:params:xml:ns:fee-0.8</extURI></svcExtension></svcMenu><dcp><access><all /></access><statement><purpose><admin /><prov /></purpose><recipient><ours /><public /></recipient><retention><stated /></retention></statement></dcp></greeting>'.$E2;
$rc=$dri->process('session','noop',[]);
is($dri->protocol()->ns()->{fee},'urn:ietf:params:xml:ns:fee-0.8','Fee 0.8 loaded correctly');
####################################################################################################

####################################################################################################
### check command and response copied draft-brown-epp-fees-05, this is an exactly simulation
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">tourism.space</domain:name></domain:cd><domain:cd><domain:name avail="0">holidays.space</domain:name><domain:reason>In use</domain:reason></domain:cd><domain:cd><domain:name avail="0">hotels.space</domain:name><domain:reason>In use</domain:reason></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:cd><fee:name>tourism.space</fee:name><fee:currency>USD</fee:currency><fee:command phase="sunrise">create</fee:command><fee:period unit="y">1</fee:period><fee:fee description="Application Fee" refundable="0">5.00</fee:fee><fee:fee description="Registration Fee" refundable="1" grace-period="P5D">5.00</fee:fee></fee:cd><fee:cd><fee:name>holidays.space</fee:name><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period><fee:fee>5.00</fee:fee></fee:cd><fee:cd><fee:name>hotels.space</fee:name><fee:currency>EUR</fee:currency><fee:command>transfer</fee:command><fee:period unit="y">2</fee:period><fee:fee description="Transfer Fee" refundable="0">2.50</fee:fee><fee:fee description="Renewal Fee" refundable="1" grace-period="P5D">10.00</fee:fee></fee:cd><fee:cd><fee:name>restaurants.space</fee:name><fee:currency>GBP</fee:currency><fee:command>restore</fee:command><fee:fee description="Restore Fee" refundable="0">25</fee:fee><fee:class>premium-tier1</fee:class></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
@fees = ( 
  { domain=>'tourism.space',currency=>'USD',action=>'create',phase=>'sunrise',duration=>$dri->local_object('duration','years',1) },
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>tourism.space</domain:name><domain:name>holidays.space</domain:name><domain:name>hotels.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:domain><fee:name>tourism.space</fee:name><fee:currency>USD</fee:currency><fee:command phase="sunrise">create</fee:command><fee:period unit="y">1</fee:period></fee:domain><fee:domain><fee:name>holidays.space</fee:name><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period></fee:domain><fee:domain><fee:name>hotels.space</fee:name><fee:currency>EUR</fee:currency><fee:command>transfer</fee:command></fee:domain><fee:domain><fee:name>restaurants.space</fee:name><fee:command>restore</fee:command></fee:domain></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check_multi build');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">check-claims-landrush.space</domain:name></domain:cd><domain:cd><domain:name avail="1">check-claims-landrush.space</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:cd><fee:name>check-claims-landrush.space</fee:name><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period><fee:fee description="Application Fee" refundable="0">150.00</fee:fee><fee:fee description="Registration Fee" refundable="1">500.00</fee:fee><fee:class>premium-tier1</fee:class></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>check-claims-landrush.space</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:domain><fee:name>check-claims-landrush.space</fee:name><fee:currency>EUR</fee:currency><fee:command phase="claims" subphase="landrush">create</fee:command><fee:period unit="y">2</fee:period></fee:domain></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
...
# domain info
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>foo.space</domain:name><domain:roid>EXAMPLE1-REP</domain:roid><domain:status s="ok" /><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:ns><domain:hostObj>ns1.tourism.space</domain:hostObj><domain:hostObj>ns1.holidays.space</domain:hostObj></domain:ns><domain:host>ns1.foo.space</domain:host><domain:host>ns2.foo.space</domain:host><domain:clID>ClientX</domain:clID><domain:crID>ClientY</domain:crID><domain:crDate>1999-04-03T22:00:00.0Z</domain:crDate><domain:upID>ClientX</domain:upID><domain:upDate>1999-12-03T09:00:00.0Z</domain:upDate><domain:exDate>2005-04-03T22:00:00.0Z</domain:exDate><domain:trDate>2000-04-08T09:00:00.0Z</domain:trDate><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:infData></resData><extension><fee:infData xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:currency>USD</fee:currency><fee:command phase="sunrise">create</fee:command><fee:period unit="y">1</fee:period><fee:fee refundable="1" grace-period="P5D" applied="immediate">10.00</fee:fee><fee:class>premium-tier1</fee:class></fee:infData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_info('foo.space',{fee=>{currency=>'USD',phase=>'sunrise',action=>'create',duration=>$dri->local_object('duration','years',1)}});
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">foo.space</domain:name></domain:info></info><extension><fee:info xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:currency>USD</fee:currency><fee:command phase="sunrise">create</fee:command><fee:period unit="y">1</fee:period></fee:info></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_info build');
...
## domain create
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>exdomain.space</domain:name><domain:crDate>1999-04-03T22:00:00.0Z</domain:crDate><domain:exDate>2001-04-03T22:00:00.0Z</domain:exDate></domain:creData></resData><extension><fee:creData xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:currency>USD</fee:currency><fee:period unit="y">1</fee:period><fee:fee>5.00</fee:fee><fee:balance>-5.00</fee:balance><fee:creditLimit>1000.00</fee:creditLimit></fee:creData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>exdomain.space</domain:name><domain:period unit="y">2</domain:period><domain:ns><domain:hostObj>ns1.example.bar</domain:hostObj><domain:hostObj>ns2.example.bar</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><fee:create xmlns:fee="urn:ietf:params:xml:ns:fee-0.8"><fee:currency>USD</fee:currency><fee:fee>5.00</fee:fee></fee:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_create build');
