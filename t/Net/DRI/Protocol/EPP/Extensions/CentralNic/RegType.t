...
####################################################################################################
# domain check
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example0.feedback</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example0.feedback' ,{reg_type => 'self-service'});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example0.feedback</domain:name></domain:check></check><extension><regtype:check xmlns:regtype="urn:ietf:params:xml:ns:regtype-0.2" xsi:schemaLocation="urn:ietf:params:xml:ns:regtype-0.2 regtype-0.2.xsd"><regtype:type>self-service</regtype:type></regtype:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example2.feedback</domain:name><domain:period unit="y">2</domain:period><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><regtype:create xmlns:regtype="urn:ietf:params:xml:ns:regtype-0.2" xsi:schemaLocation="urn:ietf:params:xml:ns:regtype-0.2 regtype-0.2.xsd"><regtype:type>foobar</regtype:type></regtype:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>example3.feedback</domain:name></domain:update></update><extension><regtype:update xmlns:regtype="urn:ietf:params:xml:ns:regtype-0.2" xsi:schemaLocation="urn:ietf:params:xml:ns:regtype-0.2 regtype-0.2.xsd"><regtype:chg><regtype:type>foobar</regtype:type></regtype:chg></regtype:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build');
