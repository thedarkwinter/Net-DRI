...
our $E1='<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0">';
our $E2='</epp>';
...
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0">
...
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><command><create><domain:create xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>przyklad44.pl</domain:name><domain:ns>ns.przyklad2.pl</domain:ns><domain:ns>ns5.przyklad.pl</domain:ns><domain:authInfo><domain:pw>authinfo_of_d97</domain:pw></domain:authInfo></domain:create></create><extension><extdom:create xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:book/></extdom:create></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_create build with book');
...
$R2=$E1.'<response>'.r().'<resData><contact:creData xmlns:contact="http://www.dns.pl/nask-epp-schema/contact-2.0"><contact:id>sh8013</contact:id><contact:crDate>1999-04-03T22:00:00.0Z</contact:crDate></contact:creData></resData>'.$TRID.'</response>'.$E2;
...
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><command><create><contact:create xmlns:contact="http://www.dns.pl/nask-epp-schema/contact-2.0"><contact:id>sh8013</contact:id><contact:postalInfo type="loc"><contact:name>11John Doe</contact:name><contact:org>Example Inc.</contact:org><contact:addr><contact:street>123 Example Dr.</contact:street><contact:street>Suite 100</contact:street><contact:city>Dulles</contact:city><contact:sp>VA</contact:sp><contact:pc>20166-6503</contact:pc><contact:cc>US</contact:cc></contact:addr></contact:postalInfo><contact:voice x="1234">+1.7035555555</contact:voice><contact:fax>+1.7035555556</contact:fax><contact:email>jdoe@example.tld</contact:email><contact:authInfo><contact:pw>2fooBAR</contact:pw></contact:authInfo></contact:create></create><extension><extcon:create xmlns:extcon="http://www.dns.pl/nask-epp-schema/extcon-2.0"><extcon:individual>1</extcon:individual></extcon:create></extension><clTRID>ABC-12345</clTRID></command></epp>','contact_create build');
...
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><command><info><contact:info xmlns:contact="http://www.dns.pl/nask-epp-schema/contact-2.0"><contact:id>666666</contact:id></contact:info></info><extension><extcon:info xmlns:extcon="http://www.dns.pl/nask-epp-schema/extcon-2.0"><extcon:authInfo><extcon:pw>2fooBAR</extcon:pw></extcon:authInfo></extcon:info></extension><clTRID>ABC-12345</clTRID></command></epp>','contact_info build');
...
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><command><update><contact:update xmlns:contact="http://www.dns.pl/nask-epp-schema/contact-2.0"><contact:id>sh8013</contact:id><contact:add><contact:status s="clientDeleteProhibited"/></contact:add><contact:chg><contact:postalInfo type="loc"><contact:org/><contact:addr><contact:street>124 Example Dr.</contact:street><contact:street>Suite 200</contact:street><contact:city>Dulles</contact:city><contact:sp>VA</contact:sp><contact:pc>20166-6503</contact:pc><contact:cc>US</contact:cc></contact:addr></contact:postalInfo><contact:voice>+1.7034444444</contact:voice><contact:fax>+1.7045555555</contact:fax><contact:authInfo><contact:pw>2fooBAR</contact:pw></contact:authInfo></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command></epp>','contact_update build');
...
$toc->set('info',$co2);
$rc=$dri->contact_update($co,$toc);
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><command><update><contact:update xmlns:contact="http://www.dns.pl/nask-epp-schema/contact-2.0"><contact:id>1234</contact:id></contact:update></update><extension><extcon:update xmlns:extcon="http://www.dns.pl/nask-epp-schema/extcon-2.0"><extcon:individual>1</extcon:individual></extcon:update></extension><clTRID>ABC-12345</clTRID></command></epp>','contact_update build - update only extcon individual');
...
$R2=$E1.'<response><result code="1000"><msg lang="en-US">Command completed successfully</msg></result><resData><host:chkData xmlns:host="http://www.dns.pl/nask-epp-schema/host-2.0"><host:cd><host:name avail="1">ns1.rawr.com</host:name></host:cd></host:chkData></resData>'.$TRID.'</response>'.$E2;
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="6" id="1651"><qDate>2005-06-03T06:41:41.927Z</qDate><msg lang="en">domain transfer requested</msg></msgQ><resData><domain:trnData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>bryzal.pl</domain:name><domain:trStatus>pending</domain:trStatus><domain:reID>wgtat</domain:reID><domain:reDate>2005-03-03T11:41:41.893Z</domain:reDate><domain:acID>dmrt0029000018</domain:acID><domain:acDate>2005-07-03T06:41:41.893Z</domain:acDate></domain:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="1849"><qDate>2005-06-22T07:36:52.223Z</qDate><msg lang="en">domain transfer cancelled</msg></msgQ><resData><domain:trnData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>weaktest.pl</domain:name><domain:trStatus>clientCancelled</domain:trStatus><domain:reID>bart</domain:reID><domain:reDate>2005-06-22T07:33:30.0Z</domain:reDate><domain:acID>neta29805</domain:acID><domain:acDate>2005-06-22T07:36:52.202Z</domain:acDate></domain:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="3" id="1900"><qDate>2005-06-22T12:04:18.323Z</qDate><msg lang="en">domain transfer expired</msg></msgQ><resData><domain:trnData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>pajac.pl</domain:name><domain:trStatus>serverCancelled</domain:trStatus><domain:reID>beep</domain:reID><domain:reDate>2005-05-12T12:38:49.0Z</domain:reDate><domain:acID>iap07</domain:acID><domain:acDate>2005-06-22T12:04:18.304Z</domain:acDate></domain:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="5" id="1652"><qDate>2005-06-03T06:55:40.253Z</qDate><msg lang="en">domain transferred</msg></msgQ><resData><domain:trnData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>brzydal6.pl</domain:name><domain:trStatus>clientApproved</domain:trStatus><domain:reID>agnat1</domain:reID><domain:reDate>2005-06-03T06:41:41.0Z</domain:reDate><domain:acID>dmrt0029000018</domain:acID><domain:acDate>2005-06-03T06:55:40.186Z</domain:acDate></domain:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="15" id="2013"><qDate>2005-06-30T14:58:29.579Z</qDate><msg lang="en">broken delegation</msg></msgQ><resData><extdom:dlgData xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:name>makota.com.pl</extdom:name><extdom:name>pikawa.net.pl</extdom:name><extdom:name>bzdziagwa.pl</extdom:name><extdom:ns>ns1.wisla.pl</extdom:ns></extdom:dlgData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="1536"><qDate>2005-05-25T09:37:46.581Z</qDate><msg lang="en">future transfer requested</msg></msgQ><resData><future:trnData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>zombi.pl</future:name><future:trStatus>pending</future:trStatus><future:reID>ceti1</future:reID><future:reDate>2005-05-25T09:37:46.549Z</future:reDate><future:acID>cet352</future:acID><future:acDate>2005-06-24T09:37:46.549Z</future:acDate></future:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="6" id="1334"><qDate>2005-05-16T22:05:39.228Z</qDate><msg lang="en">future transfer cancelled</msg></msgQ><resData><future:trnData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>futureexample.pl</future:name><future:trStatus>clientCancelled</future:trStatus><future:reID>infomix</future:reID><future:reDate>2005-05-16T22:03:44.0Z</future:reDate><future:acID>inm023</future:acID><future:acDate>2005-05-16T22:05:39.212Z</future:acDate></future:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="6" id="1334"><qDate>2005-05-16T22:05:39.228Z</qDate><msg lang="en">future transfer request expired</msg></msgQ><resData><future:trnData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>futureexample.pl</future:name><future:trStatus>serverCancelled</future:trStatus><future:reID>infomax</future:reID><future:reDate>2005-05-16T22:02:52.0Z</future:reDate><future:acID>inm_test02</future:acID><future:acDate>2005-06-24T09:52:27.727Z</future:acDate></future:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
is($dri->get_info('last_id'),1334,'message get_info last_id 1');
is($dri->get_info('last_id','message','session'),1334,'message get_info last_id 2');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="9" id="1538"><qDate>2005-05-25T09:51:20.909Z</qDate><msg lang="en">future transferred</msg></msgQ><resData><future:trnData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>example.pl</future:name><future:trStatus>clientApproved</future:trStatus><future:reID>ceti1</future:reID><future:reDate>2005-05-25T09:37:46.0Z</future:reDate><future:acID>zet352</future:acID><future:acDate>2005-05-25T09:51:20.836Z</future:acDate></future:trnData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="2001"><qDate>2005-06-27T21:00:19.538Z</qDate><msg lang="en">soon domain expiration</msg></msgQ><resData><extdom:expData xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:name>ala.pl</extdom:name><extdom:name>ma.pl</extdom:name><extdom:name>kota.pl</extdom:name><extdom:exDate>2005-06-29T21:00:19.512Z</extdom:exDate></extdom:expData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="2000"><qDate>2005-06-29T20:37:57.133Z</qDate><msg lang="en">domain authInfo</msg></msgQ><resData><extdom:pollAuthInfo xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:domain><extdom:name>nask.pl</extdom:name><extdom:authInfo><extdom:pw>cPxWt418</extdom:pw></extdom:authInfo></extdom:domain><extdom:registrant><extdom:id>tst12</extdom:id><extdom:authInfo><extdom:pw>Wct59Nka5</extdom:pw></extdom:authInfo></extdom:registrant></extdom:pollAuthInfo></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="2002"><qDate>2005-06-29T21:13:57.335Z</qDate><msg lang="en">future finalized</msg></msgQ><resData><domain:creData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example.pl</domain:name><domain:crDate>2005-06-29T21:13:57.327Z</domain:crDate><domain:exDate>2005-07-06T21:13:57.327Z</domain:exDate></domain:creData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="2003"><qDate>2005-06-29T21:17:26.288Z</qDate><msg lang="en">soon password expiration</msg></msgQ><resData><extepp:passwdReminder xmlns:extepp="http://www.dns.pl/nask-epp-schema/extepp-2.0"><extepp:exDate>2005-07-06T21:17:26.273Z</extepp:exDate></extepp:passwdReminder></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2 = $E1 . '<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="2003"><qDate>2007-07-29T21:17:26.288Z</qDate><msg lang="en">domain unblocked</msg></msgQ><resData><extdom:pollDomainUnblocked xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:domain><extdom:name>domena.pl</extdom:name><extdom:date>2007-07-06T21:17:26.273Z</extdom:date></extdom:domain></extdom:pollDomainUnblocked></resData>' . $TRID . '</response>' . $E2;
$rc = $dri->message_retrieve();
is($rc->is_success(), 1, 'message_retrieve');
is($dri->get_info('last_id'), 2003, 'message get_info last_id 1');
is($dri->get_info('id','message',2003),2003,'message get_info id');
...
$R2 = $E1 . '<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="2" id="2003"><qDate>2007-07-29T21:17:26.288Z</qDate><msg lang="en">future removed due to domain blockade</msg></msgQ><resData><extdom:pollFutureRemoved xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:future><extdom:name>b01.pl</extdom:name><extdom:date>2007-07-06T21:17:26.273Z</extdom:date></extdom:future></extdom:pollFutureRemoved></resData>' . $TRID . '</response>' . $E2;
$rc = $dri->message_retrieve();
is($rc->is_success(), 1, 'message_retrieve');
is($dri->get_info('last_id'), 2003, 'message get_info last_id 1');
is($dri->get_info('id','message',2003),2003,'message get_info id');
...
$R2 = $E1 . '<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="2003"><qDate>2007-07-29T21:17:26.288Z</qDate><msg lang="en">taste removed due to domain blockade</msg></msgQ><resData><extdom:pollTasteRemoved xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:taste><extdom:name>b02.pl</extdom:name><extdom:date>2007-07-06T21:17:26.273Z</extdom:date></extdom:taste></extdom:pollTasteRemoved></resData>' . $TRID . '</response>' . $E2;
$rc = $dri->message_retrieve();
is($rc->is_success(), 1, 'message_retrieve');
is($dri->get_info('last_id'), 2003, 'message get_info last_id 1');
is($dri->get_info('id','message',2003),2003,'message get_info id');
...
$R2 = $E1 . '<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="17830"><qDate>2008-01-04T12:34:52.238Z</qDate><msg lang="en">domain removed due to a legal valid decision of the court</msg></msgQ><resData><extdom:pollDomainJudicialRemoved xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:domain><extdom:name>judicialtest.pl</extdom:name><extdom:date>2007-07-06T21:17:26.273Z</extdom:date></extdom:domain></extdom:pollDomainJudicialRemoved></resData>' . $TRID . '</response>' . $E2;
$rc = $dri->message_retrieve();
is($rc->is_success(), 1, 'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="4" id="89010"><qDate>2009-10-19T09:34:31.178Z</qDate><msg lang="en">non-sufficient funds</msg></msgQ><resData><extepp:accountBalanceInsufficient xmlns:extepp="http://www.dns.pl/nask-epp-schema/extepp-2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><extepp:accountLevel>4.90</extepp:accountLevel><extepp:accountType>DOMAIN</extepp:accountType><extepp:serviceName>PREPAID_DOMAIN_FUNC_CREATE_1</extepp:serviceName><extepp:name>pp14.pl</extepp:name></extepp:accountBalanceInsufficient></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="3" id="89021"><qDate>2009-10-19T09:44:24.118Z</qDate><msg lang="en">account balance notification level reached</msg></msgQ><resData><extepp:accountBalanceCrossed xmlns:extepp="http://www.dns.pl/nask-epp-schema/extepp-2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><extepp:notificationLevel>100.00</extepp:notificationLevel><extepp:accountType>DOMAIN</extepp:accountType></extepp:accountBalanceCrossed></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="2" id="89024"><qDate>2009-10-19T09:52:31.128Z</qDate><msg lang="en">domain renewed automatically</msg></msgQ><resData><extdom:pollDomainAutoRenewed xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><extdom:name>ppr13.pl</extdom:name></extdom:pollDomainAutoRenewed></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="89025"><qDate>2009-10-19T09:56:51.131Z</qDate><msg lang="en">domain auto renewal failure due to domain status</msg></msgQ><resData><extdom:pollDomainAutoRenewFailed xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><extdom:name>ppr13.pl</extdom:name><extdom:date>2009-11-09T09:07:23.609Z</extdom:date></extdom:pollDomainAutoRenewFailed></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="20" id="24504834"><qDate>2018-06-28T00:38:22.385Z</qDate><msg lang="en">contacts deleted from system</msg></msgQ><resData><extcon:delData xmlns:extcon="http://www.dns.pl/nask-epp-schema/extcon-2.0"><extcon:id>foobar_028528</extcon:id><extcon:executionDate>2018-06-28T00:38:22.380Z</extcon:executionDate></extcon:delData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
is($rc->is_success(),1,'message_retrieve');
...
$R2=$E1.'<response><result code="1000"><msg lang="en">Command completed successfully</msg></result><extension><extreport:reportData xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:conDataRsp><extreport:conData><extreport:conId>k13</extreport:conId><extreport:roid>654321-NASK</extreport:roid></extreport:conData></extreport:conDataRsp><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit><extreport:size>1</extreport:size></extreport:reportData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->report_create(1235,{type=>'contact',id=>'k13',offset=>0,limit=>50});
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><extension><extreport:report xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:contact><extreport:conId>k13</extreport:conId></extreport:contact><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit></extreport:report></extension></epp>','report contact build');
...
$R2=$E1.'<response><result code="1000"><msg lang="en">Command completed successfully</msg></result><extension><extreport:reportData xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:hosDataRsp><extreport:hosData><extreport:name>ns1.temp.pl</extreport:name><extreport:roid>632381-NASK</extreport:roid></extreport:hosData></extreport:hosDataRsp><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit><extreport:size>1</extreport:size></extreport:reportData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->report_create(1236,{type=>'host',name=>'ns1.temp.pl',offset=>0,limit=>50});
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><extension><extreport:report xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:host><extreport:name>ns1.temp.pl</extreport:name></extreport:host><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit></extreport:report></extension></epp>','report host build');
...
$R2=$E1.'<response><result code="1000"><msg lang="en">Command completed successfully</msg></result><extension><extreport:reportData xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:futDataRsp><extreport:futData><extreport:name>ns1.temp.pl</extreport:name><extreport:roid>632381-NASK</extreport:roid><extreport:exDate>2007-04-19T15:25:31.0Z</extreport:exDate></extreport:futData></extreport:futDataRsp><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit><extreport:size>1</extreport:size></extreport:reportData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><extension><extreport:report xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:future><extreport:exDate>2007-04-23T15:22:34Z</extreport:exDate></extreport:future><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit></extreport:report></extension></epp>','report future build');
...
$R2=$E1.'<response><result code="1000"><msg lang="en">Command completed successfully</msg></result><extension><extreport:reportData xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:paymentFundsDataRsp><extreport:paymentFundsData><extreport:currentBalance>803.86</extreport:currentBalance></extreport:paymentFundsData></extreport:paymentFundsDataRsp><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit><extreport:size>1</extreport:size></extreport:reportData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->report_create(1238,{type=>'funds',account_type=>'domain',offset=>0,limit=>50});
is_string($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><extension><extreport:report xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:prepaid><extreport:paymentFunds><extreport:accountType>domain</extreport:accountType></extreport:paymentFunds></extreport:prepaid><extreport:offset>0</extreport:offset><extreport:limit>50</extreport:limit></extreport:report></extension></epp>','report funds build');
...
$R2 = $E1 . '<response><result code="1301"><msg lang="en">Command completed successfully; ack to dequeue</msg></result><msgQ count="1" id="85386"><qDate>2016-03-07T12:48:17.826Z</qDate><msg lang="en">extreport processing failed</msg></msgQ><resData><extreport:extreportData xmlns:extreport="http://www.dns.pl/nask-epp-schema/extreport-2.0"><extreport:extreportId>20fa0641-567a-403f-be6ea111457c3be2</extreport:extreportId><extreport:reportProcessingState>FAILED</extreport:reportProcessingState></extreport:extreportData></resData>' . $TRID . '</response>' . $E2;
$rc = $dri->message_retrieve();
is($rc->is_success(), 1, 'message_retrieve');
...
####################################################################################################
## Future - info
$R2=$E1.'<response>'.r().'<resData><future:infData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0">
...
is($R1,$E1.'<command><info><future:info xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>example.pl</future:name><future:authInfo><future:pw>2fooBAR</future:pw></future:authInfo></future:info></info><clTRID>ABC-12345</clTRID></command></epp>','future_info build');
...
####################################################################################################
## Future - check
$R2=$E1.'<response>'.r().'<resData><future:chkData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0">
  <future:cd>
...
is($R1,$E1.'<command><check><future:check xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>ala.pl</future:name></future:check></check><clTRID>ABC-12345</clTRID></command></epp>','future_check({name => "ala.pl"})');
...
is_string($R1,$E1.'<command><check><future:check xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>ela.com.pl</future:name></future:check></check><clTRID>ABC-12345</clTRID></command></epp>','future_check build');
is($rc->is_success(),1,'future_check is_success');
...
####################################################################################################
## Future - create
$R2=$E1.'<response>'.r().'<resData><future:creData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0">
  <future:name>example.pl</future:name>
  <future:crDate>1999-04-03T22:00:00.0Z</future:crDate>
...
is($R1,$E1.'<command><create><future:create xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>example.pl</future:name><future:period unit="y">3</future:period><future:registrant>jd1234</future:registrant><future:authInfo><future:pw>2fooBAR</future:pw></future:authInfo></future:create></create><clTRID>ABC-12345</clTRID></command></epp>', 'future_create build');
...
####################################################################################################
## Future - renew
$R2=$E1.'<response>'.r().'<resData><future:renData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0">
  <future:name>example.pl</future:name>
...
is($R1,$E1.'<command><renew><future:renew xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>example.pl</future:name><future:curExpDate>2010-10-30</future:curExpDate><future:period unit="y">3</future:period></future:renew></renew><clTRID>ABC-12345</clTRID></command></epp>', 'future_renew build');
...
is($R1,$E1.'<command><delete><future:delete xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>futuretest.pl</future:name></future:delete></delete><clTRID>ABC-12345</clTRID></command></epp>', 'future_delete build');
...
is($R1,$E1.'<command><update><future:update xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>example7.pl</future:name><future:chg><future:registrant>mak21</future:registrant><future:authInfo><future:pw>2BARfoo</future:pw></future:authInfo></future:chg></future:update></update><clTRID>ABC-12345</clTRID></command></epp>', 'future_update build');
is($rc->is_success(),1,'future_update is_success');

####################################################################################################
## Future - transfer
$R2=$E1.'<response>'.r().'<resData><future:trnData xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0">
  <future:name>example.pl</future:name>
...
is($R1,$E1.'<command><transfer op="request"><future:transfer xmlns:future="http://www.dns.pl/nask-epp-schema/future-2.0"><future:name>example.pl</future:name><future:authInfo><future:pw>2fooBAR</future:pw></future:authInfo></future:transfer></transfer><clTRID>ABC-12345</clTRID></command></epp>', 'future_transfer_request build');
...
is($R1,$E1.'<command><check><domain:check xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example.babia-gora.pl</domain:name><domain:name>example.czest.pl</domain:name><domain:name>example.elk.pl</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command></epp>','domain_check({multiple domain_check name => ("example.babia-gora.pl","example.czest.pl","example.elk.pl")})');
is($rc->is_success(),1,'domain_check multi is_success');


####################################################################################################
## domain renew
$R2=$E1.'<response>'.r().'<resData><domain:renData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example123.pl</domain:name><domain:exDate>2005-04-03T22:00:00.0Z</domain:exDate></domain:renData></resData>'.$TRID.'</response>'.$E2;
...
is($R1,$E1.'<command><renew><domain:renew xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example123.pl</domain:name><domain:curExpDate>2000-04-03</domain:curExpDate><domain:period unit="y">5</domain:period></domain:renew></renew><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew build');
...
$R2=$E1.'<response>'.r().'<resData><domain:renData xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example456.pl</domain:name><domain:exDate>2005-04-03T22:00:00.0Z</domain:exDate></domain:renData></resData>'.$TRID.'</response>'.$E2;
...
is($R1,$E1.'<command><renew><domain:renew xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example456.pl</domain:name><domain:curExpDate>2000-04-03</domain:curExpDate><domain:period unit="y">5</domain:period></domain:renew></renew><extension><extdom:renew xmlns:extdom="http://www.dns.pl/nask-epp-schema/extdom-2.0"><extdom:reactivate/></extdom:renew></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew build');
is($dri->get_info('action'),'renew','domain_renew get_info(action)');
is($dri->get_info('exist'),1,'domain_renew get_info(exist)');
$d=$dri->get_info('exDate');
isa_ok($d,'DateTime','domain_renew get_info(exDate)');
...
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="http://www.dns.pl/nask-epp-schema/epp-2.0"><command><create><domain:create xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example3.pl</domain:name><domain:ns>ns1.example.pl</domain:ns><domain:ns>ns2.example.pl</domain:ns><domain:registrant>k11</domain:registrant><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><secDNS:create xmlns:secDNS="http://www.dns.pl/nask-epp-schema/secDNS-2.0"><secDNS:dsData><secDNS:keyTag>12345</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>9908AF46F00D3F5CE2283CF99B9E50F1CA1DCAC5</secDNS:digest></secDNS:dsData></secDNS:create></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_create (with DS record) build');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example3.pl</domain:name></domain:update></update><extension><secDNS:update xmlns:secDNS="http://www.dns.pl/nask-epp-schema/secDNS-2.0"><secDNS:add><secDNS:dsData><secDNS:keyTag>346</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>9908AF46F00D3F5CE2283CF99B9E50F1CA1DCAC5</secDNS:digest></secDNS:dsData><secDNS:dsData><secDNS:keyTag>23</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>9908AF46F00D3F5CE2283CF99B9E50F1CA1DCAC6</secDNS:digest></secDNS:dsData><secDNS:dsData><secDNS:keyTag>45</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>9908AF46F00D3F5CE2283CF99B9E50F1CA1DCAC7</secDNS:digest></secDNS:dsData></secDNS:add></secDNS:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update (addition of DS records) build');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="http://www.dns.pl/nask-epp-schema/domain-2.0"><domain:name>example4.pl</domain:name></domain:update></update><extension><secDNS:update xmlns:secDNS="http://www.dns.pl/nask-epp-schema/secDNS-2.0"><secDNS:rem><secDNS:dsData><secDNS:keyTag>346</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>9908AF46F00D3F5CE2283CF99B9E50F1CA1DCAC5</secDNS:digest></secDNS:dsData><secDNS:dsData><secDNS:keyTag>23</secDNS:keyTag><secDNS:alg>3</secDNS:alg><secDNS:digestType>1</secDNS:digestType><secDNS:digest>9908AF46F00D3F5CE2283CF99B9E50F1CA1DCAC6</secDNS:digest></secDNS:dsData></secDNS:rem></secDNS:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update (deletion of DS records) build');
