...
is($R1,$E1.'<command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>test.travel</domain:name><domain:curExpDate>2018-10-24</domain:curExpDate><domain:period unit="y">1</domain:period></domain:renew></renew><extension><kv:renew xmlns:kv="urn:X-ar:params:xml:ns:kv-1.0"><kv:kvlist name="UIN"><kv:item key="UIN">1111</kv:item></kv:kvlist></kv:renew></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew build_xml');
