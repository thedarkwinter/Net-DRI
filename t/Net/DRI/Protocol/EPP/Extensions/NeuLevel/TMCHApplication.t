...
is ($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example2.menu</domain:name></domain:check></check><extension><tmch:check xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"/></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_check claims build_xml');
...
is($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">example4.menu</domain:name></domain:info></info><extension><application:info xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>3F2504E0-4F89-11D3-9A0C-0305E82C3301</application:id></application:info><tmch:info xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"/></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_info lp build_xml');
...
$rc=$dri->domain_create('example4.menu',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><application:create xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>NEWAPP123</application:id><application:phase>landrush</application:phase></application:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create lp build_xml [application allocate]');
...
$rc=$dri->domain_create('example4.menu',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><application:create xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:phase>sunrise</application:phase></application:create><tmch:create xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"><tmch:smd>'.$encoded_mark_test.'</tmch:smd></tmch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create lp build_xml [encoded_signed_mark validation model - using unpadded string]');
$lpres = $dri->get_info('lp');
...
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate></domain:creData></resData><extension><application:creData xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>NEWAPP123</application:id><application:phase>sunrise</application:phase></application:creData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_create('example4.menu',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><application:create xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:phase>sunrise</application:phase></application:create><tmch:create xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"><tmch:smd>ABC123=</tmch:smd></tmch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create lp build_xml [encoded_signed_mark validation model - using padded (xml) string]');
$lpres = $dri->get_info('lp');
is($lpres->{application_id},'NEWAPP123','domain_create lp get_info (sunrise application_id)');
...
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate></domain:creData></resData><extension><application:creData xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>NEWAPP123</application:id><application:phase>sunrise</application:phase></application:creData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_create('example4.menu',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><application:create xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:phase>sunrise</application:phase></application:create><tmch:create xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"><tmch:smd>ABC123=</tmch:smd></tmch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create lp build_xml [encoded_signed_mark validation model - using xml root element]');
$lpres = $dri->get_info('lp');
is($lpres->{application_id},'NEWAPP123','domain_create lp get_info (sunrise application_id)');
...
$rc=$dri->domain_create('example4.menu',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><application:create xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:phase>claims</application:phase></application:create><tmch:create xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"><tmch:noticeID>abc123</tmch:noticeID><tmch:notAfter>2008-12-01T00:00:00Z</tmch:notAfter><tmch:accepted>2009-10-01T00:00:00Z</tmch:accepted></tmch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create lp build_xml [claims create]');
$lpres = $dri->get_info('lp');
...
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate></domain:creData></resData><extension><application:creData xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>NEWAPP123</application:id><application:phase>claims</application:phase></application:creData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_create('example4.menu',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp});
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><application:create xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:phase>claims</application:phase></application:create><tmch:create xmlns:tmch="urn:ar:params:xml:ns:tmch-1.0"><tmch:smd>ABC123=</tmch:smd><tmch:noticeID>abc123</tmch:noticeID><tmch:notAfter>2008-12-01T00:00:00Z</tmch:notAfter><tmch:accepted>2009-10-01T00:00:00Z</tmch:accepted></tmch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create lp build_xml [mixed create]');
$lpres = $dri->get_info('lp');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example5.menu</domain:name></domain:update></update><extension><application:update xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>abc123</application:id><application:phase>sunrise</application:phase></application:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update lp build_xml');

# DELETE
$lp = {'application_id'=>'abc123' };
$R2='';
$rc=$dri->domain_delete('example8.menu',{pure_delete=>1,lp=>$lp});
is($R1,$E1.'<command><delete><domain:delete xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example8.menu</domain:name></domain:delete></delete><extension><application:delete xmlns:application="urn:ar:params:xml:ns:application-1.0"><application:id>abc123</application:id></application:delete></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_delete lp build_xml');
