...
is($R1,$E1.'<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">example22.menu</domain:name></domain:info></info><extension><block:info xmlns:block="urn:ar:params:xml:ns:block-1.0"><block:id>BLK-1</block:id></block:info></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_info block build_xml');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example23.menu</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><block:create xmlns:block="urn:ar:params:xml:ns:block-1.0"><block:id>BLK-2</block:id></block:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create price build_xml');
