...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.biz</domain:name><domain:authInfo><domain:pw>ABC123</domain:pw></domain:authInfo></domain:create></create><extension><idn:create xmlns:neulevel="urn:ietf:params:xml:ns:neulevel-1.0"><neulevel:unspec>IDNLang=zh</neulevel:unspec></idn:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check idn old build');
...
is($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example4.biz</domain:name><domain:authInfo><domain:pw>ABC123</domain:pw></domain:authInfo></domain:create></create><extension><idn:create xmlns:neulevel="urn:ietf:params:xml:ns:neulevel-1.0"><neulevel:unspec>IDNLang=zh</neulevel:unspec></idn:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check idn old build');
