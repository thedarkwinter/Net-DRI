...
is_deeply( $dri->protocol()->{loaded_modules},[@core_modules, map { 'Net::DRI::Protocol::EPP::Extensions::'.$_ } qw/GracePeriod SecDNS LaunchPhase AllocationToken NeuLevel::Message NeuLevel::EXTContact NeuLevel::IDNLanguage/],'Neustar::Narwal (standard): loaded_modules');
