...
is($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example6.menu</domain:name></domain:check></check><extension><exAvail:check xmlns:exAvail="urn:ar:params:xml:ns:exAvail-1.0"/></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check ex_avail build_xml');
