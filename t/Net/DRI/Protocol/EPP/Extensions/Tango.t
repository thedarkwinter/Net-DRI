...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example1.ruhr</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example1.ruhr',{'idn' => $dri->local_object('idn')->autodetect('','zh') });
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example1.ruhr</domain:name></domain:check></check><extension><idn:check xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:lang>zh</idn:lang></idn:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build_xml');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example2.ruhr</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example2.ruhr',{'idn' => $dri->local_object('idn')->autodetect('','Latn')} );
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example2.ruhr</domain:name></domain:check></check><extension><idn:check xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:script>Latn</idn:script></idn:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build_xml');
is($rc->is_success(),1,'domain_check is_success');
is($dri->get_info('action'),'check','domain_check get_info(action)');
is($dri->get_info('exist'),0,'domain_check get_info(exist)');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><idn:create xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:lang>zh</idn:lang><idn:variants/></idn:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build_xml');
...
$R2=$E1.'<response>'.r().'<resData><domain:creData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate><domain:exDate>2012-08-10T15:38:26.623854Z</domain:exDate></domain:creData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_create('example3.ruhr',{pure_create=>1,auth=>{pw=>'2fooBAR'},idn => $idn });
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><idn:create xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:lang>zh</idn:lang><idn:variants><idn:nameVariant>abc.ruhr</idn:nameVariant><idn:nameVariant>xyz.ruhr</idn:nameVariant></idn:variants></idn:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build_xml');
is($dri->get_info('action'),'create','domain_create get_info(action)');

# domain info with variants
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate><domain:exDate>2012-08-10T15:38:26.623854Z</domain:exDate></domain:infData></resData><extension><idn:infData xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:lang>zh</idn:lang><idn:variants><idn:nameVariant>abc.ruhr</idn:nameVariant><idn:nameVariant>xyz.ruhr</idn:nameVariant></idn:variants></idn:infData></extension>'.$TRID.'</response>'.$E2;
...
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example1.ruhr</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate><domain:exDate>2012-08-10T15:38:26.623854Z</domain:exDate></domain:infData></resData><extension><idn:infData xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:lang>de</idn:lang><idn:variants /></idn:infData></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name></domain:update></update><extension><idn:update xmlns:idn="http://xmlns.tango-rs.net/epp/idn-1.0"><idn:add><idn:nameVariant>ggg.ruhr</idn:nameVariant></idn:add><idn:rem><idn:nameVariant>abc.ruhr</idn:nameVariant><idn:nameVariant>xyz.ruhr</idn:nameVariant></idn:rem></idn:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build_xml');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><auction:create xmlns:auction="http://xmlns.tango-rs.net/epp/auction-1.0"><auction:bid currency="EUR">100.00</auction:bid></auction:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build_xml');
...
$rc=$dri->domain_update('example3.ruhr',$toc);
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name></domain:update></update><extension><auction:update xmlns:auction="http://xmlns.tango-rs.net/epp/auction-1.0"><auction:bid currency="EUR">200.00</auction:bid></auction:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build_xml');

# domain info
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.ruhr</domain:name><domain:crDate>2010-08-10T15:38:26.623854Z</domain:crDate><domain:exDate>2012-08-10T15:38:26.623854Z</domain:exDate></domain:infData></resData><extension><auction:infData xmlns:auction="http://xmlns.tango-rs.net/epp/auction-1.0"><auction:bid currency="EUR">10000.00</auction:bid></auction:infData></extension>'.$TRID.'</response>'.$E2;$rc=$dri->domain_info('example3.ruhr');
is($dri->get_info('action'),'info','domain_info get_info(action)');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example1-5.scot</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase name="local-entities">custom</launch:phase><ext:augmentedMark xmlns:ext="http://xmlns.corenic.net/epp/mark-ext-1.0"><ext:applicationInfo type="reference-url">http://xmlns.corenic.net/epp/test</ext:applicationInfo><ext:applicationInfo type="intended-use">fooBAR</ext:applicationInfo></ext:augmentedMark></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create local entities launch phase');

# 1.6 "Landrush" Launch Phase
$lp = {phase => 'landrush'};
$rc=$dri->domain_create('example1-6.scot',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp,intended_use=>'fooBAR'});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example1-6.scot</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>landrush</launch:phase><ext:augmentedMark xmlns:ext="http://xmlns.corenic.net/epp/mark-ext-1.0"><ext:applicationInfo type="intended-use">fooBAR</ext:applicationInfo></ext:augmentedMark></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create landrush launch phase');

# 1.7 "Claims" Phase
$lp = {phase => 'claims'};
$rc=$dri->domain_create('example1-7.scot',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp,intended_use=>'fooBAR'});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example1-7.scot</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>claims</launch:phase><ext:augmentedMark xmlns:ext="http://xmlns.corenic.net/epp/mark-ext-1.0"><ext:applicationInfo type="intended-use">fooBAR</ext:applicationInfo></ext:augmentedMark></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create claims phase');

# 1.8 "GA" Phase
$lp = {phase => 'open'};
$rc=$dri->domain_create('example1-8.scot',{pure_create=>1,auth=>{pw=>'2fooBAR'},lp=>$lp,intended_use=>'fooBAR'});
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example1-8.scot</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>open</launch:phase><ext:augmentedMark xmlns:ext="http://xmlns.corenic.net/epp/mark-ext-1.0"><ext:applicationInfo type="intended-use">fooBAR</ext:applicationInfo></ext:augmentedMark></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create GA phase');
...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>examplen-d.scot</domain:name><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><launch:create xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>claims</launch:phase><ext:augmentedMark xmlns:ext="http://xmlns.corenic.net/epp/mark-ext-1.0"><ext:applicationInfo type="intended-use">fooBAR</ext:applicationInfo></ext:augmentedMark><launch:notice><launch:noticeID>abc123</launch:noticeID><launch:notAfter>2008-12-01T00:00:00Z</launch:notAfter><launch:acceptedDate>2009-10-01T00:00:00Z</launch:acceptedDate></launch:notice></launch:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create GA phase');
...
is($R1,$E1.'<command><create><contact:create xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>sh8013</contact:id><contact:postalInfo type="int"><contact:name>Hans Mustermann</contact:name><contact:org>Musterfirma</contact:org><contact:addr><contact:street>Beispielweg 1</contact:street><contact:city>Bern</contact:city><contact:sp>Bern</contact:sp><contact:pc>123456</contact:pc><contact:cc>CH</contact:cc></contact:addr></contact:postalInfo><contact:voice x="1234">+1.7035555555</contact:voice><contact:fax>+1.7035555556</contact:fax><contact:email>jdoe@example.com</contact:email><contact:authInfo><contact:pw>2fooBAR</contact:pw></contact:authInfo><contact:disclose flag="0"><contact:voice/><contact:email/></contact:disclose></contact:create></create><extension><el:create xmlns:el="http://xmlns.corenic.net/epp/contact-eligibility-1.0"><el:enterpriseID>DE-ID-122322322</el:enterpriseID></el:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_create build');
...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>sh8013</contact:id><contact:add><contact:status s="clientDeleteProhibited"/></contact:add><contact:chg><contact:postalInfo type="int"><contact:name>Hans Mustermann</contact:name><contact:org/><contact:addr><contact:street>Beispielweg 1</contact:street><contact:city>Bern</contact:city><contact:sp>Bern</contact:sp><contact:pc>123456</contact:pc><contact:cc>CH</contact:cc></contact:addr></contact:postalInfo><contact:voice>+1.7034444444</contact:voice><contact:fax/><contact:authInfo><contact:pw>2fooBAR</contact:pw></contact:authInfo><contact:disclose flag="1"><contact:voice/><contact:email/></contact:disclose></contact:chg></contact:update></update><extension><el:update xmlns:el="http://xmlns.corenic.net/epp/contact-eligibility-1.0"><el:chg><el:enterpriseID>DE-ID-122322325</el:enterpriseID></el:chg></el:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update build along other contact data');
...
$toc->set('info',$co2);
$rc=$dri->contact_update($co,$toc);
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>sh8013</contact:id></contact:update></update><extension><el:update xmlns:el="http://xmlns.corenic.net/epp/contact-eligibility-1.0"><el:chg><el:enterpriseID>DE-ID-122322324</el:enterpriseID></el:chg></el:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update build retaining other contact data');
is($rc->is_success(),1,'contact_update is_success');
...
$toc->set('info',$co2);
$rc=$dri->contact_update($co,$toc);
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>sh8013</contact:id></contact:update></update><extension><el:update xmlns:el="http://xmlns.corenic.net/epp/contact-eligibility-1.0"><el:chg><el:enterpriseID/></el:chg></el:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update build removing the eligibility information');
is($rc->is_success(),1,'contact_update is_success');
...
is ($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>examplef.eus</domain:name></domain:check></check><extension><launch:check xmlns:launch="urn:ietf:params:xml:ns:launch-1.0" type="claims"><launch:phase name="foobar">custom</launch:phase></launch:check></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_check build_xml');
...
is ($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>exampleg2.eus</domain:name></domain:check></check><extension><launch:check xmlns:launch="urn:ietf:params:xml:ns:launch-1.0" type="claims"><launch:phase>claims</launch:phase></launch:check></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_check build_xml');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">example3.eus</domain:name></domain:cd></domain:chkData></resData>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('example3.eus',{lp => $lp});
is ($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example3.eus</domain:name></domain:check></check><extension><launch:check xmlns:launch="urn:ietf:params:xml:ns:launch-1.0" type="avail"><launch:phase name="idn-release">custom</launch:phase></launch:check></extension><clTRID>ABC-12345</clTRID></command></epp>','domain_check build_xml');
is($dri->get_info('exist'),0,'domain_check get_info(exist)');
...
is($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example10.eus</domain:name></domain:update></update><extension><launch:update xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>sunrise</launch:phase><launch:applicationID>abc321</launch:applicationID></launch:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build_xml');
...
is($R1,$E1.'<command><delete><domain:delete xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example10.eus</domain:name></domain:delete></delete><extension><launch:delete xmlns:launch="urn:ietf:params:xml:ns:launch-1.0"><launch:phase>sunrise</launch:phase><launch:applicationID>abc321</launch:applicationID></launch:delete></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_delete build_xml');
