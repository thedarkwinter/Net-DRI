...
###################################################################################################
## Tango uses the last Fee extension - https://tools.ietf.org/html/rfc8748
$dri->target('nrw');
...
# For ruhr, doesn't use any fee but doesn't matter since the server will return not enable - so no need for more tweaks :)
$dri->target('ruhr');
