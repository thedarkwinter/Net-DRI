...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0"><contact:id>sh8013</contact:id><contact:chg><contact:postalInfo type="loc"><contact:name>Example Latvia Name</contact:name><contact:addr><contact:street>Example Street 1</contact:street><contact:street>Example Street 2</contact:street><contact:city>Example Latvia City</contact:city><contact:pc>012345</contact:pc><contact:cc>LV</contact:cc></contact:addr></contact:postalInfo><contact:voice>+52.0123456789</contact:voice><contact:email>example@example.lv</contact:email></contact:chg></contact:update></update><extension><lvcontact:update xmlns:lvcontact="http://www.nic.lv/epp/schema/lvcontact-ext-1.0"><lvcontact:vatNr>LV12345678901</lvcontact:vatNr><lvcontact:regNr>12345678901</lvcontact:regNr></lvcontact:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'contact_update build');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example-lvnic.lv</domain:name></domain:update></update><extension><lvdomain:update xmlns:lvdomain="http://www.nic.lv/epp/schema/lvdomain-ext-1.0"><lvdomain:add><lvdomain:status lang="en" s="clientAutoRenewProhibited">Client did not pay for domain name: discard it</lvdomain:status></lvdomain:add></lvdomain:update></extension><clTRID>ABC-12345</clTRID></command></epp>', 'domain_update build');
is($rc->is_success(),1,'domain_update is_success');

### 2.1 Domain Info Parse /w Extension
$R2 = $E1 . '<response><resData><domain:infData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>example-mydomain.lv</domain:name><domain:roid>DOM-example-mydomain-LVNIC</domain:roid><domain:status s="ok" /><domain:registrant>regi0412-12345</domain:registrant><domain:contact type="admin">huma1208-192</domain:contact><domain:contact type="tech">client-adm0</domain:contact><domain:contact type="billing">client-bill</domain:contact><domain:ns><domain:hostAttr><domain:hostName>ns.example-mydomain.lv</domain:hostName><domain:hostAddr ip="v4">92.240.65.139</domain:hostAddr></domain:hostAttr><domain:hostAttr><domain:hostName>ns.nonexisting.lv</domain:hostName></domain:hostAttr></domain:ns><domain:clID>test-client</domain:clID><domain:crDate>2011-04-09T13:04:03+03:00</domain:crDate><domain:exDate>2012-04-09T13:04:03+03:00</domain:exDate><domain:upID>test-client</domain:upID><domain:upDate>2011-06-09T13:04:03+03:00</domain:upDate></domain:infData></resData><extension><lvDomain:infData xmlns:lvDomain="http://www.nic.lv/epp/schema/lvdomain-ext-1.0"><lvDomain:status s="clientAutoRenewProhibited" lang="en">Client did not pay for domain name: discard it</lvDomain:status></lvDomain:infData></extension><result code="1000"><msg>Command completed successfully</msg></result>' . $TRID . '</response>' . $E2;
$rc = $dri->domain_info('example-mydomain.lv');
is_string($R1,$E1 . '<command><info><domain:info xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name hosts="all">example-mydomain.lv</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command>' . $E2,'domain_info build');
