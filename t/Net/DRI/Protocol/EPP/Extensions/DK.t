...
$R2=$E1.'<greeting><svID>DK Hostmaster EPP Service (production): 2.2.3</svID><svDate>2017-01-26T09:53:33.0Z</svDate><svcMenu><version>1.0</version><lang>en</lang><objURI>urn:ietf:params:xml:ns:host-1.0</objURI><objURI>urn:ietf:params:xml:ns:domain-1.0</objURI><objURI>urn:ietf:params:xml:ns:contact-1.0</objURI><objURI>http://www.verisign.com/epp/balance-1.0</objURI><svcExtension><extURI>urn:ietf:params:xml:ns:secDNS-1.1</extURI><extURI>urn:dkhm:params:xml:ns:dkhm-4.0</extURI><extURI>urn:dkhm:params:xml:ns:dkhm-domain-4.0</extURI></svcExtension></svcMenu><dcp><access><personalAndOther /></access><statement><purpose><admin /><prov /></purpose><recipient><other /><unrelated /></recipient><retention><legal /></retention></statement></dcp></greeting></epp>';
...
is($dri->protocol()->ns()->{'dkhm'}->[0],'urn:dkhm:params:xml:ns:dkhm-4.0','dkhm-4.0 for server announcing 4.0');
...
$R2 = $E1 . '<response><result code="1001"><msg>Create domain pending for dk-xmlns:dkhm="urn:dkhm:params:xml:ns:dkhm-4.0"hostmaster-test-906.dk</msg></result><extension><dkhm:trackingNo xmlns:dkhm="urn:dkhm:params:xml:ns:dkhm-4.0">2014061800002</dkhm:trackingNo></extension>' . $TRID . '</response>' . $E2;
