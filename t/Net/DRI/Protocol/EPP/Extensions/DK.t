...
$R2=$E1.'<greeting><svID>DK Hostmaster EPP Service (production): 2.2.3</svID><svDate>2017-01-26T09:53:33.0Z</svDate><svcMenu><version>1.0</version><lang>en</lang><objURI>urn:ietf:params:xml:ns:host-1.0</objURI><objURI>urn:ietf:params:xml:ns:domain-1.0</objURI><objURI>urn:ietf:params:xml:ns:contact-1.0</objURI><svcExtension><extURI>urn:ietf:params:xml:ns:secDNS-1.1</extURI><extURI>urn:dkhm:params:xml:ns:dkhm-3.0</extURI></svcExtension></svcMenu><dcp><access><personalAndOther /></access><statement><purpose><admin /><prov /></purpose><recipient><other /><unrelated /></recipient><retention><legal /></retention></statement></dcp></greeting></epp>';
$rc=$dri->process('session','noop',[]);
is($R1,$E1.'<hello/>'.$E2,'session noop build');
is($rc->is_success(),1,'session noop is_success');
is($dri->protocol()->ns()->{'secDNS'},'urn:ietf:params:xml:ns:secDNS-1.1','secDNS 1.1 for server announcing 1.1');
is($dri->protocol()->ns()->{'dkhm'},'urn:dkhm:params:xml:ns:dkhm-3.0','dkhm-3.0 for server announcing 2.0');
...
is($R1,$E1.'<command><update><host:update xmlns:host="urn:ietf:params:xml:ns:host-1.0"><host:name>ns1.eksempel.dk</host:name></host:update></update><extension><dkhm:requestedNsAdmin xmlns:dkhm="urn:dkhm:params:xml:ns:dkhm-3.0">DKHM1-DK</dkhm:requestedNsAdmin></extension><clTRID>ABC-12345</clTRID></command></epp>','host_update build');
...
$R2 = $E1 . '<response><result code="1001"><msg>Create domain pending for dk-xmlns:dkhm="urn:dkhm:params:xml:ns:dkhm-3.0"hostmaster-test-906.dk</msg></result><extension><dkhm:trackingNo xmlns:dkhm="urn:dkhm:params:xml:ns:dkhm-3.0">2014061800002</dkhm:trackingNo></extension>' . $TRID . '</response>' . $E2;
...
### 2.2 Domain Check
$R2 = $E1 . '<response><result code="1000"><msg>Check result</msg></result><resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">blockeddomain.dk</domain:name></domain:cd></domain:chkData></resData><extension><dkhm:domainAdvisory xmlns:dkhm="urn:dkhm:params:xml:ns:dkhm-3.0" domain="blockeddomain.dk" advisory="Blocked" /></extension>' . $TRID . '</response>' . $E2;
$rc=$dri->domain_check('blockeddomain.dk');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:name>blockeddomain.dk</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_check build');
