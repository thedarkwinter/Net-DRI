...
$rc=$dri->contact_create($co);
is_string($R1,$E1.'<command><create><contact:create xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>testcontact2</contact:id><contact:postalInfo type="loc"><contact:name>John Doe</contact:name><contact:org>Test Organization</contact:org><contact:addr><contact:street>2 Harbour Square</contact:street><contact:city>Dublin</contact:city><contact:sp>ON</contact:sp><contact:pc>A96 D6R0</contact:pc><contact:cc>IE</contact:cc></contact:addr></contact:postalInfo><contact:voice>+1.6134375335</contact:voice><contact:fax>+1.6134375366</contact:fax><contact:email>jdoe@example.com</contact:email><contact:authInfo><contact:pw>password</contact:pw></contact:authInfo></contact:create></create><extension><fury:create xmlns:fury="urn:ietf:params:xml:ns:fury-2.0" xsi:schemaLocation="urn:ietf:params:xml:ns:fury-2.0 fury-2.0.xsd"><fury:properties><fury:property><fury:key>IE_CONTACT_TYPE</fury:key><fury:value>COM</fury:value></fury:property><fury:property><fury:key>IE_CRO_NUMBER</fury:key><fury:value>123456</fury:value></fury:property><fury:property><fury:key>LANGUAGE</fury:key><fury:value>EN</fury:value></fury:property></fury:properties></fury:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'contact_create build 2');
...
is_string($R1,$E1.'<command><update><contact:update xmlns:contact="urn:ietf:params:xml:ns:contact-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:contact-1.0 contact-1.0.xsd"><contact:id>agreed</contact:id></contact:update></update><extension><fury:update xmlns:fury="urn:ietf:params:xml:ns:fury-2.0" xsi:schemaLocation="urn:ietf:params:xml:ns:fury-2.0 fury-2.0.xsd"><fury:add><fury:properties><fury:property><fury:key>LANGUAGE</fury:key><fury:value>EN</fury:value></fury:property></fury:properties></fury:add><fury:rem><fury:properties><fury:property><fury:key>LANGUAGE</fury:key><fury:value>FR</fury:value></fury:property></fury:properties></fury:rem></fury:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'contact_update build (change lang fr => en)');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>testdomain3.ie</domain:name><domain:add><domain:ns><domain:hostObj>ns1.testdomain3.example</domain:hostObj><domain:hostObj>ns3.testdomain3.example</domain:hostObj></domain:ns><domain:contact type="tech">testcontact1</domain:contact><domain:status s="clientDeleteProhibited"/></domain:add><domain:chg><domain:authInfo><domain:pw>password2</domain:pw></domain:authInfo></domain:chg></domain:update></update><extension><fury:update xmlns:fury="urn:ietf:params:xml:ns:fury-2.0" xsi:schemaLocation="urn:ietf:params:xml:ns:fury-2.0 fury-2.0.xsd"><fury:add><fury:properties><fury:property><fury:key>PRIVACY</fury:key><fury:value>PUBLIC</fury:value></fury:property></fury:properties></fury:add><fury:rem><fury:properties><fury:property><fury:key>PRIVACY</fury:key><fury:value>PRIVATE</fury:value></fury:property></fury:properties></fury:rem></fury:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2, 'domain_update build (fury extension)');
