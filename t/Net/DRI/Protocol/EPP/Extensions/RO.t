...
$R2=$E1.'<response>'.r().'<resData><domain:trdData xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>test-ia8gq5cs.ro</domain:name><domain:trStatus /><domain:reID /><domain:reDate /><domain:acID /><domain:acDate /><domain:exDate /></domain:trdData></resData><extension><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:trdData><rotld:domain><rotld:request><rotld:tid>11474</rotld:tid></rotld:request></rotld:domain></rotld:trdData></rotld:ext></extension>'.$TRID.'</response>'.$E2;
...
is_string($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>test-5btc8khh-1.ro</domain:name></domain:transfer></transfer><extension><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:transfer><rotld:domain><rotld:authorization_key>fFjMmUZJQyzvXB53</rotld:authorization_key></rotld:domain></rotld:transfer></rotld:ext></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_start build_xml');
...
is_string($R1,$E1.'<command><transfer op="approve"><domain:transfer xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>test-5btc8khh-1.ro</domain:name></domain:transfer></transfer><extension><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:transfer><rotld:domain><rotld:authorization_key>fFjMmUZJQyzvXB53</rotld:authorization_key></rotld:domain></rotld:transfer></rotld:ext></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_accept build_xml');
...
is_string($R1,$E1.'<command><transfer op="reject"><domain:transfer xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>test-5btc8khh-1.ro</domain:name></domain:transfer></transfer><extension><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:transfer><rotld:domain><rotld:authorization_key>fFjMmUZJQyzvXB53</rotld:authorization_key></rotld:domain></rotld:transfer></rotld:ext></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_reject build_xml');
...
is_string($R1,$E1.'<command><transfer op="query"><domain:transfer xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>test-5btc8khh-1.ro</domain:name></domain:transfer></transfer><extension><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:transfer><rotld:domain><rotld:authorization_key>fFjMmUZJQyzvXB53</rotld:authorization_key></rotld:domain></rotld:transfer></rotld:ext></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_query build_xml');
...
is_string($R1,$E1.'<command><transfer op="cancel"><domain:transfer xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>test-5btc8khh-1.ro</domain:name></domain:transfer></transfer><extension><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:transfer><rotld:domain><rotld:authorization_key>fFjMmUZJQyzvXB53</rotld:authorization_key></rotld:domain></rotld:transfer></rotld:ext></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_stop build_xml');
...
### 2.0 Domain Info /w IDN
$R2=$E1.'<response>'.r().'<resData><domain:infData xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name>xn--test-gbdppjee--ohb5qsnr6odb.ro</domain:name><domain:roid>xn--test-gbdppjee--ohb5qsnr6odb-ROTLD</domain:roid><domain:status s="ok" /><domain:registrant>C1034067</domain:registrant><domain:ns><domain:hostObj>ns2.updated.nameserver.co.uk</domain:hostObj></domain:ns><domain:clID /><domain:crID>C1034067</domain:crID><domain:crDate>2016-06-30T09:06:46Z</domain:crDate><domain:exDate /><domain:upID /><domain:upDate>2016-06-30T09:06:49Z</domain:upDate></domain:infData></resData><extension><idn:mapping xmlns:idn="http://www.rotld.ro/xml/epp/idn-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/idn-1.0 idn-1.0.xsd"><idn:name><idn:ace>xn--test-gbdppjee--ohb5qsnr6odb.ro</idn:ace><idn:unicode>test-gbdppjee-ăîșțâ.ro</idn:unicode></idn:name></idn:mapping></extension>'.$TRID.'</response>'.$E2;
$rc = $dri->domain_info('xn--test-gbdppjee--ohb5qsnr6odb.ro');
is_string($R1,$E1.'<command><info><domain:info xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:name hosts="all">xn--test-gbdppjee--ohb5qsnr6odb.ro</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_info idn build_xml');
is($rc->is_success(), 1, 'domain_info idn is_success');
is($dri->get_info('ace'),'xn--test-gbdppjee--ohb5qsnr6odb.ro','domain_info_extension idn get_info(ace)');
is($dri->get_info('unicode'),'test-gbdppjee-ăîșțâ.ro','domain_info_extension idn get_info(unicode)');

### 2.1 Domain Check /w IDN
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="http://www.rotld.ro/xml/epp/domain-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/domain-1.0 domain-1.0.xsd"><domain:cd><domain:name avail="0">test-a8r7bs6j-ăîșțâ.ro</domain:name><domain:reason>Not Available</domain:reason></domain:cd></domain:chkData></resData><extension><idn:mapping xmlns:idn="http://www.rotld.ro/xml/epp/idn-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/idn-1.0 idn-1.0.xsd"><idn:name><idn:ace>xn--test-a8r7bs6j--ohb5qsnr6odb.ro</idn:ace><idn:unicode>test-a8r7bs6j-ăîșțâ.ro</idn:unicode></idn:name></idn:mapping><rotld:ext xmlns:rotld="http://www.rotld.ro/xml/epp/rotld-1.0" xsi:schemaLocation="http://www.rotld.ro/xml/epp/rotld-1.0 rotld-1.0.xsd"><rotld:check_renew_availability renewable="0"><rotld:reason>OPERATION NOT SUPPORTED FOR YOUR REGISTRAR TYPE</rotld:reason></rotld:check_renew_availability></rotld:ext></extension>'.$TRID.'</response>'.$E2;
...
is($rc->is_success(), 1, 'domain_check dna is_success');
