...
our $E1 = '<?xml version="1.0" encoding="UTF-8"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0">';
our $E2 = '</epp>';
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><contact:check xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>ID064561</contact:id></contact:check></check><clTRID>ABC-12345</clTRID></command>' . $E2, 'contact check build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><delete><contact:delete xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>ID064562</contact:id></contact:delete></delete><clTRID>ABC-12345</clTRID></command>' . $E2, 'contact delete build xml');

## Contact create
$R2 = $E1 . '<response><result code="1000"><msg>Command completed successfully</msg></result><resData><contact:creData xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>TL1-CZ</contact:id><contact:crDate>2008-04-25T18:20:51+02:00</contact:crDate></contact:creData></resData>' . $TRID . '</response>' . $E2;
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><contact:info xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>TL2-CZ</contact:id></contact:info></info><clTRID>ABC-12345</clTRID></command>' . $E2, 'contact info build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><update><contact:update xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>TL2-CZ</contact:id><contact:chg><contact:postalInfo><contact:addr><contact:street>Gueterstrasse 86</contact:street><contact:city>Basel</contact:city><contact:sp>BS</contact:sp></contact:addr></contact:postalInfo></contact:chg></contact:update></update><clTRID>ABC-12345</clTRID></command></epp>', 'contact update build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><domain:info xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>syhosting.cz</domain:name></domain:info></info><clTRID>ABC-12345</clTRID></command></epp>', 'domain info build xml');
...
## Domain renew
$R2 = $E1 . '<response><result code="1000"><msg>Command completed successfully</msg></result><resData><domain:renData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>sybla.cz</domain:name><domain:exDate>2010-05-07</domain:exDate></domain:renData></resData>' . $TRID . '</response>' . $E2;
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><renew><domain:renew xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>sybla.cz</domain:name><domain:curExpDate>2008-05-07</domain:curExpDate><domain:period unit="y">2</domain:period></domain:renew></renew><clTRID>ABC-12345</clTRID></command></epp>', 'domain renew build xml');

## Domain check
$R2 = $E1 . '<response><result code="1000"><msg>Command completed successfully</msg></result><resData><domain:chkData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:cd><domain:name avail="1">sybla.cz</domain:name></domain:cd></domain:chkData></resData>' . $TRID . '</response>' . $E2;
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><domain:check xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>sybla.cz</domain:name></domain:check></check><clTRID>ABC-12345</clTRID></command></epp>', 'domain check build xml');
...
is($R1,'<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><transfer op="request"><domain:transfer xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>example201.cz</domain:name><domain:authInfo>my secret</domain:authInfo></domain:transfer></transfer><clTRID>ABC-12345</clTRID></command></epp>','domain_transfer_start build xml');
...
## NSSET check
$R2 = $E1 . '<response><result code="1000"><msg>Command completed successfully</msg></result><resData><nsset:chkData xmlns:nsset="http://www.nic.cz/xml/epp/nsset-1.2"><nsset:cd><nsset:id avail="0">testservers</nsset:id><nsset:id avail="1">prodservers</nsset:id></nsset:cd></nsset:chkData></resData>' . $TRID . '</response>' . $E2;
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><nsset:check xmlns:nsset="http://www.nic.cz/xml/epp/nsset-1.2"><nsset:id>testservers</nsset:id><nsset:id>prodservers</nsset:id></nsset:check></check><clTRID>ABC-12345</clTRID></command></epp>', 'nsset check build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><nsset:info xmlns:nsset="http://www.nic.cz/xml/epp/nsset-1.2"><nsset:id>prodservers</nsset:id></nsset:info></info><clTRID>ABC-12345</clTRID></command></epp>', 'nsset info build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><transfer op="query"><nsset:transfer xmlns:nsset="http://www.nic.cz/xml/epp/nsset-1.2"><nsset:id>nameservers</nsset:id><nsset:authInfo>gnagnagna</nsset:authInfo></nsset:transfer></transfer><clTRID>ABC-12345</clTRID></command></epp>', 'nsset transfer query build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><transfer op="request"><nsset:transfer xmlns:nsset="http://www.nic.cz/xml/epp/nsset-1.2"><nsset:id>nameservers</nsset:id><nsset:authInfo>gnagnagna</nsset:authInfo></nsset:transfer></transfer><clTRID>ABC-12345</clTRID></command></epp>', 'nsset transfer request build xml');

###############################################################################
# KeySET object

## KeySET create
$R2 = $E1 . '<response><result code="1000"><msg>Command completed successfully</msg></result><resData><keyset:creData xmlns:keyset="http://www.nic.cz/xml/epp/keyset-1.3"><keyset:id>342301</keyset:id><keyset:crDate>2016-08-09T16:41:58+02:00</keyset:crDate></keyset:creData></resData>' . $TRID . '</response>' . $E2;
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><check><keyset:check xmlns:keyset="http://www.nic.cz/xml/epp/keyset-1.3"><keyset:id>342301</keyset:id></keyset:check></check><clTRID>ABC-12345</clTRID></command></epp>', 'keyset check build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><info><keyset:info xmlns:keyset="http://www.nic.cz/xml/epp/keyset-1.3"><keyset:id>342301</keyset:id></keyset:info></info><clTRID>ABC-12345</clTRID></command></epp>', 'keyset info build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><delete><keyset:delete xmlns:keyset="http://www.nic.cz/xml/epp/keyset-1.3"><keyset:id>342301</keyset:id></keyset:delete></delete><clTRID>ABC-12345</clTRID></command></epp>', 'keyset delete build xml');
...
is($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><command><transfer><keyset:transfer xmlns:keyset="http://www.nic.cz/xml/epp/keyset-1.3"><keyset:id>342301</keyset:id><keyset:authInfo>gnagnagna</keyset:authInfo></keyset:transfer></transfer><clTRID>ABC-12345</clTRID></command></epp>', 'keyset transfer build xml');
...
# credit info
$R2 = $E1 . '<response><result code="1000"><msg>Command completed successfully</msg></result><resData><fred:resCreditInfo xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:zoneCredit><fred:zone>0.2.4.e164.arpa</fred:zone><fred:credit>66112.00</fred:credit></fred:zoneCredit><fred:zoneCredit><fred:zone>cz</fred:zone><fred:credit>82640.00</fred:credit></fred:zoneCredit></fred:resCreditInfo></resData>'.$TRID.'</response>'.$E2;

$rc = $dri->credit_info();
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><extension><fred:extcommand xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:creditInfo/></fred:extcommand></extension></epp>', 'credit_info build xml');
...
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><extension><fred:extcommand xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:listContacts/><fred:clTRID>egrx002#17-08-30at18:49:12</fred:clTRID></fred:extcommand></extension></epp>', 'prep_list build xml - listContacts');

# test listContacts without cltrid
$R2='';
$rc = $dri->prep_list('listContacts');
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><extension><fred:extcommand xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:listContacts/></fred:extcommand></extension></epp>', 'prep_list build xml - listContacts (without cltrid)');

## 5.14.2. Get the results - as per documentation
$R2=$E1.'<response>'.r().'<resData><fred:resultsList xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:item>1.1.1.7.4.5.2.2.2.0.2.4.e164.arpa</fred:item><fred:item>mydomain.cz</fred:item><fred:item>thisdomain.cz</fred:item><fred:item>trdomain.cz</fred:item></fred:resultsList></resData>'.$TRID.'</response>'.$E2;
$rc = $dri->get_results({cltrid=>'ovcu003#17-08-11at12:27:01'});
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><extension><fred:extcommand xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:getResults/><fred:clTRID>ovcu003#17-08-11at12:27:01</fred:clTRID></fred:extcommand></extension></epp>', 'get_results build xml');
...
$R2='';
$rc = $dri->get_results();
is_string($R1, '<?xml version="1.0" encoding="UTF-8" standalone="no"?><epp xmlns="urn:ietf:params:xml:ns:epp-1.0"><extension><fred:extcommand xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:getResults/></fred:extcommand></extension></epp>', 'get_results build xml (without cltrid)');
...
is($dri->get_info('content','message',459),'<msg><domain:trnData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>test-transfer-dm2.cz</domain:name><domain:trDate>2016-11-14</domain:trDate><domain:clID>REG-FRED_A</domain:clID></domain:trnData></msg>','poll: domain transfer out message get_info content');
...
# 5.5.3.1. Low credit
$R2='';
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="19681433"><qDate>2017-07-25T15:03:43+02:00</qDate><msg><fred:lowCreditData xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:zone>cz</fred:zone><fred:limit><fred:zone>cz</fred:zone><fred:credit>5000.00</fred:credit></fred:limit><fred:credit><fred:zone>cz</fred:zone><fred:credit>4999.00</fred:credit></fred:credit></fred:lowCreditData></msg></msgQ>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
is($dri->get_info('content','message',19681433),'<msg><fred:lowCreditData xmlns:fred="http://www.nic.cz/xml/epp/fred-1.5"><fred:zone>cz</fred:zone><fred:limit><fred:zone>cz</fred:zone><fred:credit>5000.00</fred:credit></fred:limit><fred:credit><fred:zone>cz</fred:zone><fred:credit>4999.00</fred:credit></fred:credit></fred:lowCreditData></msg>','message get_info content (5.5.3.1)');
...
$R2='';
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="19690946"><qDate>2017-07-27T12:13:55+02:00</qDate><msg><domain:impendingExpData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>somedomain.cz</domain:name><domain:exDate>2017-08-26</domain:exDate></domain:impendingExpData></msg></msgQ>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
is($dri->get_info('content','message',19690946),'<msg><domain:impendingExpData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>somedomain.cz</domain:name><domain:exDate>2017-08-26</domain:exDate></domain:impendingExpData></msg>','message get_info content (5.5.3.3)');
...
$R2='';
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="13690946"><qDate>2017-07-27T12:13:55+02:00</qDate><msg><domain:dnsOutageData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>somednsoutagedomain.cz</domain:name><domain:exDate>2018-04-24</domain:exDate></domain:dnsOutageData></msg></msgQ>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
is($dri->get_info('content','message',13690946),'<msg><domain:dnsOutageData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>somednsoutagedomain.cz</domain:name><domain:exDate>2018-04-24</domain:exDate></domain:dnsOutageData></msg>','message get_info content (5.5.3.3 - dnsOutageData)');
...
$R2='';
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="19847350"><qDate>2017-08-14T13:19:29+02:00</qDate><msg><enumval:impendingValExpData xmlns:enumval="http://www.nic.cz/xml/epp/enumval-1.2"><enumval:name>1.1.1.7.4.5.2.2.2.0.2.4.e164.arpa</enumval:name><enumval:valExDate>2017-08-15</enumval:valExDate></enumval:impendingValExpData></msg></msgQ>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
is($dri->get_info('content','message',19847350),'<msg><enumval:impendingValExpData xmlns:enumval="http://www.nic.cz/xml/epp/enumval-1.2"><enumval:name>1.1.1.7.4.5.2.2.2.0.2.4.e164.arpa</enumval:name><enumval:valExDate>2017-08-15</enumval:valExDate></enumval:impendingValExpData></msg>','message get_info content (5.5.3.4 - ENUM domain validation)');
...
is($dri->get_info('content','message',19852593),'<msg><domain:updateData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:opTRID>ReqID-0000141228</domain:opTRID><domain:oldData><domain:infData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>mydomain.cz</domain:name><domain:roid>D0009907597-CZ</domain:roid><domain:status s="serverBlocked">Domain blocked</domain:status><domain:status s="serverDeleteProhibited">Deletion forbidden</domain:status><domain:status s="serverRenewProhibited">Registration renewal forbidden</domain:status><domain:status s="serverRegistrantChangeProhibited">Registrant change forbidden</domain:status><domain:status s="serverTransferProhibited">Sponsoring registrar change forbidden</domain:status><domain:status s="serverUpdateProhibited">Update forbidden</domain:status><domain:registrant>CID-MYOWN</domain:registrant><domain:admin>CID-ADMIN1</domain:admin><domain:admin>CID-ADMIN2</domain:admin><domain:nsset>NID-MYNSSET</domain:nsset><domain:clID>REG-MYREG</domain:clID><domain:crID>REG-MYREG</domain:crID><domain:crDate>2017-07-11T13:28:48+02:00</domain:crDate><domain:upID>REG-FRED_C</domain:upID><domain:upDate>2017-08-11T10:46:14+02:00</domain:upDate><domain:exDate>2020-07-11</domain:exDate><domain:authInfo>rvBcaTVq</domain:authInfo></domain:infData></domain:oldData><domain:newData><domain:infData xmlns:domain="http://www.nic.cz/xml/epp/domain-1.4"><domain:name>mydomain.cz</domain:name><domain:roid>D0009907597-CZ</domain:roid><domain:status s="serverBlocked">Domain blocked</domain:status><domain:status s="serverDeleteProhibited">Deletion forbidden</domain:status><domain:status s="serverRenewProhibited">Registration renewal forbidden</domain:status><domain:status s="serverRegistrantChangeProhibited">Registrant change forbidden</domain:status><domain:status s="serverTransferProhibited">Sponsoring registrar change forbidden</domain:status><domain:status s="serverUpdateProhibited">Update forbidden</domain:status><domain:registrant>CID-MYCONTACT</domain:registrant><domain:admin>CID-ADMIN1</domain:admin><domain:admin>CID-ADMIN2</domain:admin><domain:nsset>NID-MYNSSET</domain:nsset><domain:clID>REG-MYREG</domain:clID><domain:crID>REG-MYREG</domain:crID><domain:crDate>2017-07-11T13:28:48+02:00</domain:crDate><domain:upID>REG-CZNIC</domain:upID><domain:upDate>2017-08-14T13:29:06+02:00</domain:upDate><domain:exDate>2020-07-11</domain:exDate><domain:authInfo>rvBcaTVq</domain:authInfo></domain:infData></domain:newData></domain:updateData></msg>','message get_info content (5.5.3.6. Object update)');
...
$R2='';
$R2=$E1.'<response>'.r(1301,'Command completed successfully; ack to dequeue').'<msgQ count="1" id="19689674"><qDate>2017-07-26T18:28:55+02:00</qDate><msg><contact:idleDelData xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>CID-IDLE</contact:id></contact:idleDelData></msg></msgQ>'.$TRID.'</response>'.$E2;
$rc=$dri->message_retrieve();
...
is($dri->get_info('content','message',19689674),'<msg><contact:idleDelData xmlns:contact="http://www.nic.cz/xml/epp/contact-1.6"><contact:id>CID-IDLE</contact:id></contact:idleDelData></msg>','message get_info content (5.5.3.7. Idle object deletion)');
