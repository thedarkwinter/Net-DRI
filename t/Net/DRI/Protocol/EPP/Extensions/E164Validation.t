...
is_string($R1,$E1.'<command><create><domain:create xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>5.1.5.1.8.6.2.4.4.1.4.e164.arpa</domain:name><domain:period unit="y">1</domain:period><domain:ns><domain:hostObj>ns1.example.com</domain:hostObj><domain:hostObj>ns2.example.com</domain:hostObj></domain:ns><domain:registrant>jd1234</domain:registrant><domain:contact type="admin">sh8013</domain:contact><domain:contact type="tech">sh8013</domain:contact><domain:authInfo><domain:pw>2fooBAR</domain:pw></domain:authInfo></domain:create></create><extension><e164val:create xmlns:e164val="urn:ietf:params:xml:ns:e164val-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:e164val-1.0 e164val-1.0.xsd"><e164val:add id="EK77"><e164val:validationInfo><valex:simpleVal xmlns:valex="urn:ietf:params:xml:ns:e164valex-1.1"><valex:methodID>Validation-X</valex:methodID><valex:validationEntityID>VE-NMQ</valex:validationEntityID><valex:registrarID>Client-X</valex:registrarID><valex:executionDate>2004-04-08</valex:executionDate><valex:expirationDate>2004-10-07</valex:expirationDate></valex:simpleVal></e164val:validationInfo></e164val:add></e164val:create></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_create build +E164Validation');
...
is_string($R1,$E1.'<command><renew><domain:renew xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>5.1.5.1.8.6.2.4.4.1.4.e164.arpa</domain:name><domain:curExpDate>2005-04-09</domain:curExpDate><domain:period unit="y">1</domain:period></domain:renew></renew><extension><e164val:renew xmlns:e164val="urn:ietf:params:xml:ns:e164val-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:e164val-1.0 e164val-1.0.xsd"><e164val:add id="CAB176"><e164val:validationInfo><valex:simpleVal xmlns:valex="urn:ietf:params:xml:ns:e164valex-1.1"><valex:methodID>Validation-X</valex:methodID><valex:validationEntityID>VE-NMQ</valex:validationEntityID><valex:registrarID>Client-X</valex:registrarID><valex:executionDate>2005-03-30</valex:executionDate><valex:expirationDate>2005-09-29</valex:expirationDate></valex:simpleVal></e164val:validationInfo></e164val:add></e164val:renew></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_renew build +E164Validation');
...
is_string($R1,$E1.'<command><transfer op="request"><domain:transfer xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>5.1.5.1.8.6.2.4.4.1.4.e164.arpa</domain:name><domain:authInfo><domain:pw roid="HB1973-ZUE">2fooBAR</domain:pw></domain:authInfo></domain:transfer></transfer><extension><e164val:transfer xmlns:e164val="urn:ietf:params:xml:ns:e164val-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:e164val-1.0 e164val-1.0.xsd"><e164val:add id="LJ1126"><e164val:validationInfo><valex:simpleVal xmlns:valex="urn:ietf:params:xml:ns:e164valex-1.1"><valex:methodID>Validation-Y</valex:methodID><valex:validationEntityID>VE2-LMQ</valex:validationEntityID><valex:registrarID>Client-Y</valex:registrarID><valex:executionDate>2005-01-22</valex:executionDate><valex:expirationDate>2005-07-21</valex:expirationDate></valex:simpleVal></e164val:validationInfo></e164val:add></e164val:transfer></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_transfer_request build +E164Validation');
...
is_string($R1,$E1.'<command><update><domain:update xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>5.1.5.1.8.6.2.4.4.1.4.e164.arpa</domain:name></domain:update></update><extension><e164val:update xmlns:e164val="urn:ietf:params:xml:ns:e164val-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:e164val-1.0 e164val-1.0.xsd"><e164val:add id="EK2510"><e164val:validationInfo><valex:simpleVal xmlns:valex="urn:ietf:params:xml:ns:e164valex-1.1"><valex:methodID>Validation-X</valex:methodID><valex:validationEntityID>VE-NMQ</valex:validationEntityID><valex:registrarID>Client-X</valex:registrarID><valex:executionDate>2004-10-02</valex:executionDate><valex:expirationDate>2005-04-01</valex:expirationDate></valex:simpleVal></e164val:validationInfo></e164val:add><e164val:rem id="EK77"/></e164val:update></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'domain_update build +E164Validation');
