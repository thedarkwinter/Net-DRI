...
$dri->target('mamclient')->add_current_profile('p1','epp',{f_send=>\&mysend,f_recv=>\&myrecv});
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">exdom1.kiwi</domain:name></domain:cd><domain:cd><domain:name avail="1">exdom1.kiwi</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.5"><fee:cd><fee:name premium="false">exdom1.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>create</fee:command><fee:period unit="y">1</fee:period><fee:fee description="Phase Fee">0.00</fee:fee><fee:fee description="Registration Fee">10.00</fee:fee></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('exdom1.kiwi',{fee=>{action=>'create'}});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>exdom1.kiwi</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.5" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.5 fee-0.5.xsd"><fee:domain><fee:name>exdom1.kiwi</fee:name><fee:command>create</fee:command></fee:domain></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
...
is($d->{domain},'exdom1.kiwi','Fee extension: domain_check single parse domain');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">exdom2.kiwi</domain:name></domain:cd><domain:cd><domain:name avail="1">exdom2.kiwi</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.5"><fee:cd><fee:name premium="false">exdom2.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>create</fee:command><fee:period unit="y">1</fee:period><fee:fee description="Phase Fee">0.00</fee:fee><fee:fee description="Registration Fee">10.00</fee:fee></fee:cd><fee:cd><fee:name premium="true">exdom2.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>create</fee:command><fee:period unit="y">1</fee:period><fee:fee description="Phase Fee">0.00</fee:fee><fee:fee description="Registration Fee">1000.00</fee:fee></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check('exdom2.kiwi',{fee=>[{action=>'create'},{action=>'renew'}]});
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>exdom2.kiwi</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.5" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.5 fee-0.5.xsd"><fee:domain><fee:name>exdom2.kiwi</fee:name><fee:command>create</fee:command></fee:domain><fee:domain><fee:name>exdom2.kiwi</fee:name><fee:command>renew</fee:command></fee:domain></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check build');
is($dri->get_info('action'),'check','domain_check get_info(action)');
is($dri->get_info('exist'),0,'domain_check get_info(exist)');
my ($d1,$d2) = @{$dri->get_info('fee')};
is($d1->{domain},'exdom2.kiwi','Fee extension: domain_check single parse domain');
...
is($d2->{domain},'exdom2.kiwi','Fee extension: domain_check single parse domain');
...
$R2=$E1.'<response>'.r().'<resData><domain:chkData xmlns:domain="urn:ietf:params:xml:ns:domain-1.0"><domain:cd><domain:name avail="1">exdom3.kiwi</domain:name></domain:cd><domain:cd><domain:name avail="1">exdom3.kiwi</domain:name></domain:cd></domain:chkData></resData><extension><fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.5"><fee:cd><fee:name premium="false">exdom3.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>create</fee:command><fee:period unit="y">1</fee:period><fee:fee>10.00</fee:fee></fee:cd><fee:cd><fee:name premium="false">exdom3.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>renew</fee:command><fee:period unit="y">1</fee:period><fee:fee>10.00</fee:fee></fee:cd><fee:cd><fee:name premium="false">exdom3.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>transfer</fee:command><fee:period unit="y">1</fee:period><fee:fee>5.00</fee:fee></fee:cd><fee:cd><fee:name premium="false">exdom3.kiwi</fee:name><fee:currency>USD</fee:currency><fee:command>restore</fee:command><fee:period unit="y">1</fee:period><fee:fee>20.00</fee:fee></fee:cd></fee:chkData></extension>'.$TRID.'</response>'.$E2;
$rc=$dri->domain_check_price('exdom3.kiwi');
is_string($R1,$E1.'<command><check><domain:check xmlns:domain="urn:ietf:params:xml:ns:domain-1.0" xsi:schemaLocation="urn:ietf:params:xml:ns:domain-1.0 domain-1.0.xsd"><domain:name>exdom3.kiwi</domain:name></domain:check></check><extension><fee:check xmlns:fee="urn:ietf:params:xml:ns:fee-0.5" xsi:schemaLocation="urn:ietf:params:xml:ns:fee-0.5 fee-0.5.xsd"><fee:domain><fee:name>exdom3.kiwi</fee:name><fee:command>create</fee:command></fee:domain><fee:domain><fee:name>exdom3.kiwi</fee:name><fee:command>renew</fee:command></fee:domain><fee:domain><fee:name>exdom3.kiwi</fee:name><fee:command>transfer</fee:command></fee:domain><fee:domain><fee:name>exdom3.kiwi</fee:name><fee:command>restore</fee:command></fee:domain></fee:check></extension><clTRID>ABC-12345</clTRID></command>'.$E2,'Fee extension: domain_check_price build');
