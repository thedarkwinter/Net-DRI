...
$rh=Net::DRI::Protocol::EPP::Extensions::ICANN::MarkSignedMark::parse_signed_mark($po,$root);
...
## SMD from http://tools.ietf.org/id/draft-lozano-tmch-smd-03.txt
$smd=<<'EOF';
<?xml version="1.0" encoding="UTF-8"?>
<smd:signedMark xmlns:smd="urn:ietf:params:xml:ns:signedMark-1.0" id="smd1">
  ...
  <Signature xmlns="http://www.w3.org/2000/09/xmldsig#">
    ...
    <SignatureValue>jMu4PfyQGiJBF0GWSEPFCJjmywCEqR2h4LD+ge6XQ+JnmKFFCuCZS/3SLKAx0L1w
...
my @a=$cs->get('contact_agent');
is(scalar @a,1,'parse_signed_mark mark agent length');
my $a=$a[0];
is($a->voice(),'+1.2025562302','parse_signed_mark mark agent voice');
...
## signature
$rs=$rh->{signature};
is($rs->{id},'smd1','parse_signed_mark signature id');
TODO: {
 local $TODO='XML::Sig does not work correctly';
 #is($rs->{validated},1,'parse_signed_mark signature validated');
}
is($rs->{value},'','parse_signed_mark signature value');
$rk=$rs->{key};
is($rk->{algorithm},'rsa','parse_signed_mark signature key algorithm');
is($rk->{modulus},undef,'parse_signed_mark signature key modulus');
is($rk->{exponent},undef,'parse_signed_mark signature key exponent');
is($rk->{x509_certificate},'','parse_signed_mark signature key x590_certificate');
...
## ENC from http://tools.ietf.org/id/draft-lozano-tmch-smd-02.txt
...
## ENC from http://tools.ietf.org/id/draft-lozano-tmch-smd-03.txt

$smd=<<'EOF';
<?xml version="1.0" encoding="UTF-8"?><smd:encodedSignedMark xmlns:smd="urn:ietf:params:xml:ns:signedMark-1.0">PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0iVVRGLTgiPz4KPHNtZDpzaWduZWRNYXJ
 ...
 PC9zbWQ6c2lnbmVkTWFyaz4=</smd:encodedSignedMark>
EOF

require MIME::Base64;
my $xml = $smd;
$xml =~ m!(.*signedMark-1.0">)(.*)<!s;
eval {$xml=MIME::Base64::decode_base64($2);};
...
is($rs->{value},'','parse_signed_mark signature value');
