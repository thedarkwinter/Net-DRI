...
# Test below disabled as registry supports both object & host_as_attr. Set "$self->{info}->{host_as_attr}=2;" before running this test and disable the one below it. 
...
$co->vat('22222222222'); # VAT Number of the legal entity
$co->orgno('11111111111'); # 'Personal ID' number of the legal entity
$co->type('c'); # 'Personal ID' number of the legal entity
